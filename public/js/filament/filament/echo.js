      ...
      return (function (l) {
        ...
        return (
          ...
          (a.t = function (c, s) {
            ...
            if (
              (a.r(f), Object.defineProperty(f, 'default', { enumerable: !0, value: c }), s & 2 && typeof c != 'string')
            )
              for (var d in c)
                a.d(
                  f,
              ...
              return (
                ...
                (b.prototype.encode = function (v) {
                  ...
                  if (I > 0) {
                    ...
                    ;((y += this._encodeByte((O >>> 18) & 63)),
                      (y += this._encodeByte((O >>> 12) & 63)),
                      I === 2 ? (y += this._encodeByte((O >>> 6) & 63)) : (y += this._paddingCharacter || ''),
                ...
                (b.prototype.decode = function (v) {
                  ...
                  if (
                    (q < w - 1 &&
                      ...
                      (M |= F & s)),
                    q < w - 2 &&
                      ((z = this._decodeChar(v.charCodeAt(q + 2))), (O[I++] = (F << 4) | (z >>> 2)), (M |= z & s)),
            ...
            Ve = (function () {
              ...
              return (
                ...
                (e.prototype.cleanup = function () {
                  ;(this.script &&
                    ((this.script.onload = this.script.onerror = null), (this.script.onreadystatechange = null)),
                  ...
                  var u = this.transport.createConnection(t, n, r, i),
                    ...
                    g = function (k) {
                      if ((u.unbind('closed', g), k.code === 1002 || k.code === 1003)) o.manager.reportDeath()
                        ...
                        var E = j.now() - p
                        E < 2 * o.maxPingDelay &&
                          (o.manager.reportDeath(), (o.pingDelay = Math.max(E / 2, o.minPingDelay)))
                      }
                    }
        ...
        R(a, [
          {
            ...
            value: function (s, f) {
              return (
                this.socket.emit('client event', { channel: this.name, event: 'client-'.concat(s), data: f }), this
              )
            },
          },
        ]),
