      ...
      await s.getClippingRect({
        element:
          (e = await (s.isElement == null ? void 0 : s.isElement(x))) == null || e
            ? x
            : x.contextElement || (await (s.getDocumentElement == null ? void 0 : s.getDocumentElement(a.floating))),
        boundary: c,
        rootBoundary: h,
        strategy: l,
      }),
      ...
      ;((h = A ?? h),
        ...
        L &&
          ...
          typeof L == 'object' &&
            ...
            L.rects &&
              (c = L.rects === !0 ? await r.getElementRects({ reference: i, floating: t, strategy: o }) : L.rects),
            ({ x: h, y: d } = ni(c, f, l))),
          (m = -1)))
    }
  ...
  return (
    i === void 0 && (i = {}),
    {
      ...
      async fn(t) {
        ...
        if (((W = [...W, { placement: o, overflows: M }]), !M.every((C) => C <= 0))) {
          var K, et
          let C = (((K = s.flip) == null ? void 0 : K.index) || 0) + 1,
            $ = q[C]
          if (
            $ &&
            (!(d === 'alignment' ? w !== ut($) : !1) ||
              W.every((F) => (ut(F.placement) === w ? F.overflows[0] > 0 : !0)))
          )
            return { data: { index: C, overflows: W }, reset: { placement: $ } }
          let _ =
            (et = W.filter((Y) => Y.overflows[0] <= 0).sort((Y, F) => Y.overflows[1] - F.overflows[1])[0]) == null
              ? void 0
              : et.placement
          if (!_)
            switch (p) {
              case 'bestFit': {
                ...
                let Y =
                  (V = W.filter((F) => {
                    ...
                    .map((F) => [F.placement, F.overflows.filter((Q) => Q > 0).reduce((Q, ie) => Q + ie, 0)])
...
function ci(i) {
  return !re() || typeof ShadowRoot > 'u' ? !1 : i instanceof ShadowRoot || i instanceof U(i).ShadowRoot
}
function Tt(i) {
...
function yi(i) {
  let t = U(i)
  return !le() || !t.visualViewport ? hn : { x: t.visualViewport.offsetLeft, y: t.visualViewport.offsetTop }
}
function un(i, t, e) {
...
function Xt(i, t, e, n) {
  ...
  if (s) {
    ...
    for (; m && n && p !== g;) {
      ...
      ;((l *= x.x), (c *= x.y), (h *= x.x), (d *= x.y), (l += A), (c += O), (g = U(m)), (m = ce(g)))
    }
  }
...
function Si(i, t) {
  let e = ft(i)
  return e === t || !it(e) || At(e) ? !1 : nt(e).position === 'fixed' || Si(e, t)
}
function vn(i, t) {
  let e = t.get(i)
  if (e) return e
...
function yn(i) {
  let { element: t, boundary: e, rootBoundary: n, strategy: o } = i,
    r = [...(e === 'clippingAncestors' ? (zt(t) ? [] : vn(t, this._c)) : [].concat(e)), n],
    a = gi(t, r[0], o),
    l = a.top,
    c = a.right,
    h = a.bottom,
...
function at(i, t, e, n) {
  if (i) {
    e = e || document
    do {
      if ((t != null && (t[0] === '>' ? i.parentNode === e && ye(i, t) : ye(i, t))) || (n && i === e)) return i
      if (i === e) break
    } while ((i = Fi(i)))
  }
  return null
...
function je(i, t) {
  for (var e = i.lastElementChild; e && (e === v.ghost || b(e, 'display') === 'none' || (t && !ye(e, t)));)
...
v.prototype = {
  ...
  _triggerDragStart: function (t, e) {
    ;((e = e || (t.pointerType == 'touch' && t)),
      !this.nativeDraggable || e
        ...
        : (E(u, 'dragend', this), E(I, 'dragstart', this._onDragStart)))
    try {
      document.selection
        ? be(function () {
  ...
  _dragStarted: function (t, e) {
    if (((Pt = !1), I && u)) {
      ;(j('dragStarted', this, { evt: e }), this.nativeDraggable && E(document, 'dragover', $n))
      var n = this.options
      ;(!t && Z(u, n.dragClass, !1),
        Z(u, n.ghostClass, !0),
        (v.active = this),
    ...
    if (!y) {
      ...
      if (fe) {
        ...
        ;(z !== document.body && z !== document.documentElement
          ? (z === document && (z = dt()), (e.top += z.scrollTop), (e.left += z.scrollLeft))
          : (z = dt()),
          (Be = Ri(z)))
      }
      ;((y = u.cloneNode(!0)),
  ...
  _onDragStart: function (t, e) {
    ...
    ;(j('setupClone', this),
      ...
      (n.cloneId = be(function () {
        ;(j('clone', n),
          !v.eventCanceled &&
            (n.options.removeCloneOnHide || I.insertBefore(R, u), n._hideClone(), X({ sortable: n, name: 'clone' })))
      })),
      !e && Z(u, s.dragClass, !0),
      e
  ...
  _onDragOver: function (t) {
    ...
    function D() {
      ;(x('dragOverAnimationCapture'), g.captureAnimationState(), g !== f && f.captureAnimationState())
    }
    function w(F) {
      return (
        ...
        !a.dragoverBubble && !t.rootEl && n !== document && (u.parentNode[G]._isOutsideThisEl(t.target), !F && Lt(t)),
    ...
    function A() {
      ;((tt = ot(u)),
        (wt = ot(u, a.draggable)),
        X({ sortable: g, name: 'change', toEl: e, newIndex: tt, newDraggableIndex: wt, originalEvent: t }))
    }
    if (
    ...
    if (
      ...
      c &&
        ...
        (h
          ? d || (r = P !== I)
          : H === this || ((this.lastPutMode = he.checkPull(this, c, u, t)) && l.checkPut(this, c, u, t))))
    ) {
      if (((p = this._getDirection(t, n) === 'vertical'), (o = B(u)), x('dragOverValid'), v.eventCanceled)) return m
      if (r)
        return (
          (P = I),
          D(),
      ...
      if (!O || (Yn(t, p, this) && !O.animated)) {
        if (O === u) return w(!1)
        if ((O && e === t.target && (n = O), n && (s = B(n)), pe(I, e, u, o, n, s, t, !!n) !== !1))
          return (D(), O && O.nextSibling ? e.insertBefore(u, O.nextSibling) : e.appendChild(u), (P = e), A(), w(!0))
        ...
        var L = 0,
          q,
          J = u.parentNode !== e,
          M = !Wn((u.animated && u.toRect) || o, (n.animated && n.toRect) || s, p),
          W = p ? 'top' : 'left',
          K = Ti(n, 'top', 'top') || Ti(u, 'top', 'top'),
          et = K ? K.scrollTop : void 0
        ;(_t !== n && ((q = s[W]), (Zt = !1), (ue = (!M && a.invertSwap) || J)),
          (L = Un(
            t,
            n,
            s,
        ...
        if (Y !== !1)
          return (
            ...
            setTimeout(Kn, 30),
            D(),
            _ && !$ ? e.appendChild(u) : n.parentNode.insertBefore(u, _ ? $ : n),
  ...
  _onDrop: function (t) {
    ...
    ;((Pt = !1),
      ...
      t &&
        ...
        (I === P || (H && H.lastPutMode !== 'clone')) && R && R.parentNode && R.parentNode.removeChild(R),
        u &&
          (this.nativeDraggable && S(u, 'dragend', this),
          Fe(u),
          (u.style['will-change'] = ''),
          Yt && !Pt && Z(u, H ? H.options.ghostClass : this.options.ghostClass, !1),
          Z(u, this.options.chosenClass, !1),
          X({ sortable: this, name: 'unchoose', toEl: P, newIndex: null, newDraggableIndex: null, originalEvent: t }),
          I !== P
            ? (tt >= 0 &&
...
function Un(i, t, e, n, o, s, r, a) {
  ...
  if (!r) {
    if (a && me < c * o) {
      if ((!Zt && (Qt === 1 ? l > h + (c * s) / 2 : l < d - (c * s) / 2) && (Zt = !0), Zt)) f = !0
...
var Ve = Wi(function (i, t, e, n) {
    if (t.scroll) {
      var o = (i.touches ? i.touches[0] : i).clientX,
        ...
        c = !1,
        h
      Xe !== e && ((Xe = e), ve(), (Ut = t.scroll), (h = t.scrollFn), Ut === !0 && (Ut = xt(e, !0)))
      var d = 0,
        f = Ut
      do {
        var p = f,
          ...
          K = p.scrollTop
        p === l
          ? ((N = A < q && (M.overflowX === 'auto' || M.overflowX === 'scroll' || M.overflowX === 'visible')),
            (L = O < J && (M.overflowY === 'auto' || M.overflowY === 'scroll' || M.overflowY === 'visible')))
          : ((N = A < q && (M.overflowX === 'auto' || M.overflowX === 'scroll')),
            (L = O < J && (M.overflowY === 'auto' || M.overflowY === 'scroll')))
        var et = N && (Math.abs(w - o) <= r && W + A < q) - (Math.abs(D - o) <= r && !!W),
          V = L && (Math.abs(x - s) <= r && K + O < J) - (Math.abs(m - s) <= r && !!K)
          ...
          (et != 0 || V != 0) &&
            ...
            (k[d].pid = setInterval(
              function () {
                ...
                var $ = k[this.layer].vy ? k[this.layer].vy * a : 0,
                  _ = k[this.layer].vx ? k[this.layer].vx * a : 0
                ;(typeof h == 'function' &&
                  h.call(v.dragged.parentNode[G], _, $, i, Ee, k[this.layer].el) !== 'continue') ||
...
var De = class {
  ...
  render() {
    ;(this.populateLabelRepositoryFromOptions(this.options),
      ...
      T(this.ariaLabel) && this.selectButton.setAttribute('aria-label', this.ariaLabel),
  ...
  async getLabelsForMultipleSelection() {
    ...
    if (
      ...
      try {
        ...
        for (let s of o) T(s) && s.value !== void 0 && s.label !== void 0 && (this.labelRepository[s.value] = s.label)
      } catch (o) {
    ...
    if (Array.isArray(this.state))
      for (let o of this.state)
        T(this.labelRepository[o]) ? n.push(this.labelRepository[o]) : T(t[o]) ? n.push(t[o]) : n.push(o)
    return n
  }
  ...
  createRemoveButton(t, e) {
    ...
    return (
      ...
      n.addEventListener('keydown', (s) => {
        ;(s.key === ' ' || s.key === 'Enter') && (s.preventDefault(), s.stopPropagation(), T(t) && this.selectOption(t))
      }),
      n
    )
  }
  ...
  async getLabelForSingleSelection() {
    ...
    if (
      ...
      bt(t) && T(this.initialOptionLabel) && this.state === this.initialState)
    )
      ((t = this.initialOptionLabel), T(this.state) && (this.labelRepository[this.state] = t))
    else if (bt(t) && this.getOptionLabelUsing)
      try {
        ;((t = await this.getOptionLabelUsing()), T(t) && T(this.state) && (this.labelRepository[this.state] = t))
      } catch (e) {
    ...
    ;((this.buttonClickListener = () => {
      ...
      !this.isMultiple &&
        ...
        ((this.refreshOptionLabelListener = async (t) => {
          if (t.detail.livewireId === this.livewireId && t.detail.statePath === this.statePath && T(this.state))
            try {
              ...
              ;(T(n) && (this.isHtmlAllowed ? (n.innerHTML = e) : (n.textContent = e)),
  ...
  async addSingleBadge(t, e) {
    ...
    if (
      (bt(n) && ((n = this.getSelectedOptionLabel(t)), T(n) && (this.labelRepository[t] = n)),
  ...
  return {
    ...
    init() {
      ;(p ||
        ...
        (this.unsubscribeLivewireHook = Livewire.interceptMessage(({ message: C, onSuccess: $ }) => {
          $(() => {
            this.$nextTick(() => {
              if (this.isLoading || C.component.id !== this.$root.closest('[wire\\:id]')?.attributes['wire:id'].value)
                return
              let _ = this.getServerState()
              _ === void 0 || this.getNormalizedState() === _ || (this.state = _)
            })
          })
        })),
        this.$watch('state', async (C) => {
          !p &&
            this.select &&
            this.select.state !== C &&
            ((this.select.state = C), this.select.updateSelectedDisplay(), this.select.renderOptions())
          let $ = this.getServerState()
          if ($ === void 0 || this.getNormalizedState() === $) return
          this.isLoading = !0
          let _ = await this.$wire.updateTableColumnState(x, q, this.state)
