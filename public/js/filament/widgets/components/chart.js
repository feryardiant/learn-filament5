...
var zc = (s, t, e) => (t in s ? Nc(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (s[t] = e))
...
var Uc = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/
function ho(s, t, e) {
...
function vn(s) {
  ...
  return (
    r !== o &&
      ((h = r - o), (c = a > 0.5 ? h / (2 - r - o) : h / (r + o)), (l = qc(e, i, n, h, r)), (l = l * 60 + 0.5)),
    [l | 0, c || 0, a]
  )
}
function Sn(s, t, e, i) {
...
function Jc(s) {
  ...
  let n = uo(+t[2]),
    ...
    o = +t[4] / 100
  return (
    t[1] === 'hwb' ? (i = Gc(n, r, o)) : t[1] === 'hsv' ? (i = Xc(n, r, o)) : (i = Mn(n, r, o)),
    { r: i[0], g: i[1], b: i[2], a: e }
  )
}
function Kc(s, t) {
  var e = vn(s)
  ;((e[0] = uo(e[0] + t)), (e = Mn(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]))
}
function Qc(s) {
  if (!s) return
  let t = vn(s),
...
function th() {
  ...
  for (i = 0; i < t.length; i++) {
    for (o = a = t[i], n = 0; n < e.length; n++) ((r = e[n]), (a = a.replace(r, ao[r])))
    ;((r = parseInt(lo[o], 16)), (s[a] = [(r >> 16) & 255, (r >> 8) & 255, r & 255]))
  }
  return s
}
var ri
...
var sh = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/
function ih(s) {
  let t = sh.exec(s),
    e = 255,
    i,
...
function nh(s) {
  return s && (s.a < 255 ? `rgba(${s.r}, ${s.g}, ${s.b}, ${Wt(s.a)})` : `rgb(${s.r}, ${s.g}, ${s.b})`)
}
...
function co(s) {
  ...
  return (
    Array.isArray(s)
      ? s.length >= 3 && ((t = { r: s[0], g: s[1], b: s[2], a: 255 }), s.length > 3 && (t.a = Kt(s[3])))
...
var ms = class s {
  constructor(t) {
    ...
    let e = typeof t,
      i
    ;(e === 'object' ? (i = co(t)) : e === 'string' && (i = Hc(t) || eh(t) || oh(t)),
      (this._rgb = i),
      (this._valid = !!i))
  }
  get valid() {
...
function N(s, t, e, i) {
  ...
  else if (I(s)) for (o = Object.keys(s), r = o.length, n = 0; n < r; n++) t.call(e, s[o[n]], o[n])
}
function Ve(s, t) {
  let e, i, n, r
  if (!s || !t || s.length !== t.length) return !1
  for (e = 0, i = s.length; e < i; ++e)
    if (((n = s[e]), (r = t[e]), n.datasetIndex !== r.datasetIndex || n.index !== r.index)) return !1
  return !0
}
function ys(s) {
...
function Mo(s, t, e) {
  ...
  let i = t[s],
    n = e[s]
  I(i) && I(n) ? pe(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = ys(n))
}
...
function lh(s) {
  return (
    typeof s == 'symbol' ||
    (typeof s == 'object' && s !== null && !(Symbol.toPrimitive in s || 'toString' in s || 'valueOf' in s))
  )
}
function se(s) {
...
function ki(s, t, e) {
  ...
  if (s._sorted) {
    ...
    if (g) {
      let m = Math.max(Mt(l, o.axis, d, !0).hi + 1, e ? 0 : Mt(t, h, o.getPixelForValue(d), !0).hi + 1)
      if (c) {
...
var ai = (s) => s === 0 || s === 1,
  mo = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * H) / e)),
  ...
  fe = {
    ...
    easeInOutExpo: (s) =>
      ai(s) ? s : s < 0.5 ? 0.5 * Math.pow(2, 10 * (s * 2 - 1)) : 0.5 * (-Math.pow(2, -10 * (s * 2 - 1)) + 2),
    ...
    easeInOutElastic(s) {
      return ai(s) ? s : s < 0.5 ? 0.5 * mo(s * 2, 0.1125, 0.45) : 0.5 + 0.5 * po(s * 2 - 1, 0.1125, 0.45)
    },
    easeInBack(s) {
    ...
    easeInOutBounce: (s) => (s < 0.5 ? fe.easeInBounce(s * 2) * 0.5 : fe.easeOutBounce(s * 2 - 1) * 0.5 + 0.5),
  }
function Si(s) {
...
function uh(s) {
  ;(s.set('animation', {
    ...
    s.set('animations', { colors: { type: 'color', properties: hh }, numbers: { type: 'number', properties: ch } }),
...
var Ao = {
  ...
  logarithmic(s, t, e) {
    ...
    return [1, 2, 3, 5, 10, 15].includes(i) || t > 0.8 * e.length ? Ao.numeric.call(this, s, t, e) : ''
  },
}
function gh(s, t) {
...
function Wn(s, t, e, i) {
  ...
  ;(i.font !== t && ((n = i.data = {}), (r = i.garbageCollect = []), (i.font = t)), s.save(), (s.font = t))
  let o = 0,
    a = e.length,
    l,
    c,
  ...
  for (l = 0; l < a; l++)
    ...
    else if (B(u)) for (c = 0, h = u.length; c < h; c++) ((d = u[c]), d != null && !B(d) && (o = Ne(s, n, r, o, d)))
  s.restore()
  let f = r.length / 2
  if (f > e.length) {
...
function Ti(s, t) {
  ;(!t && !s) ||
    ((t = t || s.getContext('2d')), t.save(), t.resetTransform(), t.clearRect(0, 0, s.width, s.height), t.restore())
}
function Ts(s, t, e, i) {
  Oi(s, t, e, i, null)
}
  ...
  if (!(isNaN(m) || m <= 0)) {
    switch ((s.beginPath(), f)) {
      ...
      case 'star':
        ...
        break
      case 'line':
        ;((o = n ? n / 2 : Math.cos(p) * m), (a = Math.sin(p) * m), s.moveTo(e - o, i - a), s.lineTo(e + o, i + a))
        break
      case 'dash':
...
var xh = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
  _h = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/
function Io(s, t) {
  let e = ('' + s).match(xh)
...
function X(s, t) {
  ...
  i && !('' + i).match(_h) && (console.warn('Invalid font style specified: "' + i + '"'), (i = void 0))
  let n = {
...
var kh = (s, t) => (s ? s + ws(t) : t),
  jn = (s, t) => I(t) && s !== 'adapters' && (Object.getPrototypeOf(t) === null || t.constructor === Object)
function Lo(s, t, e) {
...
function Un(s, t, e, i) {
  ...
  return l === null || (typeof r < 'u' && r !== e && ((l = yo(a, o, r, l, i)), l === null))
    ? !1
...
function Ch(s, t, e, i) {
  let n
  for (let r of t) if (((n = Ro(kh(r, s), e)), typeof n < 'u')) return jn(s, n) ? Un(e, i, s, n) : n
}
function Ro(s, t) {
  for (let e of t) {
    if (!e) continue
...
function Yn(s, t, e, i, n) {
  let r, o, a, l
  if ((t.spanGaps && (s = s.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone')) Vo(s, n)
  else {
    let c = i ? s[s.length - 1] : s[0]
    for (r = 0, o = s.length; r < o; ++r)
      ((a = s[r]),
        (l = zo(c, a, s[Math.min(r + 1, o - (i ? 0 : 1)) % o], t.tension)),
        (a.cp1x = l.previous.x),
        (a.cp1y = l.previous.y),
        (a.cp2x = l.next.x),
        (a.cp2y = l.next.y),
...
function Zn(s, t, e, i) {
  ...
  return (
    ...
    c && !h && (h = te(c / 2)),
    (t !== void 0 || e !== void 0) && i && l.height && h > l.height && ((h = l.height), (c = te(Math.floor(h * i)))),
    { width: c, height: h }
  )
}
function Ei(s, t, e) {
  ...
  return (
    ...
    s.currentDevicePixelRatio !== i || o.height !== n || o.width !== r
      ? ((s.currentDevicePixelRatio = i), (o.height = n), (o.width = r), s.ctx.setTransform(i, 0, 0, i, 0, 0), !0)
      : !1
  )
}
var qn = (function () {
    ...
    ((y = t[M % o]),
      !y.skip &&
        ...
        b !== _ &&
          ...
          p !== null && v() && (g.push(_o({ start: p, end: M, loop: d, count: o, style: f })), (p = null)),
          (O = M),
          (_ = b))))
  return (p !== null && g.push(_o({ start: p, end: u, loop: d, count: o, style: f })), g)
}
function Ni(s, t) {
  let e = [],
    i = s.segments
...
function $h(s, t, e, i) {
  ...
  for (l = t + 1; l <= e; ++l) {
    let c = s[l % n]
    ;(c.skip || c.stop
      ? a.skip || ((i = !1), r.push({ start: t % n, end: (l - 1) % n, loop: i }), (t = o = c.stop ? l : null))
      : ((o = l), a.skip && (t = l)),
      (a = c))
  }
...
function jh(s, t, e, i) {
  ...
  function f(g, m, p, b) {
    ...
    if (g !== m) {
      ...
      for (; e[m % l].skip;) m += y
      g % l !== m % l && (c.push({ start: g % l, end: m % l, loop: p, style: b }), (h = b), (u = m % l))
    }
  }
  for (let g of t) {
    u = a ? u : g.start
    ...
    for (d = u + 1; d <= g.end; d++) {
      ...
      ;((p = ko(
        i.setContext(
          Ft(n, { type: 'segment', p0: m, p1: b, p0DataIndex: (d - 1) % l, p1DataIndex: d % l, datasetIndex: o }),
        ),
      )),
...
function Yh(s, t) {
  ...
  return e && i
    ? { left: ci(e, t, 'left'), right: ci(e, t, 'right'), top: ci(i, t, 'top'), bottom: ci(i, t, 'bottom') }
    : t
}
function zi(s, t) {
  let e = t._clip
...
var cr = class {
    ...
    _notify(t, e, i, n) {
      let r = e.listeners[n],
        o = e.duration
      r.forEach((a) => a({ chart: t, initial: e.initial, numSteps: o, currentStep: Math.min(i - e.start, o) }))
    }
    _refresh() {
      this._request ||
        ((this._running = !0),
...
function Jh(s) {
  let t, e, i, n
  return (
    I(s) ? ((t = s.top), (e = s.right), (i = s.bottom), (n = s.left)) : (t = e = i = n = s),
...
function Yo(s, t) {
  ...
  for (let f = 0; f < u; ++f) {
    ...
    ;((d = b[c] = eu(n, h, m)), (d[a] = p), (d._top = Uo(d, o, !0, i.type)), (d._bottom = Uo(d, o, !1, i.type)))
...
function su(s, t) {
  return Ft(s, { active: !1, dataset: void 0, datasetIndex: t, index: t, mode: 'default', type: 'dataset' })
}
function iu(s, t, e) {
  return Ft(s, {
    active: !1,
...
function As(s, t) {
  ...
  if (i) {
    ...
    for (let n of t) {
      ...
      ;(delete r[i][e],
        r[i]._visualValues !== void 0 && r[i]._visualValues[e] !== void 0 && delete r[i]._visualValues[e])
    }
  }
}
var tr = (s) => s === 'reset' || s === 'none',
  Zo = (s, t) => (t ? s : Object.assign({}, s)),
  nu = (s, t, e) => s && !t.hidden && t._stacked && { keys: Ba(e, !0), values: null },
  dt = class {
    constructor(t, e) {
      ;((this.chart = t),
        (this._ctx = t.ctx),
    ...
    buildOrUpdateElements(t) {
      ...
      ;((e._stacked = Kn(e.vScale, e)),
        ...
        (n || r !== e._stacked) && (Yo(this, e._parsed), (e._stacked = Kn(e.vScale, e))))
    }
    configure() {
    ...
    parsePrimitiveData(t, e, i, n) {
      let { iScale: r, vScale: o } = t,
        ...
        f,
        g
      for (d = 0, f = n; d < f; ++d) ((g = d + i), (u[d] = { [a]: h || r.parse(c[g], g), [l]: o.parse(e[g], g) }))
      return u
    }
    parseArrayData(t, e, i, n) {
      let { xScale: r, yScale: o } = t,
        ...
        h,
        u
      for (l = 0, c = n; l < c; ++l) ((h = l + i), (u = e[h]), (a[l] = { x: r.parse(u[0], h), y: o.parse(u[1], h) }))
      return a
    }
    ...
    applyStack(t, e, i) {
      let n = this.chart,
        r = this._cachedMeta,
        o = e[t.axis],
        a = { keys: Ba(n, !0), values: e._stacks[t.axis]._visualValues }
    ...
    getLabelAndValue(t) {
      let e = this._cachedMeta,
        ...
        n = e.vScale,
        r = this.getParsed(t)
      return { label: i ? '' + i.getLabelForValue(r[i.axis]) : '', value: n ? '' + n.getLabelForValue(r[n.axis]) : '' }
    }
    _update(t) {
      let e = this._cachedMeta
      ;(this.update(t || 'default'),
        (e._clip = Jh(P(this.options.clip, Xh(e.xScale, e.yScale, this.getMaxOverflow())))))
    }
    update(t) {}
    draw() {
      let t = this._ctx,
    ...
    getContext(t, e, i) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        ((r = this.$context || (this.$context = su(this.chart.getContext(), this.index))),
          (r.dataset = n),
    ...
    _resolveElementOptions(t, e = 'default', i) {
      ...
      return (m.$shared && ((m.$shared = l), (r[o] = Object.freeze(Zo(m, l)))), m)
    }
...
function au(s, t, e, i) {
  let n = e.barThickness,
    ...
    o
  return (
    E(n) ? ((r = t.min * e.categoryPercentage), (o = e.barPercentage)) : ((r = n * i), (o = 1)),
...
function qo(s, t, e, i) {
  let n = s.iScale,
    ...
    u,
    d
  for (c = e, h = e + i; c < h; ++c) ((d = t[c]), (u = {}), (u[n.axis] = a || n.parse(o[c], c)), l.push(Ha(d, u, r, c)))
  return l
}
function er(s) {
...
function du(s, t, e, i) {
  ...
  ;(n === 'middle' &&
    ...
    (e._top || 0) === i ? (n = c) : (e._bottom || 0) === i ? (n = h) : ((r[Go(h, o, a, l)] = !0), (n = c))),
    (r[Go(n, o, a, l)] = !0),
    (s.borderSkipped = r))
}
function Go(s, t, e, i) {
...
var je = class extends dt {
  ...
  parseObjectData(t, e, i, n) {
    let { iScale: r, vScale: o } = t,
      ...
      m
    for (d = i, f = i + n; d < f; ++d)
      ((m = e[d]), (g = {}), (g[r.axis] = r.parse(Lt(m, c), d)), u.push(Ha(Lt(m, h), g, o, d)))
    return u
  }
  updateRangeFromParsed(t, e, i, n) {
  ...
  updateElements(t, e, i, n) {
    ...
    for (let f = e; f < e + i; f++) {
      let g = this.getParsed(f),
        m = r || E(g[a.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
      ...
      ;(du(y, _, b, o), gu(y, _, h.ratio), this.updateElement(t[f], f, y, n))
    }
  }
  _getStacks(t, e) {
    ...
    for (let h of n)
      if (
        !(e !== void 0 && c(h)) &&
        ((r === !1 || o.indexOf(h.stack) === -1 || (r === void 0 && h.stack === void 0)) && o.push(h.stack),
        h.index === t)
      )
        break
  ...
  _getAxis() {
    ...
    for (let i of this.chart.data.datasets) t[P(this.chart.options.indexAxis === 'x' ? i.xAxisID : i.yAxisID, e)] = !0
    return Object.keys(t)
  }
  ...
  _calculateBarValuePixels(t) {
    let {
      ...
      m
    ;(f !== u && ((d = f - u), (f = u)),
      h && ((u = c.barStart), (f = c.barEnd - c.barStart), u !== 0 && yt(u) !== yt(c.barEnd) && (d = 0), (d += u)))
    let p = !E(r) && !h ? r : d,
      b = e.getPixelForValue(p)
    if ((this.chart.getDataVisibility(t) ? (g = e.getPixelForValue(d + f)) : (g = b), (m = g - b), Math.abs(m) < o)) {
      ...
      ;((b = Math.max(Math.min(b, x), w)),
        (g = b + m),
        i && !h && (l._stacks[e.axis]._visualValues[n] = e.getValueForPixel(g) - e.getValueForPixel(b)))
    }
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      let h = r ? this._getStackCount(t) : e.stackCount,
        u = n.barThickness === 'flex' ? lu(t, e, n, h * c) : au(t, e, n, h * c),
  ...
  updateElements(t, e, i, n) {
    ...
    for (let d = e; d < e + i; d++) {
      ...
      ;((m.skip = isNaN(p) || isNaN(b)),
        c &&
          ((m.options = l || this.resolveDataElementOptions(d, f.active ? 'active' : n)), r && (m.options.radius = 0)),
...
;(S(Ue, 'id', 'bubble'),
  ...
  S(Ue, 'overrides', { scales: { x: { type: 'linear' }, y: { type: 'linear' } } }))
function mu(s, t, e) {
  let i = 1,
    n = 1,
    r = 0,
...
var qt = class extends dt {
  ...
  calculateTotal() {
    ...
    for (n = 0; n < e.length; n++) {
      let r = t._parsed[n]
      r !== null && !isNaN(r) && this.chart.getDataVisibility(n) && !e[n].hidden && (i += Math.abs(r))
    }
    return i
  }
      ...
      legend: {
        labels: {
          generateLabels(t) {
            let e = t.data,
              {
                labels: { pointStyle: i, textAlign: n, color: r, useBorderRadius: o, borderRadius: a },
              } = t.legend.options
  ...
  updateElements(t, e, i, n) {
    ...
    for (let x = 0; x < _; ++x) {
      ...
      let M = this.getParsed(x),
        ...
        A = (v[f] = r || O ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, M, l) : M[f], x))
...
;(S(Ye, 'id', 'line'),
  S(Ye, 'defaults', { datasetElementType: 'line', dataElementType: 'point', showLine: !0, spanGaps: !1 }),
  S(Ye, 'overrides', { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }))
...
;(S(Rs, 'id', 'pie'), S(Rs, 'defaults', { cutout: 0, rotation: 0, circumference: 360, radius: '100%' }))
...
;(S(Ze, 'id', 'radar'),
  ...
  S(Ze, 'overrides', { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }))
var qe = class extends dt {
  ...
  update(t) {
    ...
    if (((this._drawStart = r), (this._drawCount = o), vi(e) && ((r = 0), (o = i.length)), this.options.showLine)) {
  ...
  updateElements(t, e, i, n) {
    ...
    for (let w = e; w < e + i; ++w) {
      let x = t[w],
        ...
        D = (v[g] = r || M ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, k, l) : k[g], w))
...
function ir(s, t, e, i, n, r) {
  return !r && !s.isPointInArea(t) ? [] : e === 'r' && !i ? xu(s, t, e, n) : _u(s, t, e, i, n, r)
}
function Jo(s, t, e, i, n) {
  ...
  return (
    Zs(s, e, t, (l, c, h) => {
      l[o] && l[o](t[e], n) && (r.push({ element: l, datasetIndex: c, index: h }), (a = a || l.inRange(t.x, t.y, n)))
    }),
    i && !a ? [] : r
  )
}
...
function Tu(s, t, e, i) {
  ...
  if (!I(n)) {
    ...
    ;((u.size = Math.max(u.size, e.horizontal ? r.height : r.width)), (e.size = u.size / u.count), (s[n] += e.size))
  }
...
function Ns(s, t, e, i) {
  ...
  for (r = 0, o = s.length, c = 0; r < o; ++r) {
    ;((a = s[r]), (l = a.box), l.update(a.width || t.w, a.height || t.h, Du(a.horizontal, t)))
  ...
  for (let a of s) {
    ...
    if (a.horizontal) {
      ...
      ;(be(c.start) && (o = c.start),
        l.fullSize ? Vi(l, n.left, o, e.outerWidth - n.right - n.left, d) : Vi(l, t.left + c.placed, o, u, d),
        (c.start = o),
        (c.placed += u),
        (o = l.bottom))
    } else {
      ...
      ;(be(c.start) && (r = c.start),
        l.fullSize ? Vi(l, r, n.top, d, e.outerHeight - n.bottom - n.top) : Vi(l, r, t.top + c.placed, d, u),
        (c.start = r),
        (c.placed += u),
        (r = l.right))
    }
...
var ot = {
    ...
    update(s, t, e, i) {
      ...
      let h = l.reduce((m, p) => (p.box.options && p.box.options.display === !1 ? m : m + 1), 0) || 1,
        u = Object.freeze({
          outerWidth: t,
          outerHeight: e,
          padding: n,
...
function Pu(s, t) {
  ...
  if (
    ((s[Ui] = { initial: { height: i, width: n, style: { display: e.display, height: e.height, width: e.width } } }),
...
var fr = class extends qi {
  ...
  removeEventListener(t, e) {
    let i = t.$proxies || (t.$proxies = {}),
      n = i[e]
    if (!n) return
    ;((({ attach: nr, detach: nr, resize: nr })[e] || Eu)(t, e, n), (i[e] = void 0))
  }
  getDevicePixelRatio() {
...
function Bu(s, t) {
  ...
  if (o > 0) {
    ...
    for (Wi(t, c, h, E(f) ? 0 : a - f, a), u = 0, d = o - 1; u < d; u++) Wi(t, c, h, r[u], r[u + 1])
...
function Qu(s, t, e, i) {
  ...
  if (s.isHorizontal()) {
    ...
    } else e === 'center' ? (g = (c.bottom + c.top) / 2 + m - t) : (g = ia(s, e, t))
    d = a - r
  } else {
    if (I(e)) {
      let b = Object.keys(e)[0],
    ...
    } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = ia(s, e, t))
...
var Ce = class s extends ft {
    ...
    getMinMax(t) {
      ...
      for (let l = 0, c = a.length; l < c; ++l)
        ((o = a[l].controller.getMinMax(this, t)), n || (e = Math.min(e, o.min)), r || (i = Math.max(i, o.max)))
      return ((e = r && e > i ? i : e), (i = n && e > i ? e : i), { min: at(e, at(i, e)), max: at(i, at(e, i)) })
    }
    getPadding() {
      return {
    ...
    update(t, e, i) {
      ...
      ;(this._convertTicksToLabels(l ? ra(this.ticks, a) : this.ticks),
        ...
        o.display &&
          ...
          ((this.ticks = Bu(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    generateTickLabels(t) {
      let e = this.options.ticks,
        ...
        n,
        r
      for (i = 0, n = t.length; i < n; i++) ((r = t[i]), (r.label = W(e.callback, [r.value, i, t], this)))
    }
    ...
    calculateLabelRotation() {
      ...
      ;((a = t.offset ? this.maxWidth / i : f / (i - 1)),
        u + 6 > a &&
          ...
          (l = this.maxHeight - Ls(t.grid) - e.padding - oa(t.title, this.chart.options.font)),
          (c = Math.sqrt(u * u + d * d)),
          (o = ks(
            Math.min(
    ...
    _convertTicksToLabels(t) {
      ...
      let e, i
      for (e = 0, i = t.length; e < i; e++) E(t[e].label) && (t.splice(e, 1), i--, e--)
      ...
      for (u = 0; u < e; u += l) {
        if (
          ...
          for (d = 0, f = g.length; d < f; ++d)
            ((x = g[d]), !E(x) && !B(x) && ((_ = Ne(n, b.data, b.gc, _, x)), (w += y)))
    ...
    getContext(t) {
      ...
      return this.$context || (this.$context = Xu(this.chart.getContext(), this))
    }
    _tickSize() {
    ...
    _computeGridLineItems(t) {
      let e = this.axis,
        ...
        L,
        J
      if (o === 'top') ((y = b(this.bottom)), (v = this.bottom - d), (O = y - p), (A = b(t.top) + p), (J = t.bottom))
      else if (o === 'bottom') ((y = b(this.top)), (A = t.top), (J = b(t.bottom) - p), (v = y + p), (O = this.top + d))
      else if (o === 'left')
        ((y = b(this.right)), (k = this.right - d), (M = y - p), (D = b(t.left) + p), (L = t.right))
      else if (o === 'right') ((y = b(this.left)), (D = t.left), (L = b(t.right) - p), (k = y + p), (M = this.left + d))
      else if (e === 'x') {
    ...
    _computeLabelItems(t) {
      ...
      for (b = 0, y = a.length; b < y; ++b) {
        ...
        if (V.showLabelBackdrop) {
          ...
          ii = { left: de, top: fs, width: ue + Fe.width, height: ds + Fe.height, color: V.backdropColor }
        }
        p.push({
          label: w,
          font: O,
    ...
    drawTitle() {
      ...
      e === 'bottom' || e === 'center' || I(e)
        ...
        : (l += o.top)
      let { titleX: c, titleY: h, maxWidth: u, rotation: d } = Qu(this, l, e, a)
      $t(t, i.text, 0, 0, r, {
        color: i.color,
        maxWidth: u,
        rotation: d,
  ...
  Je = class {
    ...
    register(t) {
      ...
      return (r in n || ((n[r] = t), td(t, o, i), this.override && j.override(t.id, t.overrides)), o)
    }
    get(t) {
      return this.items[t]
    }
...
function td(s, t, e) {
  ...
  ;(j.set(t, i), s.defaultRoutes && ed(t, s.defaultRoutes), s.descriptors && j.describe(t, s.descriptors))
}
function ed(s, t) {
...
var gr = class {
  ...
  mr = class {
    ...
    notify(t, e, i, n) {
      ...
      return (
        e === 'afterDestroy' &&
          (this._notify(r, t, 'stop'), this._notify(this._init, t, 'uninstall'), (this._init = void 0)),
        o
      )
    }
    _notify(t, e, i, n) {
...
function rd(s, { plugins: t, localIds: e }, i, n) {
  ...
  for (let a of t) {
    let l = a.id,
      c = nd(i[l], n)
    c !== null && r.push({ plugin: a, options: od(s.config, { plugin: a, local: e[l] }, c, o) })
  }
  return r
}
function od(s, { plugin: t, local: e }, i, n) {
  ...
  return (
    e && t.defaults && o.push(t.defaults), s.createResolver(o, n, [''], { scriptable: !1, indexable: !1, allKeys: !0 })
  )
}
function pr(s, t) {
  let e = j.datasets[s] || {}
...
function br(s, ...t) {
  if (aa(s)) return s
  for (let e of t) {
    let i = e.axis || cd(e.position) || (s.length > 1 && aa(s[0].toLowerCase()))
    if (i) return i
  }
...
function ud(s, t) {
  ...
  return (
    Object.keys(i).forEach((o) => {
      let a = i[o]
      if (!I(a)) return console.error(`Invalid scale configuration for scale: ${o}`)
...
var Fs = (s, t, e) => {
  ...
  yr = class {
    constructor(t) {
      ;((this._config = dd(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map()))
    }
    get platform() {
    ...
    datasetElementScopeKeys(t, e) {
      return Bi(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, '']])
    }
    pluginScopeKeys(t) {
      let e = t.id,
        i = this.type
    ...
    getOptionScopes(t, e, i) {
      ...
      let c = Array.from(l)
      return (c.length === 0 && c.push(Object.create(null)), Ga.has(e) && o.set(e, c), c)
    }
    chartOptionScopes() {
...
function ha(s, t, e) {
  ...
  let n = e.join(),
    r = i.get(n)
  return (
    r || ((r = { resolver: Ds(t, e), subPrefixes: e.filter((a) => !a.toLowerCase().includes('hover')) }), i.set(n, r)),
    r
  )
}
...
var xt = class {
  ...
  constructor(t, e) {
    ...
    ;((this.platform = new (i.platform || Wu(n))()), this.platform.updateConfig(i))
  ...
  _initialize() {
    return (
      ...
      this.options.responsive ? this.resize() : Ei(this, this.options.devicePixelRatio),
      this.bindEvents(),
    ...
    ;(e &&
      ...
      N(r, (o) => {
        let a = o.options,
          ...
          c = br(l, a),
          h = P(a.type, o.dtype)
        ;((a.position === void 0 || ua(a.position, c) !== ua(o.dposition)) && (a.position = o.dposition), (n[l] = !0))
        let u = null
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), i = 0, n = e.length; i < n; i++) {
      ...
      if (
        ...
        ;(Object.assign(l, { dataElementType: Nt.getElement(h), datasetElementType: c && Nt.getElement(c) }),
  ...
  _checkEventBindings() {
    let t = this.options,
      ...
      i = new Set(t.events)
    ;(!fi(e, i) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents())
  }
  ...
  _getUniformDataChanges() {
    ...
    let e = this.data.datasets.length,
      i = (r) => new Set(t.filter((o) => o[0] === r).map((o, a) => a + ',' + o.splice(1).join(','))),
      n = i(0)
  ...
  render() {
    this.notifyPlugins('beforeRender', { cancelable: !0 }) !== !1 &&
      (Yt.has(this) ? this.attached && !Yt.running(this) && Yt.start(this) : (this.draw(), fa({ chart: this })))
  }
  draw() {
    let t
  ...
  _drawDataset(t) {
    ...
    this.notifyPlugins('beforeDatasetDraw', i) !== !1 &&
      (n && Be(e, n), t.controller.draw(), n && He(e), (i.cancelable = !1), this.notifyPlugins('afterDatasetDraw', i))
  }
  isPointInArea(t) {
  ...
  _stop() {
    let t, e
    for (this.stop(), Yt.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t)
  }
  destroy() {
    ...
    ;(this._stop(),
      ...
      t && (this.unbindEvents(), Ti(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
      delete Yi[this.id],
  ...
  updateHoverStyle(t, e, i) {
    let n = i ? 'set' : 'remove',
      ...
      l
    for (
      e === 'dataset' && ((r = this.getDatasetMeta(t[0].datasetIndex)), r.controller['_' + n + 'DatasetHoverStyle']()),
        a = 0,
        l = t.length;
      a < l;
      ++a
  ...
  setActiveElements(t) {
    ...
    !Ve(i, e) && ((this._active = i), (this._lastEvent = null), this._updateHoverStyles(i, e))
  }
  notifyPlugins(t, e, i) {
  ...
  _handleEvent(t, e, i) {
    ...
    i && ((this._lastEvent = null), W(r.onHover, [t, a, this], this), l && W(r.onClick, [t, a, this], this))
    let h = !Ve(a, n)
...
function Xi(s, t, e, i, n, r) {
  ...
  let m = Math.max(0.001, g * u - e / F) / u,
    ...
    b = l + p + f,
    y = n - p - f,
    { outerStart: _, outerEnd: w, innerStart: x, innerEnd: k } = vd(t, d, u, y - b),
    v = u - _,
    M = u - w,
    O = b + _ / v,
    D = y - w / M,
...
function Md(s, t, e, i, n) {
  ...
  ;(s.setLineDash(u || []),
    (s.lineDashOffset = d),
    g ? ((s.lineWidth = c * 2), (s.lineJoin = h || 'round')) : ((s.lineWidth = c), (s.lineJoin = h || 'bevel')))
  let m = t.endAngle
  if (r) {
    Xi(s, t, e, i, m, n)
...
function Od(s) {
  return s.stepped ? Bn : s.tension || s.cubicInterpolationMode === 'monotone' ? Hn : Td
}
function Ka(s, t, e = {}) {
  let i = s.length,
...
function xr(s) {
  ...
  return !s._decimated && !s._loop && !t.tension && t.cubicInterpolationMode !== 'monotone' && !t.stepped && !e
    ? Cd
    : Dd
}
function Pd(s) {
...
function Ad(s, t, e, i) {
  let n = t._path
  ;(n || ((n = t._path = new Path2D()), t.path(n, e, i) && n.closePath()), Ja(s, t.options), s.stroke(n))
}
function Ed(s, t, e, i) {
  let { segments: n, options: r } = t,
    o = xr(t)
  for (let a of n)
    (Ja(s, r, a.style), s.beginPath(), o(s, t, a, { start: e, end: e + i - 1 }) && s.closePath(), s.stroke())
}
...
var zt = class extends ft {
  ...
  draw(t, e, i, n) {
    let r = this.options || {}
    ;((this.points || []).length && r.borderWidth && (t.save(), Ld(t, this, i, n), t.restore()),
...
;(S(Ge, 'id', 'point'),
  ...
  S(Ge, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }))
function Qa(s, t) {
  let { x: e, y: i, base: n, width: r, height: o } = s.getProps(['x', 'y', 'base', 'width', 'height'], t),
    a,
    l,
    c,
    h,
...
var Xe = class extends ft {
  ...
  draw(t) {
    ...
    ;(t.save(),
      (o.w !== r.w || o.h !== r.h) &&
        (t.beginPath(), a(t, or(o, e, r)), t.clip(), a(t, or(r, -e, o)), (t.fillStyle = i), t.fill('evenodd')),
      t.beginPath(),
      a(t, or(r, e)),
      (t.fillStyle = n),
      t.fill(),
...
var Wd = Object.freeze({ __proto__: null, ArcElement: Me, BarElement: Xe, LineElement: zt, PointElement: Ge }),
  _r = [
    'rgb(54, 162, 235)',
    'rgb(255, 99, 132)',
    'rgb(255, 159, 64)',
...
function jd(s) {
  ...
  return (e, i) => {
    ...
    n instanceof qt ? (t = Hd(e, t)) : n instanceof Oe ? (t = $d(e, t)) : n && (t = Bd(e, t))
  }
}
function ya(s) {
  let t
...
function qd(s, t, e, i, n) {
  ...
  for (o[l++] = s[h], u = 0; u < r - 2; u++) {
    ...
    let k = Math.floor(u * a) + 1 + t,
      ...
      { x: M, y: O } = s[h]
    for (f = g = -1, y = k; y < v; y++)
      ((g = 0.5 * Math.abs((M - p) * (s[y].y - O) - (M - s[y].x) * (b - O))), g > f && ((f = g), (d = s[y]), (m = y)))
    ;((o[l++] = d), (h = m))
  }
  return ((o[l++] = s[c]), o)
}
function Gd(s, t, e, i) {
  ...
  for (o = t; o < t + e; ++o) {
    ...
    let x = l | 0
    if (x === h) (c < g ? ((g = c), (u = o)) : c > m && ((m = c), (d = o)), (n = (r * n + a.x) / ++r))
    else {
      let k = o - 1
      if (!E(u) && !E(d)) {
        let v = Math.min(u, d),
          M = Math.max(u, d)
        ;(v !== f && v !== k && p.push({ ...s[v], x: n }), M !== f && M !== k && p.push({ ...s[M], x: n }))
      }
...
function sl(s) {
  if (s._decimated) {
    ...
    ;(delete s._decimated,
      delete s._data,
      Object.defineProperty(s, 'data', { configurable: !0, enumerable: !0, writable: !0, value: t }))
  }
}
function xa(s) {
...
function ar(s, t, e) {
  ...
  i &&
    o.points.length &&
    (Be(s, e), pf(s, { line: o, target: i, above: d, below: f, area: e, scale: a, axis: l, clip: m }), He(s))
}
function pf(s, t) {
...
function lr(s, t) {
  ...
  for (let { source: c, target: h, start: u, end: d } of l) {
    let { style: { backgroundColor: f = r } = {} } = c,
      g = i !== !0
    ;(s.save(), (s.fillStyle = f), bf(s, o, a, g && wr(n, u, d)), s.beginPath())
...
function bf(s, t, e, i) {
  ...
  if (r === 'x' || r === 'y') {
    let l, c, h, u
    ;(r === 'x' ? ((l = o), (c = n.top), (h = a), (u = n.bottom)) : ((l = n.left), (c = o), (h = n.right), (u = a)),
      s.beginPath(),
      e &&
        ((l = Math.max(l, e.left)), (h = Math.min(h, e.right)), (c = Math.max(c, e.top)), (u = Math.min(u, e.bottom))),
      s.rect(l, c, h - l, u - c),
      s.clip())
  }
}
...
var yf = {
    ...
    afterDatasetsUpdate(s, t, e) {
      ...
      for (o = 0; o < i; ++o)
        ((r = s.getDatasetMeta(o)),
          ...
          (r.$filler = l),
          n.push(l))
      for (o = 0; o < i; ++o) ((l = n[o]), !(!l || l.fill === !1) && (l.fill = tf(n, o, e.propagate)))
    },
    beforeDraw(s, t, e) {
    ...
    beforeDatasetDraw(s, t, e) {
      let i = t.meta.$filler
      !wa(i) || e.drawTime !== 'beforeDatasetDraw' || ar(s.ctx, i, s.chartArea)
    },
  ...
  xf = (s, t) => s !== null && t !== null && s.datasetIndex === t.datasetIndex && s.index === t.index,
  Ki = class extends ft {
    constructor(t) {
      ;(super(),
        (this._added = !1),
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (let c of e)
          (a !== c.row && ((a = c.row), (l = et(i, this.left + n, this.right - this.lineWidths[a]))),
            (c.top += this.top + t + n),
        ...
        for (let c of e)
          (c.col !== a && ((a = c.col), (l = et(i, this.top + t + n, this.bottom - this.columnSizes[a].height))),
            (c.top = l),
            (c.left += this.left + n),
    ...
    _draw() {
      ...
      let { boxWidth: g, boxHeight: m, itemHeight: p } = Ma(o, u),
        b = function (k, v, M) {
          ...
          if (
            ...
            let D = { radius: (m * Math.SQRT2) / 2, pointStyle: M.pointStyle, rotation: M.rotation, borderWidth: O },
              A = l.xPlus(k, g / 2),
              L = v + d
            ...
            let D = v + Math.max((u - m) / 2, 0),
              ...
              L = jt(M.borderRadius)
            ;(n.beginPath(),
              Object.values(L).some((J) => J !== 0) ? we(n, { x: A, y: D, w: g, h: m, radius: L }) : n.rect(A, D, g, m),
              n.fill(),
              O !== 0 && n.stroke())
          }
          n.restore()
        ...
        y = function (k, v, M) {
          $t(n, M.text, k, v + p / 2, c, { strikethrough: M.hidden, textAlign: l.textAlign(M.textAlign) })
        },
        _ = this.isHorizontal(),
        w = this._computeTitleHeight()
      ;(_
        ? (f = { x: et(r, this.left + h, this.right - i[0]), y: this.top + h + w, line: 0 })
        : (f = { x: this.left + h, y: et(r, this.top + w + h, this.bottom - e[0].height), line: 0 }),
      ...
      ;(this.legendItems.forEach((k, v) => {
        ...
        let J = l.x(A)
        if ((b(J, L, k), (A = Vn(O, A + g + d, _ ? A + D : this.right, t.rtl)), y(l.x(A), L, k), _)) f.x += D + h
    ...
    drawTitle() {
      ...
      if (this.isHorizontal())
        ...
        h = c + et(t.align, this.top, this.bottom - g - t.labels.padding - this._computeTitleHeight())
      }
      let f = et(a, u, u + d)
      ...
      labels: {
        ...
        generateLabels(s) {
          let t = s.data.datasets,
            {
              labels: { usePointStyle: e, pointStyle: i, textAlign: n, color: r, useBorderRadius: o, borderRadius: a },
            } = s.legend.options
...
var Tf = {
  ...
  zs = {
    average(s) {
      ...
      return r === 0 || i.size === 0 ? !1 : { x: [...i].reduce((a, l) => a + l) / i.size, y: n / r }
    },
    nearest(s, t) {
      if (!s.length) return !1
      let e = t.x,
...
var $s = class extends ft {
  ...
  getContext() {
    return this.$context || (this.$context = Lf(this.chart.getContext(), this, this._tooltipItems))
  }
  getTitle(t, e) {
    let { callbacks: i } = e,
  ...
  _drawColorBox(t, e, i, n, r) {
    let o = this.labelColors[i],
      ...
      g = e.y + f
    if (r.usePointStyle) {
      let m = { radius: Math.min(c, l) / 2, pointStyle: a.pointStyle, rotation: a.rotation, borderWidth: 1 },
      ...
      ;((t.lineWidth = I(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1),
        (t.strokeStyle = o.borderColor),
  ...
  drawBody(t, e, i) {
    let { body: n } = this,
      { bodySpacing: r, bodyAlign: o, displayColors: a, boxHeight: l, boxWidth: c, boxPadding: h } = i,
      u = X(i.bodyFont),
      d = u.lineHeight,
      f = 0,
  ...
  drawFooter(t, e, i) {
    ...
    if (r) {
      ...
      for (
        ...
        (e.fillText(n[a], l.x(t.x), t.y + o.lineHeight / 2), (t.y += o.lineHeight + i.footerSpacing))
    }
  }
...
var Ff = {
  ...
  Nf = (s, t, e, i) => (
    typeof t == 'string' ? ((e = s.push(t) - 1), i.unshift({ index: e, label: t })) : isNaN(t) && (e = null),
    e
  )
function zf(s, t, e, i) {
  let n = s.indexOf(t)
...
var Vs = class extends Ce {
  ...
  parse(t, e) {
    if (E(t)) return null
    let i = this.getLabels()
    return ((e = isFinite(e) && i[e] === t ? e : zf(i, t, P(e, t), this._addedLabels)), Vf(e, i.length - 1))
  }
  determineDataLimits() {
...
function Wf(s, t) {
  let e = [],
    { bounds: n, step: r, min: o, max: a, precision: l, count: c, maxTicks: h, maxDigits: u, includeBounds: d } = s,
    f = r || 1,
    g = h - 1,
    { min: m, max: p } = t,
    b = !E(o),
  ...
  ;((O = Math.ceil(p / x) - Math.floor(m / x)),
    ...
    b && y && r && In((a - o) / r, x / 1e3)
      ...
      : _
        ...
        : ((O = (M - v) / x), ye(O, Math.round(O), x / 1e3) ? (O = Math.round(O)) : (O = Math.ceil(O))))
  let D = Math.max(pi(x), pi(v))
  ;((k = Math.pow(10, E(l) ? D : l)), (v = Math.round(v * k) / k), (M = Math.round(M * k) / k))
  let A = 0
  for (
    b &&
    (d && v !== o
      ? (e.push({ value: o }), v < o && A++, ye(Math.round((v + A * x) * k) / k, o, Ea(o, w, s)) && A++)
      : v < o && A++);
    A < O;
    ++A
  ) {
...
var Bs = class extends Ce {
  ...
  getPixelForValue(t) {
    return (
      ...
      t === null || isNaN(t)
        ? NaN
        : this.getPixelForDecimal(t === this.min ? 0 : (It(t) - this._startValue) / this._valueRange)
    )
  }
  getValueForPixel(t) {
...
function jf(s) {
  ...
  ;(s.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (s._pointLabelItems = qf(s, i, n)))
}
...
function Zf(s, t) {
  ...
  return !(Tt({ x: e, y: i }, t) || Tt({ x: e, y: r }, t) || Tt({ x: n, y: i }, t) || Tt({ x: n, y: r }, t))
}
function qf(s, t, e) {
  let i = [],
  ...
  for (let h = 0; h < n; h++) {
    ...
    let u = Yf(s, h, l)
    ;(i.push(u), a === 'auto' && ((u.visible = Zf(u, c)), u.visible && (c = u)))
  }
  return i
}
function Gf(s) {
...
function Qf(s, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    ...
    $t(e, s._pointLabels[n], l, c + a.lineHeight / 2, a, { color: o.color, textAlign: h, textBaseline: 'middle' })
  }
}
function ol(s, t, e, i) {
  let { ctx: n } = s
...
var Te = class extends Ke {
  ...
  determineDataLimits() {
    ...
    ;((this.min = Y(t) && !isNaN(t) ? t : 0), (this.max = Y(e) && !isNaN(e) ? e : 0), this.handleTickRangeOptions())
  }
  computeTickLimit() {
  ...
  fit() {
    let t = this.options
    t.display && t.pointLabels.display ? jf(this) : this.setCenterPoint(0, 0, 0, 0)
  }
  ...
  drawBackground() {
    ...
    if (t) {
      ...
      ;(i.save(),
        i.beginPath(),
        ol(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
        i.closePath(),
        (i.fillStyle = t),
        i.fill(),
        i.restore())
  ...
  drawLabels() {
    ...
    ;(t.save(),
      ...
      this.ticks.forEach((a, l) => {
        ...
        $t(t, a.label, 0, -r, h, { color: c.color, strokeColor: c.textStrokeColor, strokeWidth: c.textStrokeWidth })
      }),
      t.restore())
  }
  drawTitle() {}
...
function Na(s, t) {
  ...
  return (
    ...
    o === null
      ? null
      : (n && (o = n === 'week' && (se(r) || r === !0) ? e.startOf(o, 'isoWeek', r) : e.startOf(o, n)), +o)
  )
}
function za(s, t, e, i) {
  let n = ct.length
...
var De = class extends Ce {
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (i.autoSkip
          ? za(e.minUnit, this.min, this.max, this._getLabelCapacity(r))
          : sg(this, a.length, e.minUnit, this.min, this.max))),
      (this._majorUnit = !i.major.enabled || this._unit === 'year' ? void 0 : ig(this._unit)),
      this.initOffsets(n),
      t.reverse && a.reverse(),
  ...
  initOffsets(t = []) {
    ...
    ;((e = K(e, 0, o)), (i = K(i, 0, o)), (this._offsets = { start: e, end: i, factor: 1 / (e + 1 + i) }))
  }
  _generate() {
    let t = this._adapter,
      e = this.min,
      ...
      d,
      f
    if ((c && (u = +t.startOf(u, 'isoWeek', l)), (u = +t.startOf(u, c ? 'day' : o)), t.diff(i, e, o) > 1e5 * a))
  ...
  _getLabelCapacity(t) {
    let e = this.options.time,
      ...
      r = this._tickFormatFunction(t, 0, Wa(this, [t], this._majorUnit), n),
...
var Xt = class extends Error {},
  ...
  tc = { year: T, month: pt, day: T, hour: T, minute: T, second: T, timeZoneName: At },
  ec = { year: T, month: pt, day: T, weekday: pt, hour: T, minute: T, timeZoneName: pt },
  sc = { year: T, month: pt, day: T, weekday: pt, hour: T, minute: T, second: T, timeZoneName: pt },
  Ie = class {
    get type() {
      throw new Vt()
    }
...
var Mr = new Map(),
  he = class s extends Ie {
    ...
    offset(t) {
      ...
      a === 'BC' && (n = -Math.abs(n) + 1)
      let d = bn({ year: n, month: r, day: o, hour: l === 24 ? 0 : l, minute: c, second: h, millisecond: 0 }),
        f = +e,
        g = f % 1e3
...
function wg(s) {
  return s.numberingSystem && s.numberingSystem !== 'latn'
    ? !1
    : s.numberingSystem === 'latn' || !s.locale || s.locale.startsWith('en') || ic(s.locale).numberingSystem === 'latn'
}
var $r = class {
    constructor(t, e, i) {
      ...
      if (!e || Object.keys(o).length > 0) {
        ...
        ;(i.padTo > 0 && (a.minimumIntegerDigits = i.padTo), (this.inf = fg(t, a)))
      }
    }
    format(t) {
      if (this.inf) {
  ...
  Ur = class {
    constructor(t, e, i) {
      ;((this.opts = { style: 'long', ...i }), !e && uc() && (this.rtf = gg(t, i)))
    }
    format(t, e) {
      return this.rtf ? this.rtf.format(t, e) : Hg(e, t, this.opts.numeric, this.opts.style !== 'long')
    }
    formatToParts(t, e) {
  ...
  $ = class s {
    ...
    constructor(t, e, i, n, r) {
      ...
      ;((this.locale = o),
        ...
        (this.weekSettings = n),
        (this.intl = yg(this.locale, this.numberingSystem, this.outputCalendar)),
    ...
    get fastNumbers() {
      return (this.fastNumbersCached == null && (this.fastNumbersCached = wg(this)), this.fastNumbersCached)
    }
    listingMode() {
    ...
    weekdays(t, e = !1) {
      return en(this, t, xc, () => {
        ...
        return (
          this.weekdaysCache[n][t] || (this.weekdaysCache[n][t] = _g((r) => this.extract(r, i, 'weekday'))),
    ...
    eras(t) {
      return en(this, t, wc, () => {
        ...
        return (
          this.eraCache[t] ||
            (this.eraCache[t] = [R.utc(-40, 1, 1), R.utc(2017, 1, 1)].map((i) => this.extract(i, e, 'era'))),
          this.eraCache[t]
        )
      })
    }
    ...
    isEnglish() {
      return this.locale === 'en' || this.locale.toLowerCase() === 'en-us' || ic(this.intl).locale.startsWith('en-us')
    }
    getWeekSettings() {
      return this.weekSettings ? this.weekSettings : dc() ? pg(this.locale) : nc
    }
    getStartOfWeek() {
...
function wt(s, t) {
  return new mt('unit out of range', `you specified ${t} (of type ${typeof t}) as a ${s}, which is invalid`)
}
function Kr(s, t, e) {
...
function Mg(s, t = 4, e = 1) {
  let i = pn(s.weekYear),
    ...
    r = kt(s.weekday, 1, 7)
  return i ? (n ? (r ? !1 : wt('weekday', s.weekday)) : wt('week', s.weekNumber)) : wt('weekYear', s.weekYear)
}
function Tg(s) {
  let t = pn(s.year),
...
function hc(s) {
  let { hour: t, minute: e, second: i, millisecond: n } = s,
    ...
    a = kt(i, 0, 59),
    l = kt(n, 0, 999)
  return r ? (o ? (a ? (l ? !1 : wt('millisecond', n)) : wt('second', i)) : wt('minute', e)) : wt('hour', t)
}
function C(s) {
  return typeof s > 'u'
}
...
function gc(s) {
  let t = Number(s)
  if (typeof s == 'boolean' || s === '' || !Number.isFinite(t)) throw new it(`Invalid unit value ${s}`)
  return t
}
function gn(s, t) {
  let e = {}
...
var bc = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
...
var $g = {
  ...
  gt = class s {
    ...
    static parseFormat(t) {
      ...
      for (let o = 0; o < t.length; o++) {
        let a = t.charAt(o)
        a === "'"
          ? ((i.length > 0 || n) && r.push({ literal: n || /^\s+$/.test(i), val: i === '' ? "'" : i }),
            (e = null),
            (i = ''),
            (n = !n))
          : n || a === e
    ...
    formatDateTimeFromString(t, e) {
      let i = this.loc.listingMode() === 'en',
        ...
        o = (f) =>
          t.isOffsetFixed && t.offset === 0 && f.allowZ ? 'Z' : t.isValid ? t.zone.formatOffset(t.ts, f.format) : '',
        a = () => (i ? zg(t) : r({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')),
        l = (f, g) => (i ? Wg(t, f) : r(g ? { month: f } : { month: f, day: 'numeric' }, 'month')),
        c = (f, g) => (i ? Vg(t, f) : r(g ? { weekday: f } : { weekday: f, month: 'long', day: 'numeric' }, 'weekday')),
        h = (f) => {
  ...
  kc = /[A-Za-z_+-]{1,256}(?::?\/[A-Za-z0-9_+-]{1,256}(?:\/[A-Za-z0-9_+-]{1,256})?)?/
function ls(...s) {
...
function us(s, t) {
  return [
    { hours: rs(s, t, 0), minutes: rs(s, t + 1, 0), seconds: rs(s, t + 2, 0), milliseconds: to(s[t + 3]) },
    null,
    t + 4,
  ]
}
...
var sm = { GMT: 0, EDT: -240, EST: -300, CDT: -300, CST: -360, MDT: -360, MST: -420, PDT: -420, PST: -480 }
function no(s, t, e, i, n, r, o) {
  let a = { year: t.length === 2 ? Gr(oe(t)) : oe(t), month: mc.indexOf(e) + 1, day: oe(i), hour: oe(n), minute: oe(r) }
  return (o && (a.second = oe(o)), s && (a.weekday = s.length > 3 ? bc.indexOf(s) + 1 : yc.indexOf(s) + 1), a)
}
var im =
...
var Ml = 'Invalid Duration',
  ...
  Ee = ['years', 'quarters', 'months', 'weeks', 'days', 'hours', 'minutes', 'seconds', 'milliseconds'],
...
var nt = class s {
    ...
    static fromObject(t, e = {}) {
      if (t == null || typeof t != 'object')
        throw new it(`Duration.fromObject: argument expected to be an object, got ${t === null ? 'null' : typeof t}`)
      return new s({
    ...
    toFormat(t, e = {}) {
      ...
      return this.isValid ? gt.create(this.loc, i).formatDurationFromString(this, t) : Ml
    }
    toHuman(t = {}) {
      ...
      let e = t.showZeros !== !1,
        i = Ee.map((n) => {
          ...
          return C(r) || (r === 0 && !e)
            ? null
            : this.loc.numberFormatter({ style: 'unit', unitDisplay: 'long', ...t, unit: n.slice(0, -1) }).format(r)
        }).filter((n) => n)
    ...
    toISO() {
      ...
      return (
        ...
        (this.seconds !== 0 || this.milliseconds !== 0) && (t += eo(this.seconds + this.milliseconds / 1e3, 3) + 'S'),
        t === 'P' && (t += 'T0S'),
        t
      )
    }
    ...
    mapUnits(t) {
      if (!this.isValid) return this
      let e = {}
      for (let i of Object.keys(this.values)) e[i] = gc(t(this.values[i], i))
    ...
    reconfigure({ locale: t, numberingSystem: e, conversionAccuracy: i, matrix: n } = {}) {
      let o = { loc: this.loc.clone({ locale: t, numberingSystem: e }), matrix: n, conversionAccuracy: i }
      return Gt(this, o)
    }
    as(t) {
...
var os = class s {
    ...
    static xor(t) {
      ...
      for (let l of a)
        ((i += l.type === 's' ? 1 : -1),
          i === 1 ? (e = l.time) : (e && +e != +l.time && n.push(s.fromDateTimes(e, l.time)), (e = null)))
      return s.merge(n)
    }
    difference(...t) {
      return s
  ...
  is = class {
    ...
    static months(
      t = 'long',
      { locale: e = null, numberingSystem: i = null, locObj: n = null, outputCalendar: r = 'gregory' } = {},
    ) {
...
function Pt(s, t) {
  return s === null
    ? null
    : { regex: RegExp(s.map(Fm).join('|')), deser: ([e]) => s.findIndex((i) => Cl(e) === Cl(i)) + t }
}
function Pl(s, t) {
...
function Nm(s, t) {
  let e = Ct(t),
    ...
    u = Ct(t, '{2,4}'),
    d = Ct(t, '{4,6}'),
    f = (p) => ({ regex: RegExp(Rm(p.val)), deser: ([b]) => b, literal: !0 }),
    m = ((p) => {
...
var mn = class {
  ...
  explainFromTokens(t) {
    if (this.isValid) {
      ...
      if (as(i, 'a') && as(i, 'H')) throw new le("Can't include meridiem when specifying 24-hour format")
      return {
        input: t,
        tokens: this.tokens,
        regex: this.regex,
...
function Ar(s) {
  return (
    s.localWeekData === null && (s.localWeekData = dn(s.c, s.loc.getMinDaysInFirstWeek(), s.loc.getStartOfWeek())),
    s.localWeekData
  )
}
function Ae(s, t) {
...
function El(s, t) {
  let e = s.o,
    ...
    r = { ...s.c, year: i, month: n, day: Math.min(s.c.day, fn(i, n)) + Math.trunc(t.days) + Math.trunc(t.weeks) * 7 },
    o = nt
      .fromObject({
...
function rn(s, t, e = !0) {
  return s.isValid ? gt.create($.create('en-US'), { allowZ: e, forceSimple: !0 }).formatDateTimeFromString(s, t) : null
}
function Er(s, t, e) {
...
var Rc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
  Ym = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function Rl(s, t, e) {
  let i = C(e.round) ? !0 : e.round,
    ...
    o = (a) => (e.calendary ? (t.hasSame(s, a) ? 0 : t.startOf(a).diff(s.startOf(a), a).get(a)) : t.diff(s, a).get(a))
  ...
  R = class s {
    constructor(t) {
      let e = t.zone || Z.defaultZone,
        i = t.invalid || (Number.isNaN(t.ts) ? new mt('invalid input') : null) || (e.isValid ? null : Xs(e))
    ...
    static local() {
      let [t, e] = Nl(arguments),
        [i, n, r, o, a, l, c] = e
      return Fl({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t)
    }
    static utc() {
      let [t, e] = Nl(arguments),
        [i, n, r, o, a, l, c] = e
      return (
        (t.zone = vt.utcInstance), Fl({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t)
      )
    }
    ...
    static fromSeconds(t, e = {}) {
      if (ce(t)) return new s({ ts: t * 1e3, zone: ae(e.zone, Z.defaultZone), loc: $.fromObject(e) })
    ...
    static fromObject(t, e = {}) {
      ...
      if ((f || h) && g) throw new le("Can't mix weekYear/weekNumber units with year/month/day or ordinals")
      if (d && h) throw new le("Can't mix ordinal dates with month/day")
      let m = g || (r.weekday && !f),
        p,
        b,
        y = nn(l, c)
      m ? ((p = qm), (b = Ym), (y = dn(y, o, a))) : h ? ((p = Gm), (b = Zm), (y = Or(y))) : ((p = an), (b = Rc))
      let _ = !1
      for (let D of p) {
        let A = r[D]
      ...
      return r.weekday && f && t.weekday !== O.weekday
        ? s.invalid('mismatched weekday', `you can't specify both a weekday of ${r.weekday} and a date of ${O.toISO()}`)
        : O.isValid
          ? O
          : s.invalid(O.invalid)
    }
    ...
    get weeksInLocalWeekYear() {
      return this.isValid ? Qs(this.localWeekYear, this.loc.getMinDaysInFirstWeek(), this.loc.getStartOfWeek()) : NaN
    }
    resolvedLocaleOptions(t = {}) {
      let { locale: e, numberingSystem: i, calendar: n } = gt.create(this.loc.clone(t), t).resolvedOptions(this)
    ...
    set(t) {
      ...
      if ((c || o) && h) throw new le("Can't mix weekYear/weekNumber units with year/month/day or ordinals")
      if (l && o) throw new le("Can't mix ordinal dates with month/day")
      let u
      r
        ? (u = yl({ ...dn(this.c, i, n), ...e }, i, n))
        : C(e.ordinal)
          ? ((u = { ...this.toObject(), ...e }), C(e.day) && (u.day = Math.min(fn(u.year, u.month), u.day)))
          : (u = xl({ ...Or(this.c), ...e }))
    ...
    toFormat(t, e = {}) {
      return this.isValid ? gt.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(this, t) : Cr
    }
    toLocaleString(t = hn, e = {}) {
    ...
    toISOTime({
      ...
      return this.isValid
        ? ((a = ln(a)), (n && an.indexOf(a) >= 3 ? 'T' : '') + Il(this, o === 'extended', e, t, i, r, a))
        : null
    }
    toRFC2822() {
    ...
    toRelative(t = {}) {
      ...
      return (
        ...
        Rl(e, this.plus(i), { ...t, numeric: 'always', units: n, unit: r })
      )
    }
    ...
    static fromFormatParser(t, e, i = {}) {
      if (C(t) || C(e)) throw new it('fromFormatParser requires an input string and a format parser')
      let { locale: n = null, numberingSystem: r = null } = i,
        o = $.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 })
      if (!o.equals(e.locale))
        throw new it(`fromFormatParser called with a locale of ${o}, but the format parser was created for ${e.locale}`)
...
function Km({ cachedData: s, options: t, type: e }) {
  return {
      ...
      ;(t ?? (t = {}),
        ...
        ['doughnut', 'pie', 'polarArea'].includes(e) &&
          ...
          (k = t.plugins.legend.labels).generateLabels ??
            (k.generateLabels = (A) => {
              let L = Qe.overrides[e].plugins.legend.labels.generateLabels(A)
        ...
        new Qe(this.$refs.canvas, { type: e, data: s, options: t, plugins: window.filamentChartJsPlugins ?? [] }))
    },
    updateChartData(i) {
      let n = this.getChart()
    ...
    normalizeDatasets(i) {
      for (let n of i?.datasets ?? [])
        (e === 'bar' &&
          ...
          e === 'scatter' && n.backgroundColor !== void 0 && (n.borderColor ?? (n.borderColor = n.backgroundColor)),
    ...
    updateChartTheme() {
      let i = this.getChart()
      i && (this.applyChartColors(i.options), this.applyChartCustomProperties(i.options), i.update('resize'))
    },
    applyChartColors(i) {
      var d, f, g
      let {
      ...
      ;((i.backgroundColor = this.userBackgroundColor ?? n),
        ...
        this.$refs.tooltipBackgroundColorElement &&
          ...
          (i.plugins.tooltip.backgroundColor = this.userTooltipBackgroundColor ?? l),
          (i.plugins.tooltip.titleColor = this.userTooltipTitleColor ?? c),
          (i.plugins.tooltip.bodyColor = this.userTooltipBodyColor ?? c),
          (i.plugins.tooltip.borderColor = this.userTooltipBorderColor ?? h)),
        ['doughnut', 'pie', 'polarArea'].includes(e) &&
          ((g = i.elements).arc ?? (g.arc = {}), (i.elements.arc.borderColor = this.getSurroundingBackgroundColor())),
    ...
    getChartColors() {
      ...
      return {
        ...
        tooltipBackgroundColor: i(this.$refs.tooltipBackgroundColorElement),
    ...
    applyChartCustomProperties(i) {
      ...
      ;((i.borderWidth = this.userBorderWidth ?? u),
        ...
        (i.plugins.tooltip.cornerRadius = this.userTooltipCornerRadius ?? a),
        (i.plugins.tooltip.borderWidth = this.userTooltipBorderWidth ?? l))
      ...
      ;((m = i.plugins).legend ?? (m.legend = {}),
        ...
        (i.plugins.legend.labels.useBorderRadius = this.userLegendUseBorderRadius ?? f > 0),
        (i.plugins.legend.labels.boxWidth = this.userLegendBoxWidth ?? h))
    },
