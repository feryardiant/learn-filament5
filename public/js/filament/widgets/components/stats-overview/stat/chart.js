...
var to = (i, t, e) => (t in i ? Qn(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (i[t] = e))
...
var ro = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/
function ts(i, t, e) {
...
function Je(i) {
  ...
  return (
    o !== a &&
      ((h = o - a), (c = r > 0.5 ? h / (2 - o - a) : h / (o + a)), (l = ho(e, s, n, h, o)), (l = l * 60 + 0.5)),
    [l | 0, c || 0, r]
  )
}
function Ze(i, t, e, s) {
...
function go(i) {
  ...
  let n = es(+t[2]),
    ...
    a = +t[4] / 100
  return (
    t[1] === 'hwb' ? (s = uo(n, o, a)) : t[1] === 'hsv' ? (s = fo(n, o, a)) : (s = Qe(n, o, a)),
    { r: s[0], g: s[1], b: s[2], a: e }
  )
}
function po(i, t) {
  var e = Je(i)
  ;((e[0] = es(e[0] + t)), (e = Qe(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]))
}
function mo(i) {
  if (!i) return
  let t = Je(i),
...
function bo() {
  ...
  for (s = 0; s < t.length; s++) {
    for (a = r = t[s], n = 0; n < e.length; n++) ((o = e[n]), (r = r.replace(o, Ji[o])))
...
var _o = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/
function yo(i) {
  let t = _o.exec(i),
    e = 255,
    s,
...
function vo(i) {
  return i && (i.a < 255 ? `rgba(${i.r}, ${i.g}, ${i.b}, ${et(i.a)})` : `rgb(${i.r}, ${i.g}, ${i.b})`)
}
...
function Qi(i) {
  ...
  return (
    Array.isArray(i)
      ? i.length >= 3 && ((t = { r: i[0], g: i[1], b: i[2], a: 255 }), i.length > 3 && (t.a = lt(i[3])))
...
var Kt = class i {
  constructor(t) {
    ...
    let e = typeof t,
      s
    ;(e === 'object' ? (s = Qi(t)) : e === 'string' && (s = no(t) || xo(t) || ko(t)),
      (this._rgb = s),
      (this._valid = !!s))
  }
  get valid() {
...
var gs = (i, t) => (typeof i == 'string' && i.endsWith('%') ? (parseFloat(i) / 100) * t : +i)
function L(i, t, e) {
...
function W(i, t, e, s) {
  ...
  else if (S(i)) for (a = Object.keys(i), o = a.length, n = 0; n < o; n++) t.call(e, i[a[n]], a[n])
}
function ni(i, t) {
  let e, s, n, o
...
function Ao(i) {
  return (
    typeof i == 'symbol' ||
    (typeof i == 'object' && i !== null && !(Symbol.toPrimitive in i || 'toString' in i || 'valueOf' in i))
  )
}
function Bt(i) {
...
function Cs(i, t, e) {
  ...
  if (i._sorted) {
    ...
    if (m) {
      let g = Math.max(ht(l, a.axis, u, !0).hi + 1, e ? 0 : ht(t, h, a.getPixelForValue(u), !0).hi + 1)
      if (c) {
...
var xe = (i) => i === 0 || i === 1,
  os = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * j) / e)),
  ...
  Rt = {
    ...
    easeInOutExpo: (i) =>
      xe(i) ? i : i < 0.5 ? 0.5 * Math.pow(2, 10 * (i * 2 - 1)) : 0.5 * (-Math.pow(2, -10 * (i * 2 - 1)) + 2),
    ...
    easeInOutElastic(i) {
      return xe(i) ? i : i < 0.5 ? 0.5 * os(i * 2, 0.1125, 0.45) : 0.5 + 0.5 * as(i * 2 - 1, 0.1125, 0.45)
    },
    easeInBack(i) {
    ...
    easeInOutBounce: (i) => (i < 0.5 ? Rt.easeInBounce(i * 2) * 0.5 : Rt.easeOutBounce(i * 2 - 1) * 0.5 + 0.5),
  }
function pi(i) {
...
function Eo(i) {
  ;(i.set('animation', {
    ...
    i.set('animations', { colors: { type: 'color', properties: Ro }, numbers: { type: 'number', properties: Lo } }),
...
var As = {
  ...
  logarithmic(i, t, e) {
    ...
    return [1, 2, 3, 5, 10, 15].includes(s) || t > 0.8 * e.length ? As.numeric.call(this, i, t, e) : ''
  },
}
function zo(i, t) {
...
function Ts(i, t, e, s) {
  ...
  for (l = 0; l < r; l++)
    ...
    else if (A(d)) for (c = 0, h = d.length; c < h; c++) ((u = d[c]), u != null && !A(u) && (a = Jt(i, n, o, a, u)))
  i.restore()
  let f = o.length / 2
  if (f > e.length) {
...
var Xo = (i, t) => (i ? i + we(t) : t),
  yi = (i, t) => S(t) && i !== 'adapters' && (Object.getPrototypeOf(t) === null || t.constructor === Object)
function Ws(i, t, e) {
...
function vi(i, t, e, s) {
  ...
  return l === null || (typeof o < 'u' && o !== e && ((l = ls(r, a, o, l, s)), l === null))
    ? !1
...
function ta(i, t, e, s) {
  let n
  for (let o of t) if (((n = Hs(Xo(o, i), e)), typeof n < 'u')) return yi(i, n) ? vi(e, s, i, n) : n
}
function Hs(i, t) {
  for (let e of t) {
    if (!e) continue
...
function aa(i, t = 'x') {
  ...
  for (a = 0; a < s; ++a)
    if (((r = l), (l = c), (c = Ft(i, a + 1)), !!l)) {
      ...
      o[a] = r ? (c ? (vt(n[a - 1]) !== vt(n[a]) ? 0 : (n[a - 1] + n[a]) / 2) : n[a - 1]) : n[a]
    }
  ;(na(i, n, o), oa(i, o, t))
}
function _e(i, t, e) {
...
function ra(i, t) {
  ...
  for (e = 0, s = i.length; e < s; ++e)
    ((a = o),
      ...
      o &&
        ((n = i[e]),
        a && ((n.cp1x = _e(n.cp1x, t.left, t.right)), (n.cp1y = _e(n.cp1y, t.top, t.bottom))),
        r && ((n.cp2x = _e(n.cp2x, t.left, t.right)), (n.cp2y = _e(n.cp2y, t.top, t.bottom)))))
}
function $s(i, t, e, s, n) {
  ...
  if ((t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone')) aa(i, n)
    ...
    for (o = 0, a = i.length; o < a; ++o)
      ((r = i[o]),
        (l = sa(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
...
function pt(i, t) {
  ...
  return (
    ...
    { x: Math.round((((l - d) / f) * e.width) / s), y: Math.round((((c - u) / m) * e.height) / s) }
  )
}
function ua(i, t, e) {
  let s, n
...
function Ys(i, t, e, s) {
  ...
  return (
    ...
    c && !h && (h = dt(c / 2)),
    (t !== void 0 || e !== void 0) && s && l.height && h > l.height && ((h = l.height), (c = dt(Math.floor(h * s)))),
    { width: c, height: h }
  )
}
function Mi(i, t, e) {
...
var Us = (function () {
  ...
  try {
    ...
    Le() && (window.addEventListener('test', null, t), window.removeEventListener('test', null, t))
  } catch {}
  return i
})()
function ki(i, t) {
    ...
    ((_ = t[M % a]),
      !_.skip &&
        ...
        b !== D &&
          ...
          p !== null && y() && (m.push(hs({ start: p, end: M, loop: u, count: a, style: f })), (p = null)),
          (w = M),
          (D = b))))
  return (p !== null && m.push(hs({ start: p, end: d, loop: u, count: a, style: f })), m)
}
function Si(i, t) {
  let e = [],
    s = i.segments
...
function ma(i, t, e, s) {
  ...
  function f(m, g, p, b) {
    ...
    if (m !== g) {
      ...
      for (; e[g % l].skip;) g += _
      m % l !== g % l && (c.push({ start: m % l, end: g % l, loop: p, style: b }), (h = b), (d = g % l))
    }
  }
  for (let m of t) {
    d = r ? d : m.start
    ...
    for (u = d + 1; u <= m.end; u++) {
      ...
      ;((p = us(
        s.setContext(
          gt(n, { type: 'segment', p0: g, p1: b, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a }),
        ),
      )),
...
function xa(i, t) {
  ...
  return e && s
    ? { left: ye(e, t, 'left'), right: ye(e, t, 'right'), top: ye(s, t, 'top'), bottom: ye(s, t, 'bottom') }
    : t
}
function Pi(i, t) {
  let e = t._clip
...
function en(i, t) {
  ...
  for (let f = 0; f < d; ++f) {
    ...
    ;((u = b[c] = Da(n, h, g)), (u[r] = p), (u._top = tn(u, a, !0, s.type)), (u._bottom = tn(u, a, !1, s.type)))
...
function Ca(i, t) {
  return gt(i, { active: !1, dataset: void 0, datasetIndex: t, index: t, mode: 'default', type: 'dataset' })
}
function Oa(i, t, e) {
  return gt(i, {
    active: !1,
...
var Oi = (i) => i === 'reset' || i === 'none',
  ...
  Aa = (i, t, e) => i && !t.hidden && t._stacked && { keys: Vn(e, !0), values: null },
  Pt = class {
    constructor(t, e) {
      ;((this.chart = t),
        (this._ctx = t.ctx),
    ...
    _dataCheck() {
      ...
      if (S(e)) {
        ...
        ;(e && Object.isExtensible(e) && ws(e, this), (this._syncList = []), (this._data = e))
      }
    }
    addElements() {
      let t = this._cachedMeta
    ...
    buildOrUpdateElements(t) {
      ...
      ;((e._stacked = Di(e.vScale, e)),
        ...
        (n || o !== e._stacked) && (en(this, e._parsed), (e._stacked = Di(e.vScale, e))))
    }
    configure() {
    ...
    parsePrimitiveData(t, e, s, n) {
      let { iScale: o, vScale: a } = t,
        ...
        f,
        m
      for (u = 0, f = n; u < f; ++u) ((m = u + s), (d[u] = { [r]: h || o.parse(c[m], m), [l]: a.parse(e[m], m) }))
      return d
    }
    ...
    parseObjectData(t, e, s, n) {
      let { xScale: o, yScale: a } = t,
        ...
        f
      for (h = 0, d = n; h < d; ++h)
        ((u = h + s), (f = e[u]), (c[h] = { x: o.parse(Zt(f, r), u), y: a.parse(Zt(f, l), u) }))
      return c
    }
    getParsed(t) {
    ...
    applyStack(t, e, s) {
      let n = this.chart,
        o = this._cachedMeta,
        a = e[t.axis],
        r = { keys: Vn(n, !0), values: e._stacks[t.axis]._visualValues }
    ...
    _update(t) {
      ...
      ;(this.update(t || 'default'),
        (e._clip = ka(P(this.options.clip, Ma(e.xScale, e.yScale, this.getMaxOverflow())))))
    }
    update(t) {}
    draw() {
      let t = this._ctx,
    ...
    getContext(t, e, s) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        ((o = this.$context || (this.$context = Ca(this.chart.getContext(), this.index))),
          (o.dataset = n),
    ...
    _resolveElementOptions(t, e = 'default', s) {
      ...
      return (g.$shared && ((g.$shared = l), (o[a] = Object.freeze(sn(g, l)))), g)
    }
  ...
  updateElements(t, e, s, n) {
    ...
    for (let x = 0; x < D; ++x) {
      ...
      let M = this.getParsed(x),
        ...
        F = (y[f] = o || w ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, M, l) : M[f], x))
...
;(v(Dt, 'id', 'line'),
  v(Dt, 'defaults', { datasetElementType: 'line', dataElementType: 'point', showLine: !0, spanGaps: !1 }),
  ...
  for (let r of i) {
    ...
    if (r.horizontal) {
      ...
      ;(Qt(c.start) && (a = c.start),
        l.fullSize ? Fe(l, n.left, a, e.outerWidth - n.right - n.left, u) : Fe(l, t.left + c.placed, a, d, u),
        (c.start = a),
        (c.placed += d),
        (a = l.bottom))
    } else {
      ...
      ;(Qt(c.start) && (o = c.start),
        l.fullSize ? Fe(l, o, n.top, u, e.outerHeight - n.bottom - n.top) : Fe(l, o, t.top + c.placed, u, d),
        (c.start = o),
        (c.placed += d),
        (o = l.right))
    }
...
function Ya(i, t) {
  ...
  if (
    ((i[He] = { initial: { height: s, width: n, style: { display: e.display, height: e.height, width: e.width } } }),
...
var Wi = class extends $e {
  ...
  removeEventListener(t, e) {
    let s = t.$proxies || (t.$proxies = {}),
      n = s[e]
    if (!n) return
    ;((({ attach: Li, detach: Li, resize: Li })[e] || Xa)(t, e, n), (s[e] = void 0))
  }
  getDevicePixelRatio() {
...
function ir(i, t) {
  ...
  if (a > 0) {
    ...
    for (ze(t, c, h, O(f) ? 0 : r - f, r), d = 0, u = a - 1; d < u; d++) ze(t, c, h, o[d], o[d + 1])
...
function gr(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    ...
    } else e === 'center' ? (m = (c.bottom + c.top) / 2 + g - t) : (m = hn(i, e, t))
    u = r - o
  } else {
    if (S(e)) {
      let b = Object.keys(e)[0],
    ...
    } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = hn(i, e, t))
...
var Ot = class i extends mt {
    ...
    getMinMax(t) {
      ...
      return ((e = o && e > s ? s : e), (s = n && e > s ? e : s), { min: $(e, $(s, e)), max: $(s, $(e, s)) })
    }
    getPadding() {
      return {
    ...
    update(t, e, s) {
      ...
      ;(this._convertTicksToLabels(l ? un(this.ticks, r) : this.ticks),
        ...
        a.display &&
          ...
          ((this.ticks = ir(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    generateTickLabels(t) {
      let e = this.options.ticks,
        ...
        n,
        o
      for (s = 0, n = t.length; s < n; s++) ((o = t[s]), (o.label = L(e.callback, [o.value, s, t], this)))
    }
    ...
    calculateLabelRotation() {
      ...
      ;((r = t.offset ? this.maxWidth / s : f / (s - 1)),
        d + 6 > r &&
          ...
          (l = this.maxHeight - ae(t.grid) - e.padding - fn(t.title, this.chart.options.font)),
          (c = Math.sqrt(d * d + u * u)),
          (a = Se(
            Math.min(
    ...
    _computeLabelSizes(t, e, s) {
      ...
      return { first: M(0), last: M(e - 1), widest: M(k), highest: M(y), widths: a, heights: r }
    }
    getLabelForValue(t) {
      return t
    }
    ...
    _computeGridLineItems(t) {
      let e = this.axis,
        ...
        z,
        J
      if (a === 'top') ((_ = b(this.bottom)), (y = this.bottom - u), (w = _ - p), (F = b(t.top) + p), (J = t.bottom))
      else if (a === 'bottom') ((_ = b(this.top)), (F = t.top), (J = b(t.bottom) - p), (y = _ + p), (w = this.top + u))
      else if (a === 'left')
        ((_ = b(this.right)), (k = this.right - u), (M = _ - p), (E = b(t.left) + p), (z = t.right))
      else if (a === 'right') ((_ = b(this.left)), (E = t.left), (z = b(t.right) - p), (k = _ + p), (M = this.left + u))
      else if (e === 'x') {
    ...
    _computeLabelItems(t) {
      ...
      for (b = 0, _ = r.length; b < _; ++b) {
        ...
        if (I.showLabelBackdrop) {
          ...
          ge = { left: xt, top: Ut, width: bt + Tt.width, height: Yt + Tt.height, color: I.backdropColor }
        }
        p.push({
          label: C,
          font: w,
    ...
    drawBorder() {
      ...
      let r = n.setContext(this.getContext(0)).lineWidth,
        ...
        u
      ;(this.isHorizontal()
        ? ((c = ft(t, this.left, a) - a / 2), (h = ft(t, this.right, r) + r / 2), (d = u = l))
        : ((d = ft(t, this.top, a) - a / 2), (u = ft(t, this.bottom, r) + r / 2), (c = h = l)),
        e.save(),
        (e.lineWidth = o.width),
    ...
    drawTitle() {
      ...
      e === 'bottom' || e === 'center' || S(e)
        ...
        : (l += a.top)
      let { titleX: c, titleY: h, maxWidth: d, rotation: u } = gr(this, l, e, r)
      ee(t, s.text, 0, 0, o, {
        color: s.color,
        maxWidth: d,
        rotation: u,
  ...
  Wt = class {
    ...
    unregister(t) {
      let e = this.items,
        s = t.id,
        n = this.scope
      ;(s in e && delete e[s], n && s in R[n] && (delete R[n][s], this.override && delete ut[s]))
    }
  }
function pr(i, t, e) {
  let s = Et(Object.create(null), [e ? R.get(e) : {}, R.get(t), i.defaults])
  ;(R.set(t, s), i.defaultRoutes && mr(t, i.defaultRoutes), i.descriptors && R.describe(t, i.descriptors))
}
function mr(i, t) {
...
var Ni = class {
  ...
  Hi = class {
    ...
    notify(t, e, s, n) {
      ...
      return (
        e === 'afterDestroy' &&
          (this._notify(o, t, 'stop'), this._notify(this._init, t, 'uninstall'), (this._init = void 0)),
        a
      )
    }
    _notify(t, e, s, n) {
...
function yr(i, { plugins: t, localIds: e }, s, n) {
  ...
  for (let r of t) {
    let l = r.id,
      c = _r(s[l], n)
    c !== null && o.push({ plugin: r, options: vr(i.config, { plugin: r, local: e[l] }, c, a) })
  }
  return o
}
function vr(i, { plugin: t, local: e }, s, n) {
  ...
  return (
    e && t.defaults && a.push(t.defaults), i.createResolver(a, n, [''], { scriptable: !1, indexable: !1, allKeys: !0 })
  )
}
function ji(i, t) {
  let e = R.datasets[i] || {}
...
function $i(i, ...t) {
  if (gn(i)) return i
  for (let e of t) {
    let s = e.axis || wr(e.position) || (i.length > 1 && gn(i[0].toLowerCase()))
    if (s) return s
  }
...
var re = (i, t, e) => {
  ...
  Yi = class {
    constructor(t) {
      ;((this._config = Dr(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map()))
    }
    get platform() {
...
function bn(i, t, e) {
  ...
  let n = e.join(),
    o = s.get(n)
  return (
    o || ((o = { resolver: Te(t, e), subPrefixes: e.filter((r) => !r.toLowerCase().includes('hover')) }), s.set(n, o)),
    o
  )
}
...
function Xn(i) {
  return (
    Le() && typeof i == 'string' ? (i = document.getElementById(i)) : i && i.length && (i = i[0]),
...
var U = class {
    ...
    ;(e &&
      ...
      W(o, (a) => {
        let r = a.options,
          ...
          c = $i(l, r),
          h = P(r.type, a.dtype)
        ;((r.position === void 0 || xn(r.position, c) !== xn(a.dposition)) && (r.position = a.dposition), (n[l] = !0))
        let d = null
  ...
  render() {
    this.notifyPlugins('beforeRender', { cancelable: !0 }) !== !1 &&
      (ot.has(this) ? this.attached && !ot.running(this) && ot.start(this) : (this.draw(), yn({ chart: this })))
  }
  draw() {
    let t
  ...
  _drawDataset(t) {
    ...
    this.notifyPlugins('beforeDatasetDraw', s) !== !1 &&
      (n && Oe(e, n), t.controller.draw(), n && Ae(e), (s.cancelable = !1), this.notifyPlugins('afterDatasetDraw', s))
  }
  isPointInArea(t) {
  ...
  _stop() {
    let t, e
    for (this.stop(), ot.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t)
  }
  destroy() {
    ...
    ;(this._stop(),
      ...
      t && (this.unbindEvents(), bi(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
      delete je[this.id],
  ...
  updateHoverStyle(t, e, s) {
    let n = s ? 'set' : 'remove',
      ...
      l
    for (
      e === 'dataset' && ((o = this.getDatasetMeta(t[0].datasetIndex)), o.controller['_' + n + 'DatasetHoverStyle']()),
        r = 0,
        l = t.length;
      r < l;
      ++r
  ...
  _handleEvent(t, e, s) {
    ...
    s && ((this._lastEvent = null), L(o.onHover, [t, r, this], this), l && L(o.onClick, [t, r, this], this))
    let h = !ni(r, n)
...
function Ir(i) {
  return i.stepped ? Es : i.tension || i.cubicInterpolationMode === 'monotone' ? Fs : Fr
}
function qn(i, t, e = {}) {
  let s = i.length,
...
function Vr(i) {
  return i.stepped ? Xs : i.tension || i.cubicInterpolationMode === 'monotone' ? Ks : ct
}
function Wr(i, t, e, s) {
  let n = t._path
...
function Nr(i, t, e, s) {
  let { segments: n, options: o } = t,
    a = Ui(t)
  for (let r of n)
    (Kn(i, o, r.style), i.beginPath(), a(i, t, r, { start: e, end: e + s - 1 }) && i.closePath(), i.stroke())
}
...
var G = class extends mt {
  ...
  get segments() {
    return this._segments || (this._segments = Gs(this, this.options.segment))
  }
  first() {
    let t = this.segments,
      e = this.points
  ...
  draw(t, e, s, n) {
    let o = this.options || {}
    ;((this.points || []).length && o.borderWidth && (t.save(), jr(t, this, s, n), t.restore()),
...
;(v(G, 'id', 'line'),
  ...
  v(G, 'descriptors', { _scriptable: !0, _indexable: (t) => t !== 'borderDash' && t !== 'fill' }))
function kn(i, t, e, s) {
  let n = i.options,
    { [e]: o } = i.getProps([e], s)
...
function Ri(i, t, e) {
  ...
  s &&
    a.points.length &&
    (Oe(i, e), rl(i, { line: a, target: s, above: u, below: f, area: e, scale: r, axis: l, clip: g }), Ae(i))
}
function rl(i, t) {
...
function Ei(i, t) {
  ...
  for (let { source: c, target: h, start: d, end: u } of l) {
    let { style: { backgroundColor: f = o } = {} } = c,
      m = s !== !0
    ;(i.save(), (i.fillStyle = f), ll(i, a, r, m && Xi(n, d, u)), i.beginPath())
...
function ll(i, t, e, s) {
  ...
  if (o === 'x' || o === 'y') {
    ...
    ;(o === 'x' ? ((l = a), (c = n.top), (h = r), (d = n.bottom)) : ((l = n.left), (c = a), (h = n.right), (d = r)),
      i.beginPath(),
      e &&
        ((l = Math.max(l, e.left)), (h = Math.min(h, e.right)), (c = Math.max(c, e.top)), (d = Math.min(d, e.bottom))),
      i.rect(l, c, h - l, d - c),
      i.clip())
  }
}
...
var Jn = {
  ...
  afterDatasetsUpdate(i, t, e) {
    ...
    for (a = 0; a < s; ++a)
      ((o = i.getDatasetMeta(a)),
        ...
        (o.$filler = l),
        n.push(l))
    for (a = 0; a < s; ++a) ((l = n[a]), !(!l || l.fill === !1) && (l.fill = Ur(n, a, e.propagate)))
  },
  beforeDraw(i, t, e) {
  ...
  beforeDatasetDraw(i, t, e) {
    let s = t.meta.$filler
    !Sn(s) || e.drawTime !== 'beforeDatasetDraw' || Ri(i.ctx, s, i.chartArea)
  },
...
var Nt = class extends Ot {
  ...
  parse(t, e) {
    if (O(t)) return null
    let s = this.getLabels()
    return ((e = isFinite(e) && s[e] === t ? e : hl(s, t, P(e, t), this._addedLabels)), dl(e, s.length - 1))
  }
  determineDataLimits() {
...
function ul(i, t) {
  ...
  ;((w = Math.ceil(p / x) - Math.floor(g / x)),
    ...
    n === 'ticks' ? ((y = Math.floor(g / x) * x), (M = Math.ceil(p / x) * x)) : ((y = g), (M = p)),
    b && _ && o && xs((r - a) / o, x / 1e3)
      ? ((w = Math.round(Math.min((r - a) / x, h))), (x = (r - a) / w), (y = a), (M = r))
      : D
        ? ((y = b ? a : y), (M = _ ? r : M), (w = c - 1), (x = (M - y) / w))
        : ((w = (M - y) / x), zt(w, Math.round(w), x / 1e3) ? (w = Math.round(w)) : (w = Math.ceil(w))))
  ...
  for (
    b &&
    (u && y !== a
      ? (e.push({ value: a }), y < a && F++, zt(Math.round((y + F * x) * k) / k, a, An(a, C, i)) && F++)
      : y < a && F++);
    F < w;
    ++F
  ) {
...
var Ve = class extends Ot {
  ...
  getPixelForValue(t) {
    return (
      ...
      t === null || isNaN(t)
        ? NaN
        : this.getPixelForDecimal(t === this.min ? 0 : (st(t) - this._startValue) / this._valueRange)
    )
  }
  getValueForPixel(t) {
...
function pl(i, t, e) {
  return ((e = A(e) ? e : [e]), { w: Ts(i, t.string, e), h: e.length * t.lineHeight })
}
...
function ml(i) {
  ...
  ;(i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (i._pointLabelItems = yl(i, s, n)))
}
...
function _l(i, t) {
  ...
  return !(Z({ x: e, y: s }, t) || Z({ x: e, y: o }, t) || Z({ x: n, y: s }, t) || Z({ x: n, y: o }, t))
}
function yl(i, t, e) {
  let s = [],
  ...
  for (let h = 0; h < n; h++) {
    ...
    let d = xl(i, h, l)
    ;(s.push(d), r === 'auto' && ((d.visible = _l(d, c)), d.visible && (c = d)))
  }
  return s
}
function vl(i) {
...
function wl(i, t, e) {
  ...
  if (!O(r)) {
    ...
    Object.values(l).some((m) => m !== 0)
      ? (i.beginPath(), Is(i, { x: h, y: d, w: u, h: f, radius: l }), i.fill())
      : i.fillRect(h, d, u, f)
  }
}
function Sl(i, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    ...
    ee(e, i._pointLabels[n], l, c + r.lineHeight / 2, r, { color: a.color, textAlign: h, textBaseline: 'middle' })
  }
}
function Zn(i, t, e, s) {
  let { ctx: n } = i
...
var Vt = class extends $t {
  ...
  determineDataLimits() {
    ...
    ;((this.min = T(t) && !isNaN(t) ? t : 0), (this.max = T(e) && !isNaN(e) ? e : 0), this.handleTickRangeOptions())
  }
  computeTickLimit() {
  ...
  fit() {
    let t = this.options
    t.display && t.pointLabels.display ? ml(this) : this.setCenterPoint(0, 0, 0, 0)
  }
  ...
  drawBackground() {
    ...
    if (t) {
      ...
      ;(s.save(),
        s.beginPath(),
        Zn(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
        s.closePath(),
        (s.fillStyle = t),
        s.fill(),
        s.restore())
  ...
  drawLabels() {
    ...
    ;(t.save(),
      ...
      this.ticks.forEach((r, l) => {
        ...
        ee(t, r.label, 0, -o, h, { color: c.color, strokeColor: c.textStrokeColor, strokeWidth: c.textStrokeWidth })
      }),
      t.restore())
  }
  drawTitle() {}
...
;(v(Vt, 'id', 'radialLinear'),
  ...
  v(Vt, 'defaultRoutes', { 'angleLines.color': 'borderColor', 'pointLabels.color': 'color', 'ticks.color': 'color' }),
...
function Fn(i, t) {
  ...
  return (
    ...
    a === null
      ? null
      : (n && (a = n === 'week' && (Bt(o) || o === !0) ? e.startOf(a, 'isoWeek', o) : e.startOf(a, n)), +a)
  )
}
function In(i, t, e, s) {
  let n = Y.length
...
var jt = class extends Ot {
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (s.autoSkip
          ? In(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
          : Cl(this, r.length, e.minUnit, this.min, this.max))),
      (this._majorUnit = !s.major.enabled || this._unit === 'year' ? void 0 : Ol(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
  ...
  _getLabelCapacity(t) {
    let e = this.options.time,
      ...
      o = this._tickFormatFunction(t, 0, Bn(this, [t], this._majorUnit), n),
...
function Tl({ key: i, labels: t, values: e }) {
  return {
    ...
    initChart() {
      if (!this.$refs.canvas || !this.$refs.backgroundColorElement || !this.$refs.borderColorElement) return
      this.getChart()?.destroy()
      let { backgroundColor: s, borderColor: n } = this.getChartColors(),
        { borderWidth: o, fill: a, lineTension: r } = this.getChartCustomProperties()
      new U(this.$refs.canvas, {
        type: 'line',
        data: {
          labels: t,
          datasets: [{ data: e, borderWidth: o, fill: a, tension: r, backgroundColor: s, borderColor: n }],
        },
        options: {
    ...
    updateChartData(s) {
      let n = this.getChart()
      n && ((n.data.labels = s.map((o, a) => a)), (n.data.datasets[0].data = s), n.update('none'))
    },
    updateChartTheme() {
      let s = this.getChart()
      if (!s) return
      let { backgroundColor: n, borderColor: o } = this.getChartColors(),
        { borderWidth: a, fill: r, lineTension: l } = this.getChartCustomProperties()
    ...
    destroy() {
      ;(this.systemThemeMediaQuery?.removeEventListener('change', this.systemThemeListener), this.getChart()?.destroy())
    },
  }
}
