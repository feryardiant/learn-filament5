...
var Ed = (o, p, v, L) => {
  if ((p && typeof p == 'object') || typeof p == 'function')
    for (let b of Td(p))
      !Ld.call(o, b) && b !== v && ss(o, b, { get: () => p[b], enumerable: !(L = Sd(p, b)) || L.enumerable })
  return o
}
...
var We = Ke((Yo, Qo) => {
  ;(function (o, p) {
    ...
    var o = navigator.userAgent,
      ...
      U = /Android/.test(o),
      M = w || U || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(o),
      O = w || /Mac/.test(p),
      W = /\bCrOS\b/.test(o),
      J = /win/i.test(p),
      re = d && o.match(/Version\/(\d*\.\d*)/)
    ;(re && (re = Number(re[1])), re && re >= 15 && ((d = !1), (g = !0)))
    var F = O && (C || (d && (re == null || re < 12.11))),
      q = v || (s && h >= 9)
    function D(e) {
    ...
    var Ft = (function () {
      ...
      return function (m, A) {
        ...
        for (var xe = 0, be = B; xe < ee; ++xe) {
          var Ce = Y[xe]
          Ce == '1' && be == 'r' ? (Y[xe] = 'n') : a.test(Ce) && ((be = Ce), Ce == 'r' && (Y[xe] = 'R'))
        }
        ...
        for (var Ve = 0; Ve < ee; ++Ve) {
          ...
          if (vt == ',') Y[Ve] = 'N'
            ...
            for (var Ot = (Ve && Y[Ve - 1] == '!') || (rt < ee && Y[rt] == '1') ? '1' : 'N', At = Ve; At < rt; ++At)
              Y[At] = Ot
            Ve = rt - 1
          }
        }
...
`,
    ...
    ;((at.prototype.eol = function () {
      ...
      (at.prototype.indentation = function () {
        return (
          Oe(this.string, null, this.tabSize) - (this.lineStart ? Oe(this.string, this.lineStart, this.tabSize) : 0)
        )
      }),
    ...
    function ka(e, t) {
      ...
      if (n)
        for (var i = void 0, a = 0; a < n.length; ++a)
          ((i = n[a]),
            i.marker.collapsed && (t ? i.from : i.to) == null && (!r || oo(r, i.marker) < 0) && (r = i.marker))
      return r
    }
    function wa(e) {
      return ka(e, !0)
      ...
      for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
        ...
        ;($c(a, r, da(e, a, u)),
          a.styleClasses &&
            ...
            a.styleClasses.textClass && (r.textClass = _e(a.styleClasses.textClass, r.textClass || ''))),
...
`
      ...
      for (var u = i.length, f = 0, m = 1, A = '', B, ee, Y = 0, ie, ue, me, ve, xe; ;) {
        if (Y == f) {
          ...
          for (var be = [], Ce = void 0, Ne = 0; Ne < r.length; ++Ne) {
            ...
            else if (Fe.from <= f && (Fe.to == null || Fe.to > f || ($e.collapsed && Fe.to == f && Fe.from == f))) {
              if (
    ...
    function qa(e, t, n) {
      if ((Fa(e, t.line, t, n, !0), t.rest)) for (var r = 0; r < t.rest.length; r++) Fa(e, t.rest[r], t, n, !1)
    }
    ...
    function Na(e, t, n) {
      ...
      if (e.rest) {
        ...
        for (var i = 0; i < e.rest.length; i++)
          if (_(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 }
      }
    }
    function rf(e, t) {
      t = Zt(t)
      ...
      function B(be, Ce, Ne) {
        ...
        function Ot(ut, Dt, yt) {
          var ft = Ga(e, Fe, null, ut),
            ...
            lt = yt == 'after' ? ft.begin : ft.end - (/\s/.test(Fe.text.charAt(ft.end - 1)) ? 2 : 1)
          return rt(lt, ct)[ct]
        }
      ...
      for (
        ...
        if (!u.hidden) {
          if (((i += u.line.height), s && h < 8)) {
            ...
            ;((m = ee.bottom - ee.top),
              !f && u.text.firstChild && (A = u.text.firstChild.getBoundingClientRect().right - ee.left - 1))
          }
    ...
    function An(e, t) {
      Math.abs(e.doc.scrollTop - t) < 2 || (v || Eo(e, { top: t }), el(e, t, !0), v && Eo(e), Fn(e, 100))
    }
    function el(e, t, n) {
    ...
    function bf(e) {
      ...
      ;(Sf(t),
        ...
        (e.update =
          e.mustUpdate && new vi(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate)))
    }
    function yf(e) {
    ...
    function Co(e, t) {
      ...
      var u =
        a != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth
    ...
    function Cf(e, t, n) {
      ...
      function u(ie) {
        ...
        return (
          g && O && e.display.currentWheelTarget == ie ? (ie.style.display = 'none') : ie.parentNode.removeChild(ie), ue
        )
      }
        ...
        if (!B.hidden)
          if (!B.node || B.node.parentNode != a) {
            ...
            ;(B.changes && (Se(B.changes, 'gutter') > -1 && (Y = !1), Ma(e, B, m, n)),
              Y && (j(B.lineNumber), B.lineNumber.appendChild(document.createTextNode(pe(e.options, m)))),
    ...
    function ol(e) {
      ...
      if (!(!t.alignWidgets && (!t.gutters.firstChild || !e.options.fixedGutter))) {
        for (
          var r = yo(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, a = r + 'px', l = 0;
          l < n.length;
          l++
        )
          if (!n[l].hidden) {
    ...
    function ll(e) {
      ...
      for (var r = 0; r < n.length; ++r) {
        ...
        ;(l && (u.style.cssText = l),
          a == 'CodeMirror-linenumbers' && ((e.lineGutter = u), (u.style.width = (e.lineNumWidth || 1) + 'px')))
      }
            ...
            ? ((l.wheelStartX = u.scrollLeft),
              ...
              setTimeout(function () {
                if (l.wheelStartX != null) {
                  ...
                  ;((l.wheelStartX = l.wheelStartY = null), xe && ((sr = (sr * bi + xe) / (bi + 1)), ++bi))
                }
              }, 200))
    ...
    function ml(e, t, n, r) {
      ...
      if (
        ...
        ((u = ce(l.changes)),
          ye(t.from, t.to) == 0 && ye(t.from, u.to) == 0 ? (u.to = xr(t)) : l.changes.push(Io(e, t)))
      else {
        var f = ce(i.done)
        for (
          (!f || !f.ranges) && xi(e.sel, i.done), l = { changes: [Io(e, t)], generation: i.generation }, i.done.push(l);
    ...
    function Ff(e, t, n, r) {
      var i = e.history,
        a = r && r.origin
      ;(n == i.lastSelOp ||
      (a && i.lastSelOrigin == a && ((i.lastModTime == i.lastSelTime && i.lastOrigin == a) || qf(e, a, ce(i.done), t)))
      ...
      for (var r = [], i = 0; i < e.length; ++i) {
        ...
        for (var f = 0; f < l.length; ++f) {
          ...
          if ((u.push({ from: m.from, to: m.to, text: m.text }), t))
            for (var B in m)
              (A = B.match(/^spans_(\d+)$/)) && Se(t, Number(A[1])) > -1 && ((ce(u)[B] = m[B]), delete m[B])
        }
      }
      return r
    }
    ...
    function ki(e, t, n) {
      ;(It(e, 'beforeSelectionChange') || (e.cm && It(e.cm, 'beforeSelectionChange'))) && (t = Of(e, t, n))
    ...
    function an(e, t, n) {
      ...
      if (!((It(e, 'beforeChange') || (e.cm && It(e.cm, 'beforeChange'))) && ((t = Cl(e, t, !0)), !t))) {
    ...
    function On(e, t, n, r) {
      ...
      if (!(t.from.line > e.lastLine())) {
        if (t.from.line < e.first) {
          ...
          ;(zl(e, i),
            (t = { from: ne(e.first, 0), to: ne(t.to.line + i, t.to.ch), text: [ce(t.text)], origin: t.origin }))
        }
        var a = e.lastLine()
    ...
    ;((Mt.prototype = oe(jn.prototype, {
      ...
      setValue: mt(function (e) {
        ...
        ;(an(
          this,
          { from: t, to: ne(n, Ae(this, n).text.length), text: this.splitLines(e), origin: 'setValue', full: !0 },
          !0,
        ),
    ...
    function Vf(e, t, n, r) {
      ...
      var ie = function (ve, xe, be) {
          for (
            ...
            if ((Ne.from <= $e && $e < Ne.to) || (($e = Fe ? Ne.from : u(Ne.to, -1)), be.begin <= $e && $e < be.end))
              return Ce($e, Fe)
          }
        },
        ue = ie(a + r, r, A)
...
`,
    ...
    function Gl(e) {
      var t = this
      if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = R(he(t))), !ot(t, e))) {
        ...
        ;(d &&
          ((Ro = r ? n : null),
          !r && n == 88 && !ti && (O ? e.metaKey : e.ctrlKey) && t.replaceSelection('', null, 'cut')),
          v && !O && !r && n == 46 && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand('cut'),
            ...
            !(r && ad(t, i, r, a, e)) &&
              (i == 1
                ...
                : i == 2
                  ...
                  : i == 3 && (q ? t.display.input.onContextMenu(e) : wo(t))))
        }
      }
    }
    ...
    function ld(e, t, n) {
      var r = e.getOption('configureMouse'),
        i = r ? r(e, t, n) : {}
      if (i.unit == null) {
        var a = W ? n.shiftKey && n.metaKey : n.altKey
    ...
    function Jl(e, t) {
      lr(e.display, t) || dd(e, t) || ot(e, t, 'contextmenu') || q || e.display.input.onContextMenu(t)
    }
    function dd(e, t) {
...
`) &&
    ...
    function os() {
      ...
      return (
        g ? (e.style.width = '1000px') : e.setAttribute('wrap', 'off'), w && (e.style.border = '1px solid black'), t
      )
    }
    function vd(e) {
      var t = e.optionHandlers,
      ...
      ;((e.prototype = {
        ...
        setOption: function (r, i) {
          var a = this.options,
            l = a[r]
          ;(a[r] == i && r != 'mode') ||
            ((a[r] = i), t.hasOwnProperty(r) && gt(this, t[r])(this, i, l), it(this, 'optionChange', this, r))
        },
        ...
        indentSelection: Tt(function (r) {
          for (var i = this.doc.sel.ranges, a = -1, l = 0; l < i.length; l++) {
            ...
            if (u.empty())
              u.head.line > a &&
                (Xn(this, u.head.line, r, !0), (a = u.head.line), l == this.doc.sel.primIndex && tn(this))
            else {
              var f = u.from(),
                m = u.to(),
                A = Math.max(a, f.line)
    ...
    function Go(e, t, n, r, i) {
      ...
      function m() {
        var xe = t.line + f
        return xe < e.first || xe >= e.first + e.size ? !1 : ((t = new ne(xe, t.ch, t.sticky)), (u = Ae(e, xe)))
      }
      function A(xe) {
        var be
        if (r == 'codepoint') {
...
`
    ...
    function as(e, t, n, r) {
      var i = e.doc,
        ...
        l
      if (r == 'page') {
        var u = Math.min(e.display.wrapper.clientHeight, de(e).innerHeight || i(e).documentElement.clientHeight),
      ...
      function l(u) {
        if (!(!a(u) || ot(r, u))) {
          if (r.somethingSelected())
            (zi({ lineWise: !1, text: r.getSelections() }), u.type == 'cut' && r.replaceSelection('', null, 'cut'))
...
`)))
      ...
      (Qe.prototype.pollSelection = function () {
        if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
          var e = this.getSelection(),
            t = this.cm
          if (U && k && this.cm.display.gutterSpecs.length && bd(e.anchorNode)) {
      ...
      (Qe.prototype.pollContent = function () {
        ...
        for (
          var xe = ce(B),
            be = ce(ee),
            Ce = Math.min(xe.length - (B.length == 1 ? Y : 0), be.length - (ee.length == 1 ? Y : 0));
          ie < Ce && xe.charCodeAt(xe.length - ie - 1) == be.charCodeAt(be.length - ie - 1);
        )
          ++ie
        if (B.length == 1 && ee.length == 1 && l == r.line)
          for (; Y && Y > r.ch && xe.charCodeAt(xe.length - ie - 1) == be.charCodeAt(be.length - ie - 1);) (Y--, ie++)
...
`)),
      ...
      (st.prototype.focus = function () {
        if (this.cm.options.readOnly != 'nocursor' && (!M || R(ze(this.textarea)) != this.textarea))
          try {
            this.textarea.focus()
          } catch {}
      }),
      ...
      return {
        ...
        token: function (b, S) {
          return (
            ...
            S.overlayCur == null
              ? S.baseCur
              : (S.baseCur != null && S.overlay.combineTokens) || (L && S.overlay.combineTokens == null)
    ...
    o.commands.newlineAndIndentContinueMarkdownList = function (S) {
      ...
      for (var s = S.listSelections(), h = [], g = 0; g < s.length; g++) {
        ...
        if (v.test(E)) {
          var U = x && />\s*$/.test(E),
            M = !/>\s*$/.test(E)
          ;((U || M) && S.replaceRange('', { line: C.line, ch: 0 }, { line: C.line, ch: C.ch + 1 }),
            (h[g] = `
`))
        } else {
          var O = z[1],
            ...
            re = J ? parseInt(z[3], 10) + 1 + z[4] : z[2].replace('x', ' ')
          ;((h[g] =
            `
` +
            O +
      ...
      do {
        ...
        if (E) {
          ...
          if (c === z && !isNaN(U))
            (w === U && (M = U + 1),
              w > U && (M = w + 1),
              S.replaceRange(x.replace(p, z + M + E[4] + E[5]), { line: d, ch: 0 }, { line: d, ch: x.length }))
          else {
  ...
  ;(function (o) {
    ...
    function S(h) {
      var g = h.getWrapperElement(),
        C = s(h)
      ;((g.className = g.className.replace(' CodeMirror-empty', '') + (C ? ' CodeMirror-empty' : '')), C ? v(h) : p(h))
    }
    function s(h) {
...
var ys = Ke((vs, bs) => {
  ;(function (o) {
    ...
    function s(k, c, d, x) {
      if (S(c, d) != 0)
        for (var E = k.state.markedSelection, z = k.state.markedSelectionStyle, w = c.line; ;) {
          var U = w == c.line ? c : b(w, 0),
            M = w + L,
            O = M >= d.line,
            W = O ? d : b(M, 0),
            J = k.markText(U, W, { className: z })
          if ((x == null ? E.push(J) : E.splice(x++, 0, J), O)) break
          w = M
        }
    }
    function h(k) {
    ...
    function C(k) {
      ...
      var E = x[0].find(),
        z = x[x.length - 1].find()
      if (!E || !z || d.line - c.line <= L || S(c, z.to) >= 0 || S(d, E.from) <= 0) return g(k)
      for (; S(c, E.from) > 0;) (x.shift().clear(), (E = x[0].find()))
      for (
        S(c, E.from) < 0 && (E.to.line - c.line < L ? (x.shift().clear(), s(k, c, E.to, 0)) : s(k, c, E.from, 0));
        S(d, z.to) < 0;
      )
        (x.pop().clear(), (z = x[x.length - 1].find()))
      S(d, z.to) > 0 && (d.line - z.from.line < L ? (x.pop().clear(), s(k, z.from, d)) : s(k, z.to, d))
    }
  })
})
var ks = Ke((xs, _s) => {
  ;(function (o) {
    ...
    function v(w) {
      var U = w.flags
      return U ?? (w.ignoreCase ? 'i' : '') + (w.global ? 'g' : '') + (w.multiline ? 'm' : '')
    }
    function L(w, U) {
      for (var M = v(w), O = M, W = 0; W < U.length; W++) O.indexOf(U.charAt(W)) == -1 && (O += U.charAt(W))
      return M == O ? w : new RegExp(w.source, O)
    }
    function b(w) {
      return /\\s|\\n|\n|\\W|\\D|\[\^/.test(w.source)
    }
    function S(w, U, M) {
      U = L(U, 'g')
      for (var O = M.line, W = M.ch, J = w.lastLine(); O <= J; O++, W = 0) {
        U.lastIndex = W
        var re = w.getLine(O),
          F = U.exec(re)
        if (F) return { from: p(O, F.index), to: p(O, F.index + F[0].length), match: F }
      }
    }
    function s(w, U, M) {
      if (!b(U)) return S(w, U, M)
      U = L(U, 'gm')
      for (var O, W = 1, J = M.line, re = w.lastLine(); J <= re;) {
        for (var F = 0; F < W && !(J > re); F++) {
          var q = w.getLine(J++)
          O =
            O == null
              ? q
...
`),
          ...
          return {
            from: p(V, y),
            to: p(V + j.length - 1, j.length == 1 ? y + j[0].length : j[j.length - 1].length),
            match: D,
          }
        }
      }
    ...
    function h(w, U, M) {
      for (var O, W = 0; W <= w.length;) {
        U.lastIndex = W
        var J = U.exec(w)
        if (!J) break
        var re = J.index + J[0].length
        if (re > w.length - M) break
        ;((!O || re > O.index + O[0].length) && (O = J), (W = J.index + 1))
      }
      return O
    }
    function g(w, U, M) {
      U = L(U, 'g')
      for (var O = M.line, W = M.ch, J = w.firstLine(); O >= J; O--, W = -1) {
        var re = w.getLine(O),
          F = h(re, U, W < 0 ? 0 : re.length - W)
        if (F) return { from: p(O, F.index), to: p(O, F.index + F[0].length), match: F }
      }
    }
    function C(w, U, M) {
      if (!b(U)) return g(w, U, M)
      U = L(U, 'gm')
      for (var O, W = 1, J = w.getLine(M.line).length - M.ch, re = M.line, F = w.firstLine(); re >= F;) {
        for (var q = 0; q < W && re >= F; q++) {
          var D = w.getLine(re--)
          O =
            O == null
              ? D
...
`),
          ...
          return {
            from: p(y, G),
            to: p(y + V.length - 1, V.length == 1 ? G + V[0].length : V[V.length - 1].length),
            match: Q,
          }
        }
      }
    ...
    function d(w, U, M, O) {
      if (w.length == U.length) return M
      for (var W = 0, J = M + Math.max(0, w.length - U.length); ;) {
        if (W == J) return W
        var re = (W + J) >> 1,
          F = O(w.slice(0, re)).length
        if (F == M) return re
        F > M ? (J = re) : (W = re + 1)
      }
    }
    function x(w, U, M, O) {
      ...
      var W = O ? k : c,
        J = W(U).split(/\r|\n\r?/)
      e: for (var re = M.line, F = M.ch, q = w.lastLine() + 1 - J.length; re <= q; re++, F = 0) {
        var D = w.getLine(re).slice(F),
          Q = W(D)
        if (J.length == 1) {
          var j = Q.indexOf(J[0])
          if (j == -1) continue e
          var M = d(D, Q, j, W) + F
          return { from: p(re, d(D, Q, j, W) + F), to: p(re, d(D, Q, j + J[0].length, W) + F) }
        } else {
          var V = Q.length - J[0].length
          if (Q.slice(V) != J[0]) continue e
          for (var y = 1; y < J.length - 1; y++) if (W(w.getLine(re + y)) != J[y]) continue e
          var G = w.getLine(re + J.length - 1),
            X = W(G),
            N = J[J.length - 1]
          if (X.slice(0, N.length) != N) continue e
          return { from: p(re, d(D, Q, V, W) + F), to: p(re + J.length - 1, d(G, X, N.length, W)) }
        }
      }
    }
    function E(w, U, M, O) {
      ...
      var W = O ? k : c,
        J = W(U).split(/\r|\n\r?/)
      e: for (var re = M.line, F = M.ch, q = w.firstLine() - 1 + J.length; re >= q; re--, F = -1) {
        var D = w.getLine(re)
        F > -1 && (D = D.slice(0, F))
        var Q = W(D)
        if (J.length == 1) {
          ...
          if (j == -1) continue e
          return { from: p(re, d(D, Q, j, W)), to: p(re, d(D, Q, j + J[0].length, W)) }
        } else {
          var V = J[J.length - 1]
          if (Q.slice(0, V.length) != V) continue e
          for (var y = 1, M = re - J.length + 1; y < J.length - 1; y++) if (W(w.getLine(M + y)) != J[y]) continue e
          var G = w.getLine(re + 1 - J.length),
            X = W(G)
          if (X.slice(X.length - J[0].length) != J[0]) continue e
          return { from: p(re + 1 - J.length, d(G, X, G.length - J[0].length, W)), to: p(re, d(D, Q, V.length, W)) }
        }
      }
    }
    function z(w, U, M, O) {
      ;((this.atOccurrence = !1),
        ...
        (this.doc = w),
        (M = M ? w.clipPos(M) : p(0, 0)),
        (this.pos = { from: M, to: M }))
      var W
      ;(typeof O == 'object' ? (W = O.caseFold) : ((W = O), (O = null)),
        typeof U == 'string'
          ? (W == null && (W = !1),
            (this.matches = function (J, re) {
              return (J ? E : x)(w, U, re, W)
            }))
          : ((U = L(U, 'gm')),
            !O || O.multiline !== !1
              ? (this.matches = function (J, re) {
    ...
    ;((z.prototype = {
      ...
      find: function (w) {
        var U = this.doc.clipPos(w ? this.pos.from : this.pos.to)
        if (
          this.afterEmptyMatch &&
          this.atOccurrence &&
          ((U = p(U.line, U.ch)),
          w
            ? (U.ch--, U.ch < 0 && (U.line--, (U.ch = (this.doc.getLine(U.line) || '').length)))
            : (U.ch++, U.ch > (this.doc.getLine(U.line) || '').length && ((U.ch = 0), U.line++)),
          o.cmpPos(U, this.doc.clipPos(U)) != 0)
        )
          return (this.atOccurrence = !1)
        var M = this.matches(w, U)
      ...
      replace: function (w, U) {
        if (this.atOccurrence) {
          var M = o.splitLines(w)
          ;(this.doc.replaceRange(M, this.pos.from, this.pos.to, U),
            (this.pos.to = p(
      ...
      o.defineExtension('getSearchCursor', function (w, U, M) {
        return new z(this.doc, w, U, M)
      }),
      o.defineDocExtension('getSearchCursor', function (w, U, M) {
        return new z(this, w, U, M)
      }),
      o.defineExtension('selectMatches', function (w, U) {
        for (
          var M = [], O = this.getSearchCursor(w, this.getCursor('from'), U);
          O.findNext() && !(o.cmpPos(O.to(), this.getCursor('to')) > 0);
        )
          M.push({ anchor: O.from(), head: O.to() })
...
var Vo = Ke((ws, Ss) => {
  ;(function (o) {
    ...
    'use strict'
    function p(N, R, se, _e, I, T) {
      ;((this.indented = N), (this.column = R), (this.type = se), (this.info = _e), (this.align = I), (this.prev = T))
    }
    function v(N, R, se, _e) {
      var I = N.indented
      return (
        N.context && N.context.type == 'statement' && se != 'statement' && (I = N.context.indented),
        (N.context = new p(I, R, se, _e, null, N.context))
      )
    }
    function L(N) {
      var R = N.context.type
      return ((R == ')' || R == ']' || R == '}') && (N.indented = N.context.indented), (N.context = N.context.prev))
    }
    function b(N, R, se) {
      if (
        R.prevToken == 'variable' ||
        R.prevToken == 'type' ||
        /\S(?:[^- ]>|[*\]])\s*$|\*$/.test(N.string.slice(0, se)) ||
    ...
    o.defineMode('clike', function (N, R) {
      ...
      function fe(we) {
        return function (Me, Le) {
          for (var K = !1, H, le = !1; (H = Me.next()) != null;) {
            if (H == we && !K) {
              le = !0
              break
            }
          ...
          return ((le || !(K || qe)) && (Le.tokenize = null), 'string')
        }
      }
      function oe(we, Me) {
      ...
      return {
        ...
        token: function (we, Me) {
          var Le = Me.context
          if (
            (we.sol() && (Le.align == null && (Le.align = !1), (Me.indented = we.indentation()), (Me.startOfLine = !0)),
            we.eatSpace())
          )
          ...
          if (
            (K == 'variable' &&
              (Me.prevToken == 'def' ||
                (R.typeFirstDefinitions && b(we, Me, we.start) && S(Me.context) && we.match(/^\s*\(/, !1))) &&
              (K = 'def'),
            Oe.token)
          ) {
            var H = Oe.token(we, Me, K)
            H !== void 0 && (K = H)
          }
          return (
            K == 'def' && R.styleDefs === !1 && (K = 'variable'),
            (Me.startOfLine = !1),
        ...
        indent: function (we, Me) {
          ...
          var Le = we.context,
            K = Me && Me.charAt(0),
            H = K == Le.type
          if ((Le.type == 'statement' && K == '}' && (Le = Le.prev), R.dontIndentStatements))
          ...
          return Le.type == 'statement'
            ...
            : Le.align && (!I || Le.type != ')')
              ...
              : Le.type == ')' && !H
                ? Le.indented + _e
                : Le.indented + (H ? 0 : se) + (!H && De && !/^(?:case|default)\b/.test(Me) ? se : 0)
        },
    ...
    function s(N) {
      for (var R = {}, se = N.split(' '), _e = 0; _e < se.length; ++_e) R[se[_e]] = !0
      return R
    }
    function h(N, R) {
    ...
    function M(N, R) {
      ...
      for (var se, _e = null; (se = N.peek());) {
        if (se == '\\' && N.match(/^.$/)) {
          _e = M
          break
        } else if (se == '/' && N.match(/^\/[\/\*]/, !1)) break
        N.next()
      }
    ...
    function re(N, R) {
      if ((N.backUp(1), N.match(/^(?:R|u8R|uR|UR|LR)/))) {
        var se = N.match(/^"([^\s\\()]{0,16})\(/)
        return se ? ((R.cpp11RawStringDelim = se[1]), (R.tokenize = D), D(N, R)) : !1
      }
    ...
    function D(N, R) {
      var se = R.cpp11RawStringDelim.replace(/[^\w\s]/g, '\\$&'),
        _e = N.match(new RegExp('.*?\\)' + se + '"'))
      return (_e ? (R.tokenize = null) : N.skipToEnd(), 'string')
    }
    function Q(N, R) {
      typeof N == 'string' && (N = [N])
      var se = []
      ...
      ;(_e(R.keywords),
        ...
        _e(R.builtin),
        _e(R.atoms),
        se.length && ((R.helperType = N[0]), o.registerHelper('hintWords', N[0], se)))
      for (var I = 0; I < N.length; ++I) o.defineMIME(N[I], R)
    }
    ;(Q(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
      ...
      Q(['text/x-c++src', 'text/x-c++hdr'], {
        ...
        defKeywords: s(U + ' class namespace'),
        typeFirstDefinitions: !0,
      ...
      Q('text/x-java', {
        ...
        hooks: {
          ...
          '"': function (N, R) {
            return N.match(/""$/) ? ((R.tokenize = j), R.tokenize(N, R)) : !1
          },
        },
      ...
      Q('text/x-csharp', {
        ...
        hooks: {
          '@': function (N, R) {
            return N.eat('"') ? ((R.tokenize = q), q(N, R)) : (N.eatWhile(/[\w\$_]/), 'meta')
          },
        },
      }))
    function j(N, R) {
        ...
        for (var _e; (_e = R.next());)
          if (_e == '*' && R.eat('/'))
            if (N == 1) {
              se.tokenize = null
              break
            } else return ((se.tokenize = V(N - 1)), se.tokenize(R, se))
          else if (_e == '/' && R.eat('*')) return ((se.tokenize = V(N + 1)), se.tokenize(R, se))
        return 'comment'
      }
    }
    Q('text/x-scala', {
      ...
      hooks: {
        ...
        "'": function (N) {
          return N.match(/^(\\[^'\s]+|[^\\'])'/) ? 'string-2' : (N.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom')
        },
        '=': function (N, R) {
          var se = R.context
          return se.type == '}' && se.align && N.eat('>')
            ? ((R.context = new p(se.indented, se.column, se.type, se.info, null, se.prev)), 'operator')
            : !1
        },
        '/': function (N, R) {
          return N.eat('*') ? ((R.tokenize = V(1)), R.tokenize(N, R)) : !1
        },
      },
    ...
    function y(N) {
      return function (R, se) {
        for (var _e = !1, I, T = !1; !R.eol();) {
          ...
          ;((I = R.next()), !_e && I == '$' && R.match('{') && R.skipTo('}'), (_e = !_e && I == '\\' && !N))
        }
        return ((T || !N) && (se.tokenize = null), 'string')
      }
    }
    ;(Q('text/x-kotlin', {
      name: 'clike',
      ...
      hooks: {
        ...
        indent: function (N, R, se, _e) {
          var I = se && se.charAt(0)
          if ((N.prevToken == '}' || N.prevToken == ')') && se == '') return N.indented
          if (
            (N.prevToken == 'operator' && se != '}' && N.context.type != '}') ||
            (N.prevToken == 'variable' && I == '.') ||
            ((N.prevToken == '}' || N.prevToken == ')') && I == '.')
          )
            return _e * 2 + R.indented
          if (R.align && R.type == '}') return R.indented + (N.context.type == (se || '').charAt(0) ? 0 : _e)
        },
      },
      ...
      Q('text/x-objectivec', {
        ...
        defKeywords: s(U + ' @interface @implementation @protocol @class'),
      ...
      Q('text/x-objectivec++', {
        ...
        types: z,
        builtin: s(c),
        blockKeywords: s(w + ' @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch'),
        defKeywords: s(U + ' @interface @implementation @protocol @class class namespace'),
        dontIndentStatements: /^@.*$|^template$/,
        typeFirstDefinitions: !0,
        atoms: s('YES NO NULL Nil nil true false nullptr'),
        isReservedIdentifier: W,
    ...
    function X(N) {
      return function (R, se) {
        for (var _e = !1, I, T = !1; !R.eol();) {
          if (!_e && R.match('"') && (N == 'single' || R.match('""'))) {
            T = !0
            break
          }
          if (!_e && R.match('``')) {
    ...
    Q('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function (N, R) {
          return ((R.tokenize = X(N.match('""') ? 'triple' : 'single')), R.tokenize(N, R))
        },
        '`': function (N, R) {
          return !G || !N.match('`') ? !1 : ((R.tokenize = G), (G = null), R.tokenize(N, R))
        },
        "'": function (N) {
  ...
  ;(function (o) {
    ...
    o.defineMode('css', function (q, D) {
      ...
      function Be(te, fe) {
        ...
        if (oe === '-') {
          ...
          if (te.match(/^-[\w\\\-]*/))
            return (
              te.eatWhile(/[\w\\\-]/),
              te.match(/^\s*:/, !1) ? Se('variable-2', 'variable-definition') : Se('variable-2', 'variable')
            )
      ...
      function ce(te) {
        ...
        he.hasOwnProperty(fe) ? (qe = 'atom') : T.hasOwnProperty(fe) ? (qe = 'keyword') : (qe = 'variable')
      }
      var He = {}
      return (
        ...
        (He.pseudo = function (te, fe, oe) {
          return te == 'meta' ? 'pseudo' : te == 'word' ? ((qe = 'variable-3'), oe.context.type) : $(te, fe, oe)
        }),
        ...
        (He.keyframes = function (te, fe, oe) {
          return te == 'word' ? ((qe = 'variable'), 'keyframes') : te == '{' ? Re(oe, fe, 'top') : $(te, fe, oe)
        }),
        ...
        (He.interpolation = function (te, fe, oe) {
          return te == '}'
            ...
            : te == '{' || te == ';'
              ? Z(te, fe, oe)
              : (te == 'word' ? (qe = 'variable') : te != 'variable' && te != '(' && te != ')' && (qe = 'error'),
                'interpolation')
        }),
        {
    ...
    function p(q) {
      for (var D = {}, Q = 0; Q < q.length; ++Q) D[q[Q].toLowerCase()] = !0
      return D
    }
    var v = ['domain', 'regexp', 'url', 'url-prefix'],
      ...
      J = p(W),
      re = v.concat(b).concat(s).concat(g).concat(k).concat(d).concat(M).concat(W)
      ...
      o.defineMIME('text/x-scss', {
        ...
        tokenHooks: {
          ...
          $: function (q) {
            return (
              q.match(/^[\w-]+/),
              q.match(/^\s*:/, !1) ? ['variable-2', 'variable-definition'] : ['variable-2', 'variable']
            )
          },
          '#': function (q) {
    ...
    ;(o.defineMode('diff', function () {
      ...
      return {
        token: function (v) {
          ...
          if (!v.sol() || L === 0) return (v.skipToEnd(), ('error ' + (p[v.string.charAt(0)] || '')).replace(/ $/, ''))
  ...
  ;(function (o) {
    ...
    ;(o.defineMode('xml', function (L, b) {
            ...
            ? y.eat('[')
              ...
              : y.match('--')
                ...
                : y.match('DOCTYPE', !0, !0)
                  ...
                  : null
            : y.eat('?')
              ? (y.eatWhile(/[\w\._\-]/), (G.tokenize = E('meta', '?>')), 'meta')
      ...
      function d(y, G) {
        ...
        if (X == '<') {
          ;((G.tokenize = c), (G.state = W), (G.tagName = G.tagStart = null))
          var N = G.tokenize(y, G)
      ...
      function z(y) {
        return function (G, X) {
          for (var N; (N = G.next()) != null;) {
            if (N == '<') return ((X.tokenize = z(y + 1)), X.tokenize(G, X))
            if (N == '>')
              if (y == 1) {
                X.tokenize = c
                break
      ...
      function U(y, G, X) {
        ;((this.prev = y.context),
          ...
          (this.startOfLine = X),
          (s.doNotIndent.hasOwnProperty(G) || (y.context && y.context.noIndent)) && (this.noIndent = !0))
      }
      function M(y) {
      ...
      function O(y, G) {
        for (var X; ;) {
          if (
            !y.context ||
            ((X = y.context.tagName),
            !s.contextGrabbers.hasOwnProperty(w(X)) || !s.contextGrabbers[w(X)].hasOwnProperty(w(G)))
          )
            return
          M(y)
        }
      ...
      function W(y, G, X) {
        return y == 'openTag' ? ((X.tagStart = G.column()), J) : y == 'closeTag' ? re : W
      }
      function J(y, G, X) {
        return y == 'word'
      ...
      function re(y, G, X) {
        if (y == 'word') {
          var N = G.current()
          return (
            X.context && X.context.tagName != N && s.implicitlyClosed.hasOwnProperty(w(X.context.tagName)) && M(X),
            (X.context && X.context.tagName == N) || s.matchClosing === !1 ? ((k = 'tag'), F) : ((k = 'tag error'), q)
          )
        } else return s.allowMissingTagName && y == 'endTag' ? ((k = 'tag bracket'), F(y, G, X)) : ((k = 'error'), q)
      }
      function F(y, G, X) {
        return y != 'endTag' ? ((k = 'error'), F) : (M(X), W)
      }
      function q(y, G, X) {
        return ((k = 'error'), F(y, G, X))
      }
      function D(y, G, X) {
        ...
        if (y == 'endTag' || y == 'selfcloseTag') {
          ...
          return (
            ...
            y == 'selfcloseTag' || s.autoSelfClosers.hasOwnProperty(w(N))
              ? O(X, N)
              : (O(X, N), (X.context = new U(X, N, R == X.indented))),
            W
          )
        }
        return ((k = 'error'), D)
      ...
      function j(y, G, X) {
        return y == 'string' ? V : y == 'word' && s.allowUnquoted ? ((k = 'string'), D) : ((k = 'error'), D(y, G, X))
      }
      function V(y, G, X) {
      ...
      return {
        startState: function (y) {
          var G = { tokenize: c, state: W, indented: y || 0, tagName: null, tagStart: null, context: null }
        ...
        token: function (y, G) {
          ...
          return (
            (X || C) &&
              X != 'comment' &&
              ((k = null), (G.state = G.state(C || X, y, G)), k && (X = k == 'error' ? X + ' error' : k)),
            X
          )
        },
        indent: function (y, G, X) {
          ...
          if (R && R[1])
            ...
            for (; N;) {
              var se = s.contextGrabbers[w(N.tagName)]
              if (se && se.hasOwnProperty(w(R[2]))) N = N.prev
              else break
            }
...
var vn = Ke((Is, Ns) => {
  ;(function (o) {
    ...
    ;(o.defineMode('javascript', function (p, v) {
      ...
      function U(_, P) {
        var ae = _.next()
        if (ae == '"' || ae == "'") return ((P.tokenize = M(ae)), P.tokenize(_, P))
        ...
        if (ae == '0' && _.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return w('number', 'number')
        if (/\d/.test(ae)) return (_.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), w('number', 'number'))
        if (ae == '/')
          return _.eat('*')
            ? ((P.tokenize = O), O(_, P))
            : _.eat('/')
      ...
      function M(_) {
        return function (P, ae) {
          var pe = !1,
            ne
          if (S && P.peek() == '@' && P.match(d)) return ((ae.tokenize = U), w('jsonld-keyword', 'meta'))
          for (; (ne = P.next()) != null && !(ne == _ && !pe);) pe = !pe && ne == '\\'
          return (pe || (ae.tokenize = U), w('string', 'string'))
        }
      }
      function O(_, P) {
      ...
      var F = { atom: !0, number: !0, variable: !0, string: !0, regexp: !0, this: !0, import: !0, 'jsonld-keyword': !0 }
      function q(_, P, ae, pe, ne, ye) {
        ;((this.indented = _),
          (this.column = P),
          (this.type = ae),
          (this.prev = ne),
      ...
      function D(_, P) {
        ...
        for (var pe = _.context; pe; pe = pe.prev) for (var ae = pe.vars; ae; ae = ae.next) if (ae.name == P) return !0
      }
      ...
      function R(_) {
        return _ == 'public' || _ == 'private' || _ == 'protected' || _ == 'abstract' || _ == 'readonly'
      }
      function se(_, P, ae) {
      ...
      function T() {
        ;((j.state.context = new se(j.state.context, j.state.localVars, !1)), (j.state.localVars = I))
      }
      function he() {
        ;((j.state.context = new se(j.state.context, j.state.localVars, !0)), (j.state.localVars = null))
      }
      T.lex = he.lex = !0
      function ze() {
      ...
      function de(_, P) {
        var ae = function () {
          ...
          else for (var ye = pe.lexical; ye && ye.type == ')' && ye.align; ye = ye.prev) ne = ye.indented
          pe.lexical = new q(ne, j.stream.column(), _, null, pe.lexical, P)
        }
        return ((ae.lex = !0), ae)
      }
      function Ee() {
        var _ = j.state
        _.lexical.prev && (_.lexical.type == ')' && (_.indented = _.lexical.indented), (_.lexical = _.lexical.prev))
      }
      Ee.lex = !0
      function ge(_) {
        function P(ae) {
          return ae == _ ? y() : _ == ';' || ae == '}' || ae == ')' || ae == ']' ? V() : y(P)
        }
        return P
      }
      function Oe(_, P) {
                        ...
                        : _ == 'function'
                          ...
                          : _ == 'for'
                            ...
                            : _ == 'class' || (g && P == 'interface')
                              ? ((j.marked = 'keyword'), y(de('form', _ == 'class' ? _ : P), Wr, Ee))
                              : _ == 'variable'
                                ? g && P == 'declare'
                                  ...
                                  : g && (P == 'module' || P == 'enum' || P == 'type') && j.stream.match(/^\s*\w/, !1)
                                    ...
                                    : g && P == 'namespace'
                                      ...
                                      : g && P == 'abstract'
                                        ...
                                        : y(de('stat'), Ue)
                                : _ == 'switch'
                                  ? y(de('form'), Ze, ge('{'), de('}', 'switch'), he, De, Ee, Ee, ze)
                                  : _ == 'case'
                                    ? y(Se, ge(':'))
                                    : _ == 'default'
                                      ? y(ge(':'))
      ...
      function Ge(_, P, ae) {
        ...
        if (_ != ';') {
          ...
          if (_ == 'regexp')
            return (
              (j.state.lastType = j.marked = 'operator'), j.stream.backUp(j.stream.pos - j.stream.start - 1), y(ne)
            )
        }
      }
      function $(_, P) {
        return _ != 'quasi' ? V() : P.slice(P.length - 2) != '${' ? y($) : y(Je, Z)
      }
      function Z(_) {
        if (_ == '}') return ((j.marked = 'string-2'), (j.state.tokenize = W), y($))
      }
      function ce(_) {
      ...
      function te(_) {
        return function (P) {
          return P == '.' ? y(_ ? oe : fe) : P == 'variable' && g ? y(It, _ ? Ge : Re) : V(_ ? Be : Se)
        }
      }
      function fe(_, P) {
      ...
      function Me(_, P) {
        ...
        if (_ == 'variable' || j.style == 'keyword') {
          ...
          if (_ == 'number' || _ == 'string') return ((j.marked = S ? 'property' : j.style + ' property'), y(K))
          if (_ == 'jsonld-keyword') return y(K)
          if (g && R(P)) return ((j.marked = 'keyword'), y(Me))
          if (_ == '[') return y(Se, nt, ge(']'), K)
          if (_ == 'spread') return y(Be, K)
          if (P == '*') return ((j.marked = 'keyword'), y(Me))
          if (_ == ':') return V(K)
        }
      }
      function Le(_) {
        return _ != 'variable' ? V(K) : ((j.marked = 'property'), y(Ht))
      }
      function K(_) {
        if (_ == ':') return y(Be)
        if (_ == '(') return V(Ht)
      ...
      function H(_, P, ae) {
        function pe(ne, ye) {
          ...
          return ne == P || ye == P ? y() : ae && ae.indexOf(';') > -1 ? V(_) : y(ge(P))
        }
      ...
      function Ie(_) {
        return _.match(/[\}\)\]]/) ? y() : _ == ',' || _ == ';' ? y(Ie) : V(nr, Ie)
      }
      function nr(_, P) {
      ...
      function _t(_, P) {
        return _ != 'quasi' ? V() : P.slice(P.length - 2) != '${' ? y(_t) : y(Pe, it)
      }
      function it(_) {
        if (_ == '}') return ((j.marked = 'string-2'), (j.state.tokenize = W), y(_t))
      }
      function ot(_, P) {
      ...
      function dr(_, P) {
        return _ == 'variable' && !j.stream.match(/^\s*:/, !1)
          ...
          : (_ == 'variable' && (j.marked = 'property'),
            _ == 'spread' ? y(Ct) : _ == '}' ? V() : _ == '[' ? y(Se, ge(']'), ge(':'), dr) : y(ge(':'), Ct, Ut))
      }
      function yn() {
        return V(Ct, Ut)
      }
      ...
      function gr(_) {
        return _ == 'string' ? y() : _ == '(' ? V(Se) : _ == '.' ? V(Re) : V(Kr, Vt, Gr)
      }
      function Kr(_, P) {
        return _ == '{' ? le(Kr, '}') : (_ == 'variable' && X(P), P == '*' && (j.marked = 'keyword'), y(_n))
      }
      function Vt(_) {
        if (_ == ',') return y(Kr, Vt)
      }
      ...
      function kn(_, P) {
        return _.lastType == 'operator' || _.lastType == ',' || c.test(P.charAt(0)) || /[,.]/.test(P.charAt(0))
      }
      function Bt(_, P, ae) {
        return (
          (P.tokenize == U &&
      ...
      return {
        ...
        token: function (_, P) {
          if (
            (_.sol() &&
              (P.lexical.hasOwnProperty('align') || (P.lexical.align = !1), (P.indented = _.indentation()), re(_, P)),
          ...
          return E == 'comment'
            ? ae
            : ((P.lastType = E == 'operator' && (z == '++' || z == '--') ? 'incdec' : E), Q(P, ae, E, z, _))
        },
        indent: function (_, P) {
          if (_.tokenize == O || _.tokenize == W) return o.Pass
          if (_.tokenize != U) return 0
          var ae = P && P.charAt(0),
            pe = _.lexical,
            ne
          if (!/^\s*else\b/.test(P))
          ...
          for (
            ...
            (ae == '}' || ((ne = _.cc[_.cc.length - 1]) && (ne == Re || ne == Ge) && !/^[,\.=+\-*:?[\(]/.test(P)));
          )
            pe = pe.prev
  ...
  ;(function (o) {
    ...
    function v(C, k, c) {
      var d = C.current(),
        x = d.search(k)
      return (
        x > -1 ? C.backUp(d.length - x) : d.match(/<\/?$/) && (C.backUp(d.length), C.match(k, !1) || C.match(d)), c
      )
    }
    var L = {}
    function b(C) {
    ...
    function h(C, k) {
      for (var c in C) for (var d = k[c] || (k[c] = []), x = C[c], E = x.length - 1; E >= 0; E--) d.unshift(x[E])
    }
    function g(C, k) {
    ...
    ;(o.defineMode(
      ...
      function (C, k) {
        ...
        function w(U, M) {
          var O = c.token(U, M.htmlState),
            W = /\btag\b/.test(O),
            J
          if (
            W &&
            !/[<>\s\/]/.test(U.current()) &&
            (J = M.htmlState.tagName && M.htmlState.tagName.toLowerCase()) &&
            d.hasOwnProperty(J)
          )
            M.inTag = J + ' '
          else if (M.inTag && W && />$/.test(U.current())) {
            var re = /^([\S]+) (.*)/.exec(M.inTag)
            M.inTag = null
            var F = U.current() == '>' && g(d[re[1]], re[2]),
              q = o.getMode(C, F),
              D = s(re[1], !0),
              Q = s(re[1], !1)
            ;((M.token = function (j, V) {
              ...
              (M.localMode = q),
              (M.localState = o.startState(q, c.indent(M.htmlState, '', ''))))
          } else M.inTag && ((M.inTag += U.current()), U.eol() && (M.inTag += ' '))
          return O
        }
        return {
          startState: function () {
            var U = o.startState(c)
            return { token: w, inTag: null, localMode: null, localState: null, htmlState: U }
          },
          copyState: function (U) {
            var M
            return (
              U.localState && (M = o.copyState(U.localMode, U.localState)),
              {
                token: U.token,
                inTag: U.inTag,
                localMode: U.localMode,
                localState: M,
                htmlState: o.copyState(c, U.htmlState),
              }
            )
          },
          token: function (U, M) {
          ...
          indent: function (U, M, O) {
            return !U.localMode || /^\s*<\//.test(M)
              ? c.indent(U.htmlState, M, O)
              : U.localMode.indent
                ? U.localMode.indent(U.localState, M, O)
                : o.Pass
          },
          innerMode: function (U) {
            return { state: U.localState || U.htmlState, mode: U.localMode || c }
          },
        }
      },
      'xml',
...
var Rs = Ke((Bs, js) => {
  ;(function (o) {
    ...
    ;(o.defineMode('django:inner', function () {
      ...
      function s(c, d) {
        return function (x, E) {
          if (!E.escapeNext && x.eat(c)) E.tokenize = d
          else {
...
var Di = Ke((Hs, Ws) => {
  ;(function (o) {
      ...
      (o.simpleMode = function (k, c) {
        ...
        for (var z in c)
          if (z != x && c.hasOwnProperty(z))
            for (var w = (d[z] = []), U = c[z], M = 0; M < U.length; M++) {
              var O = U[M]
              ;(w.push(new b(O, c)), (O.indent || O.dedent) && (E = !0))
            }
        var W = {
          startState: function () {
          ...
          copyState: function (re) {
            ...
            ;(re.localState && (F.localState = o.copyState(re.local.mode, re.localState)),
              re.stack && (F.stack = re.stack.slice(0)))
            for (var q = re.persistentStates; q; q = q.next)
              F.persistentStates = {
                mode: q.mode,
                spec: q.spec,
                state: q.state == re.localState ? F.localState : o.copyState(q.mode, q.state),
        ...
        if (x) for (var J in x) x.hasOwnProperty(J) && (W[J] = x[J])
        return W
      }))
    function p(k, c) {
    ...
    function v(k, c) {
      ...
      var d = ''
      return (
        k instanceof RegExp ? (k.ignoreCase && (d = 'i'), k.unicode && (d += 'u'), (k = k.source)) : (k = String(k)),
        new RegExp((c === !1 ? '' : '^') + '(?:' + k + ')', d)
      )
    }
    function L(k) {
    ...
    function S(k, c) {
      return function (d, x) {
        if (x.pending) {
          var E = x.pending.shift()
          return (x.pending.length == 0 && (x.pending = null), (d.pos += E.text.length), E.token)
        }
        if (x.local)
          if (x.local.end && d.match(x.local.end)) {
            ...
            var z = x.local.mode.token(d, x.localState),
              w
            return (x.local.endScan && (w = x.local.endScan.exec(d.current())) && (d.pos = d.start + w.index), z)
          }
        for (var U = k[x.state], M = 0; M < U.length; M++) {
          var O = U[M],
            W = (!O.data.sol || d.sol()) && d.match(O.regex)
          if (W) {
            ;(O.data.next
              ? (x.state = O.data.next)
              : O.data.push
                ? ((x.stack || (x.stack = [])).push(x.state), (x.state = O.data.push))
                : O.data.pop && x.stack && x.stack.length && (x.state = x.stack.pop()),
              O.data.mode && h(c, x, O.data.mode, O.token),
              O.data.indent && x.indent.push(d.indentation() + c.indentUnit),
              O.data.dedent && x.indent.pop())
            var J = O.token
            if ((J && J.apply && (J = J(W)), W.length > 2 && O.token && typeof O.token != 'string')) {
              for (var re = 2; re < W.length; re++)
                W[re] && (x.pending || (x.pending = [])).push({ text: W[re], token: O.token[re - 1] })
              return (d.backUp(W[0].length - (W[1] ? W[1].length : 0)), J[0])
    ...
    function h(k, c, d, x) {
      var E
      if (d.persistent)
        for (var z = c.persistentStates; z && !E; z = z.next) (d.spec ? s(d.spec, z.spec) : d.mode == z.mode) && (E = z)
      var w = E ? E.mode : d.mode || o.getMode(k, d.spec),
        U = E ? E.state : o.startState(w)
      ;(d.persistent && !E && (c.persistentStates = { mode: w, spec: d.spec, state: U, next: c.persistentStates }),
        (c.localState = U),
        (c.local = {
          mode: w,
          end: d.end && v(d.end),
    ...
    function C(k, c) {
      return function (d, x, E) {
        if (d.local && d.local.mode.indent) return d.local.mode.indent(d.localState, x, E)
        ...
        e: for (;;) {
          for (var U = 0; U < w.length; U++) {
            ...
            if (M.data.dedent && M.data.dedentIfLineStart !== !1) {
              var O = M.regex.exec(x)
              if (O && O[0]) {
                ;(z--, (M.next || M.push) && (w = k[M.next || M.push]), (x = x.slice(O[0].length)))
                continue e
              }
            }
          }
    ...
    ;(o.defineMode(
      ...
      function (p, v) {
        ...
        function J(I) {
          if (
            ...
            if (!T) {
              ...
              T = he.mode.name == 'xml' && he.state.tagStart === null && !he.state.context && he.state.tokenize.isInText
            }
        ...
        function re(I, T) {
          ...
          if (T.indentationDiff === null && ((T.indentationDiff = T.indentation), ge)) {
            for (T.list = null; qe < T.listStack[T.listStack.length - 1];)
              (T.listStack.pop(),
                T.listStack.length ? (T.indentation = T.listStack[T.listStack.length - 1]) : (T.list = !1))
          ...
          if (T.indentation <= Oe && I.eat('>'))
            return (
              (T.quote = he ? 1 : T.quote + 1), v.highlightFormatting && (T.formatting = 'quote'), I.eatSpace(), D(T)
            )
          if (!Be && !T.setext && he && T.indentation <= Oe && (Ze = I.match(C))) {
            ...
            if (he && T.indentation <= Oe && (Ze = I.match(E, !0)))
              return (
                (T.quote = 0),
                (T.fencedEndRE = new RegExp(Ze[1] + '+ *$')),
                (T.localMode = v.fencedCodeBlockHighlighting && S(Ze[2] || v.fencedCodeBlockDefaultMode)),
            ...
            if (I.peek() === '[') return M(I, T, N)
          }
          return M(I, T, T.inline)
        }
        function F(I, T) {
        ...
        function D(I) {
          var T = []
          if (I.formatting) {
            ;(T.push(s.formatting), typeof I.formatting == 'string' && (I.formatting = [I.formatting]))
            for (var he = 0; he < I.formatting.length; he++)
              (T.push(s.formatting + '-' + I.formatting[he]),
                I.formatting[he] === 'header' && T.push(s.formatting + '-' + I.formatting[he] + '-' + I.header),
        ...
        function j(I, T) {
          ...
          if (de === '!' && I.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))
            return ((T.imageMarker = !0), (T.image = !0), v.highlightFormatting && (T.formatting = 'image'), D(T))
          if (de === '[' && T.imageMarker && I.match(/[^\]]*\](\(.*?\)| ?\[.*?\])/, !1))
            return (
              (T.imageMarker = !1), (T.imageAltText = !0), v.highlightFormatting && (T.formatting = 'image'), D(T)
            )
          ...
          if (de === ']' && T.linkText) {
            ...
            var Be = D(T)
            return ((T.linkText = !1), (T.inline = T.f = I.match(/\(.*?\)| ?\[.*?\]/, !1) ? y : j), Be)
          }
          if (de === '<' && I.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)) {
            ;((T.f = T.inline = V), v.highlightFormatting && (T.formatting = 'link'))
            var Be = D(T)
          ...
          if (
            v.xml &&
            de === '<' &&
            I.match(/^(!--|\?|!\[CDATA\[|[a-z][a-z0-9-]*(?:\s+[a-z_:.\-]+(?:\s*=\s*[^>]+)?)*\s*(?:>|$))/i, !1)
          ) {
            ...
            return (I.backUp(1), (T.htmlState = o.startState(L)), O(I, T, F))
          }
          if (v.xml && de === '<' && I.match(/^\/\w*?>/)) return ((T.md_inside = !1), 'tag')
          if (de === '*' || de === '_') {
            for (var Re = 1, Ge = I.pos == 1 ? ' ' : I.string.charAt(I.pos - 2); Re < 3 && I.eat(de);) Re++
            var $ = I.peek() || ' ',
              Z = !/\s/.test($) && (!w.test($) || /\s/.test(Ge) || w.test(Ge)),
              ce = !/\s/.test(Ge) && (!w.test(Ge) || /\s/.test($) || w.test($)),
              He = null,
              te = null
            if (
              (Re % 2 &&
                (!T.em && Z && (de === '*' || !ce || w.test(Ge))
                  ? (He = !0)
                  : T.em == de && ce && (de === '*' || !Z || w.test($)) && (He = !1)),
              Re > 1 &&
                (!T.strong && Z && (de === '*' || !ce || w.test(Ge))
                  ? (te = !0)
                  : T.strong == de && ce && (de === '*' || !Z || w.test($)) && (te = !1)),
              te != null || He != null)
            ) {
              ;(v.highlightFormatting && (T.formatting = He == null ? 'strong' : te == null ? 'em' : 'strong em'),
                He === !0 && (T.em = de),
                te === !0 && (T.strong = de))
              var Se = D(T)
          ...
          if (v.strikethrough) {
            if (de === '~' && I.eatWhile(de)) {
              if (T.strikethrough) {
                ...
                return ((T.strikethrough = !0), v.highlightFormatting && (T.formatting = 'strikethrough'), D(T))
            } else if (de === ' ' && I.match('~~', !0)) {
              if (I.peek() === ' ') return D(T)
              I.backUp(2)
            }
          }
          if (v.emoji && de === ':' && I.match(/^(?:[a-z_\d+][a-z_\d+-]*|\-[a-z_\d+][a-z_\d+-]*):/)) {
            ;((T.emoji = !0), v.highlightFormatting && (T.formatting = 'emoji'))
            var fe = D(T)
            return ((T.emoji = !1), fe)
          }
          return (
            de === ' ' && (I.match(/^ +$/, !1) ? T.trailingSpace++ : T.trailingSpace && (T.trailingSpaceNewLine = !0)),
            D(T)
          )
        }
        function V(I, T) {
        ...
        function N(I, T) {
          return I.match(/^([^\]\\]|\\.)*\]:/, !1)
            ? ((T.f = R), I.next(), v.highlightFormatting && (T.formatting = 'link'), (T.linkText = !0), D(T))
            : M(I, T, j)
        }
        function R(I, T) {
          if (I.match(']:', !0)) {
        ...
        var _e = {
          ...
          token: function (I, T) {
            if (((T.formatting = !1), I != T.thisLine.stream)) {
              if (((T.header = 0), (T.hr = !1), I.match(/^\s*$/, !0))) return (J(T), null)
              if (
                ...
                var he = I.match(/^\s*/, !0)[0].replace(/\t/g, U).length
        ...
        var s = {
            ...
            token: function (C, k) {
              ...
              if ((C.sol() || k.ateSpace) && ((k.ateSpace = !1), L.gitHubSpice !== !1)) {
                if (C.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+@)?(?=.{0,6}\d)(?:[a-f0-9]{7,40}\b)/))
...
var nu = Ke((tu, ru) => {
  ;(function (o) {
    ...
    ;(o.defineMode('go', function (p) {
      ...
      function h(x, E) {
        var z = x.next()
        if (z == '"' || z == "'" || z == '`') return ((E.tokenize = g(z)), E.tokenize(x, E))
        if (/[\d\.]/.test(z))
          return (
            z == '.'
        ...
        if (z == '/') {
          if (x.eat('*')) return ((E.tokenize = C), C(x, E))
      ...
      function g(x) {
        return function (E, z) {
          for (var w = !1, U, M = !1; (U = E.next()) != null;) {
            if (U == x && !w) {
              M = !0
              break
            }
          ...
          return ((M || !(w || x == '`')) && (z.tokenize = h), 'string')
        }
      }
      function C(x, E) {
      ...
      function k(x, E, z, w, U) {
        ;((this.indented = x), (this.column = E), (this.type = z), (this.align = w), (this.prev = U))
      }
      function c(x, E, z) {
        return (x.context = new k(x.indented, E, z, null, x.context))
      }
      function d(x) {
        if (x.context.prev) {
          var E = x.context.type
          return ((E == ')' || E == ']' || E == '}') && (x.indented = x.context.indented), (x.context = x.context.prev))
        }
      }
      return {
        startState: function (x) {
          return { tokenize: null, context: new k((x || 0) - v, 0, 'top', !1), indented: 0, startOfLine: !0 }
        },
        token: function (x, E) {
          var z = E.context
          if (
        ...
        indent: function (x, E) {
          ...
          var z = x.context,
            w = E && E.charAt(0)
          if (z.type == 'case' && /^(?:case|default)\b/.test(E)) return ((x.context.type = '}'), z.indented)
          var U = w == z.type
          return z.align ? z.column + (U ? 0 : 1) : z.indented + (U ? 0 : v)
        },
        electricChars: '{}):',
        closeBrackets: '()[]{}\'\'""``',
        fold: 'brace',
    ...
    ;(o.defineMode('jinja2', function () {
      ...
      function s(h, g) {
        ...
        if (g.intag) {
          ...
          if (h.eat('#'))
            return (
              (g.incomment = !0), h.skipTo('#}') ? (h.eatWhile(/\#|}/), (g.incomment = !1)) : h.skipToEnd(), 'comment'
            )
          if ((C = h.eat(/\{|%/)))
            return ((g.intag = C), (g.inbraces = 0), (g.inbrackets = 0), C == '{' && (g.intag = '}'), h.eat('-'), 'tag')
        } else if (h.eat('#')) {
...
var du = Ke((cu, fu) => {
  ;(function (o) {
    ...
    ;(o.defineMode(
      'jsx',
      function (L, b) {
        var S = o.getMode(L, { name: 'xml', allowMissing: !0, multilineTagIndentPastTag: !1, allowMissingTagName: !0 }),
        ...
        function C(c, d, x) {
          ...
          if (c.peek() == '{') {
            ...
            if (z && c.match(/^[^>]*>\s*$/, !1)) {
              ...
              z.startOfLine ? (E -= L.indentUnit) : x.prev.state.lexical && (E = x.prev.state.lexical.indented)
            } else x.depth == 1 && (E += L.indentUnit)
            return ((d.context = new p(o.startState(s, E), s, 0, d.context)), null)
          }
          if (x.depth == 1) {
            if (c.peek() == '<')
              return (S.skipAttribute(x.state), (d.context = new p(o.startState(S, h(x.state)), S, 0, d.context)), null)
          ...
          return (
            /\btag\b/.test(w)
              ? />$/.test(U)
                ...
                : /^</.test(U) && (x.depth = 1)
              : !w && (M = U.indexOf('{')) > -1 && c.backUp(U.length - M),
            w
          )
        }
        function k(c, d, x) {
          if (c.peek() == '<' && !c.match(/^<([^<>]|<[^>]*>)+,\s*>/, !1) && s.expressionAllowed(c, x.state))
            return (
              (d.context = new p(o.startState(S, s.indent(x.state, '', '')), S, 0, d.context)),
              s.skipExpression(x.state),
              null
            )
          var E = s.token(c, x.state)
          if (!E && x.depth != null) {
            var z = c.current()
...
var gu = Ke((pu, hu) => {
  ;(function (o) {
    ...
    ;(o.defineMode('nginx', function (p) {
      function v(x) {
        for (var E = {}, z = x.split(' '), w = 0; w < z.length; ++w) E[z[w]] = !0
        return E
      }
      var L = v(
      ...
      function C(x, E) {
        ...
        if (w == '/' && x.eat('*')) return ((E.tokenize = k), k(x, E))
        if (w == '<' && x.eat('!')) return ((E.tokenize = c), c(x, E))
        if (w == '=') g(null, 'compare')
        else
          return (w == '~' || w == '|') && x.eat('=')
            ? g(null, 'compare')
            : w == '"' || w == "'"
              ? ((E.tokenize = d(w)), E.tokenize(x, E))
              : w == '#'
      ...
      function d(x) {
        return function (E, z) {
          for (var w = !1, U; (U = E.next()) != null && !(U == x && !w);) w = !w && U == '\\'
      ...
      return {
        ...
        token: function (x, E) {
          ...
          h = null
          var z = E.tokenize(x, E),
            w = E.stack[E.stack.length - 1]
          return (
            h == 'hash' && w == 'rule'
              ? (z = 'atom')
              : z == 'variable' && (w == 'rule' ? (z = 'number') : (!w || w == '@media{') && (z = 'tag')),
            w == 'rule' && /^[\{\};]$/.test(h) && E.stack.pop(),
            h == '{'
              ? w == '@media'
              ...
              : h == '}'
                ...
                : h == '@media'
                  ? E.stack.push('@media')
                  : w == '{' && h != 'comment' && E.stack.push('rule'),
            z
          )
        },
        indent: function (x, E) {
          var z = x.stack.length
          return (/^\}/.test(E) && (z -= x.stack[x.stack.length - 1] == 'rule' ? 2 : 1), x.baseIndent + z * s)
        },
        electricChars: '}',
      }
    }),
  ...
  ;(function (o) {
    ...
    ;(o.defineMode('pascal', function () {
      ...
      function S(C, k) {
        ...
        return v.propertyIsEnumerable(d) ? 'keyword' : L.propertyIsEnumerable(d) ? 'atom' : 'variable'
      }
      function s(C) {
        return function (k, c) {
          for (var d = !1, x, E = !1; (x = k.next()) != null;) {
            if (x == C && !d) {
              E = !0
              break
            }
  ...
  ;(function (o) {
    ...
    ;(o.defineMode('perl', function () {
      var S = {
        ...
        s = 'string-2',
        h = /[goseximacplud]/
      function g(c, d, x, E, z) {
        return (
          (d.chain = null),
          (d.style = null),
          (d.tail = null),
          (d.tokenize = function (w, U) {
            for (var M = !1, O, W = 0; (O = w.next());) {
              if (O === x[W] && !M)
                return (
                  x[++W] !== void 0 ? ((U.chain = x[W]), (U.style = E), (U.tail = z)) : z && w.eatWhile(z),
                  (U.tokenize = k),
                  E
                )
              M = !M && O == '\\'
      ...
      function C(c, d, x) {
        return (
          (d.tokenize = function (E, z) {
            return (E.string == x && (z.tokenize = k), E.skipToEnd(), 'string')
          }),
          d.tokenize(c, d)
        )
      }
      function k(c, d) {
        ...
        if (c.match(/^(\-?((\d[\d_]*)?\.\d+(e[+-]?\d+)?|\d+\.\d*)|0x[\da-fA-F_]+|0b[01_]+|\d[\d_]*(e[+-]?\d+)?)/))
          return 'number'
        ...
        if (/[$@%&]/.test(x) && (c.eatWhile(/[\w$]/) || (c.eat('{') && c.eatWhile(/[\w$]/) && c.eat('}')))) {
          var w = c.current()
...
var Su = Ke((ku, wu) => {
  ;(function (o) {
      ...
      return C.length == 0
        ...
        : function (d, x) {
            for (var E = C[0], z = 0; z < E.length; z++)
              if (d.match(E[z][0])) return ((x.tokenize = v(C.slice(1), k)), E[z][1])
    ...
    function b(C, k, c, d) {
      if ((d !== !1 && C.match('${', !1)) || C.match('{$', !1)) return ((k.tokenize = null), 'string')
      ...
      for (
        var x = !1;
        !C.eol() && (x || d === !1 || (!C.match('{$', !1) && !C.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1)));
      ) {
        if (!x && C.match(c)) {
      ...
      hooks: {
        ...
        '<': function (C, k) {
          ...
          if ((c = C.match(/^<<\s*/))) {
            ...
            if ((d && C.eat(d), x))
              return ((k.tokStack || (k.tokStack = [])).push(x, 0), (k.tokenize = L(x, d != "'")), 'string')
          }
          return !1
        },
        '#': function (C) {
    ...
    ;(o.defineMode(
      ...
      function (C, k) {
        ...
        function x(E, z) {
          var w = z.curMode == d
          if ((E.sol() && z.pending && z.pending != '"' && z.pending != "'" && (z.pending = null), w))
            return w && z.php.tokenize == null && E.match('?>')
          ...
          if (z.pending == '"' || z.pending == "'") {
            ...
            E.pos = z.pending.end
            var U = z.pending.style
          } else var U = c.token(E, z.curState)
          ...
          return (
            O != -1 &&
              (U == 'string' && (W = M.match(/[\'\"]$/)) && !/\?>/.test(M)
                ? (z.pending = W[0])
                : (z.pending = { end: E.pos, style: U }),
              E.backUp(M.length - O)),
            U
          )
        }
        return {
          startState: function () {
            ...
            return { html: E, php: z, curMode: k.startOpen ? d : c, curState: k.startOpen ? z : E, pending: null }
          },
          copyState: function (E) {
            ...
            return (
              E.curMode == c ? (O = w) : (O = M),
              { html: w, php: M, curMode: E.curMode, curState: O, pending: E.pending }
            )
          },
          token: x,
          indent: function (E, z, w) {
            return (E.curMode != d && /^\s*<\//.test(z)) || (E.curMode == d && /^\?>/.test(z))
              ? c.indent(E.html, z, w)
              : E.curMode.indent(E.curState, z, w)
          },
          blockCommentStart: '/*',
          blockCommentEnd: '*/',
          lineComment: '//',
...
var Mu = Ke((Eu, zu) => {
  ;(function (o) {
    ...
    ;(o.defineMode('python', function (h, g) {
      ...
      if (w) {
        var U = g.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/
      ...
      var O = p(E),
        W = p(z)
      function J(G, X) {
        var N = G.sol() && X.lastToken != '\\'
        if ((N && (X.indent = G.indentation()), N && S(X).type == 'py')) {
          var R = S(X).offset
          if (G.eatSpace()) {
            var se = G.indentation()
            return (se > R ? D(X) : se < R && j(G, X) && G.peek() != '#' && (X.errorToken = !0), null)
          } else {
            var _e = re(G, X)
        ...
        function _e(I, T) {
          for (; !I.eol();)
            if ((I.eatWhile(/[^'"\{\}\\]/), I.eat('\\'))) {
              ...
              if (I.match('{{')) return R
              if (I.match('{', !1)) return ((T.tokenize = se(0)), I.current() ? R : T.tokenize(I, T))
              if (I.match('}}')) return R
              if (I.match('}')) return C
              I.eat(/['"]/)
            }
      ...
      function Q(G, X, N) {
        ...
        X.scopes.push({ offset: X.indent + x, type: N, align: R })
      }
      function j(G, X) {
        for (var N = G.indentation(); X.scopes.length > 1 && S(X).offset > N;) {
      ...
      function V(G, X) {
        ...
        var N = X.tokenize(G, X),
          R = G.current()
        if (X.beginningOfLine && R == '@') return G.match(U, !1) ? 'meta' : w ? 'operator' : C
        if (
        ...
        return (X.dedent && G.eol() && S(X).type == 'py' && X.scopes.length > 1 && X.scopes.pop(), N)
      }
      var y = {
        ...
        token: function (G, X) {
          ...
          var R = V(G, X)
          return (
            R && R != 'comment' && (X.lastToken = R == 'keyword' || R == 'punctuation' ? G.current() : R),
        ...
        indent: function (G, X) {
          ...
          var N = S(G),
            R = N.type == X.charAt(0) || (N.type == 'py' && !G.dedent && /^(else:|elif |except |finally:)/.test(X))
          return N.align != null ? N.align - (R ? 1 : 0) : N.offset - (R ? x : 0)
        },
...
var qu = Ke((Au, Du) => {
  ;(function (o) {
    ...
    ;(o.defineMode('ruby', function (g) {
      var C
      function k(M, O, W) {
        return (W.tokenize.push(M), M(O, W))
      }
      function c(M, O) {
        if (M.sol() && M.match('=begin') && M.eol()) return (O.tokenize.push(U), 'comment')
        if (M.eatSpace()) return null
        var W = M.next(),
          J
        if (W == '`' || W == "'" || W == '"') return k(z(W, 'string', W == '"' || W == '`'), M, O)
        if (W == '/') return d(M) ? k(z(W, 'string-2', !0), M, O) : 'operator'
        if (W == '%') {
          var re = 'string',
            F = !0
          M.eat('s')
          ...
          var q = M.eat(/[^\w\s=]/)
          return q ? (s.propertyIsEnumerable(q) && (q = s[q]), k(z(q, re, F, !0), M, O)) : 'operator'
        } else {
          if (W == '#') return (M.skipToEnd(), 'comment')
          if (W == '<' && (J = M.match(/^<([-~])[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/)))
            return k(w(J[2], J[1]), M, O)
          if (W == '0')
            return (
              M.eat('x') ? M.eatWhile(/[\da-fA-F]/) : M.eat('b') ? M.eatWhile(/[01]/) : M.eatWhile(/[0-7]/), 'number'
            )
          if (/\d/.test(W)) return (M.match(/^[\d_]*(?:\.[\d_]+)?(?:[eE][+\-]?[\d_]+)?/), 'number')
          if (W == '?') {
            for (; M.match(/^\\[CM]-/););
                  ...
                  : M.eat(/[\<\>]/)
                    ...
                    : M.eat(/[\+\-\*\/\&\|\:\!]/)
                      ...
                      : M.eat(/[a-zA-Z$@_\xa1-\uffff]/)
                        ...
                        : 'operator'
            if (W == '@' && M.match(/^@?[a-zA-Z_\xa1-\uffff]/))
              return (M.eat('@'), M.eatWhile(/[\w\xa1-\uffff]/), 'variable-2')
            if (W == '$')
              return (M.eat(/[a-zA-Z_]/) ? M.eatWhile(/[\w]/) : M.eat(/\d/) ? M.eat(/\d/) : M.next(), 'variable-3')
            if (/[a-zA-Z_\xa1-\uffff]/.test(W))
              return (M.eatWhile(/[\w\xa1-\uffff]/), M.eat(/[\?\!]/), M.eat(':') ? 'atom' : 'ident')
            if (W == '|' && (O.varList || O.lastTok == '{' || O.lastTok == 'do')) return ((C = '|'), null)
            if (/[\(\)\[\]{}\\;]/.test(W)) return ((C = W), null)
            if (W == '-' && M.eat('>')) return 'arrow'
            if (/[=+\-\/*:\.^%<>~|]/.test(W)) {
              var D = M.eatWhile(/[=+\-\/*:\.^%<>~|]/)
              return (W == '.' && !D && (C = '.'), 'operator')
            } else return null
          }
        }
      }
      function d(M) {
        for (var O = M.pos, W = 0, J, re = !1, F = !1; (J = M.next()) != null;)
          if (F) F = !1
          else {
            if ('[{('.indexOf(J) > -1) W++
            else if (']})'.indexOf(J) > -1) {
      ...
      function x(M) {
        return (
          ...
          function (O, W) {
            if (O.peek() == '}') {
              if (M == 1) return (W.tokenize.pop(), W.tokenize[W.tokenize.length - 1](O, W))
              W.tokenize[W.tokenize.length - 1] = x(M - 1)
            } else O.peek() == '{' && (W.tokenize[W.tokenize.length - 1] = x(M + 1))
            return c(O, W)
          }
        )
      }
      function E() {
        var M = !1
        return function (O, W) {
          return M ? (W.tokenize.pop(), W.tokenize[W.tokenize.length - 1](O, W)) : ((M = !0), c(O, W))
        }
      }
      function z(M, O, W, J) {
        return function (re, F) {
          var q = !1,
            D
          for (
            F.context.type === 'read-quoted-paused' && ((F.context = F.context.prev), re.eat('}'));
            (D = re.next()) != null;
          ) {
            if (D == M && (J || !q)) {
              F.tokenize.pop()
            ...
            if (W && D == '#' && !q) {
              if (re.eat('{')) {
                ;(M == '}' && (F.context = { prev: F.context, type: 'read-quoted-paused' }), F.tokenize.push(x()))
                break
      ...
      function w(M, O) {
        return function (W, J) {
          return (O && W.eatSpace(), W.match(M) ? J.tokenize.pop() : W.skipToEnd(), 'string')
        }
      }
      function U(M, O) {
        return (M.sol() && M.match('=end') && M.eol() && O.tokenize.pop(), M.skipToEnd(), 'comment')
      }
      return {
        startState: function () {
          return {
        ...
        token: function (M, O) {
          ;((C = null), M.sol() && (O.indented = M.indentation()))
          var W = O.tokenize[O.tokenize.length - 1](M, O),
            J,
            re = C
          if (W == 'ident') {
            var F = M.current()
              ...
              W == 'keyword' &&
                ...
                b.propertyIsEnumerable(F)
                  ...
                  : S.propertyIsEnumerable(F)
                    ? (J = 'dedent')
                    : (((F == 'if' || F == 'unless') && M.column() == M.indentation()) ||
                        (F == 'do' && O.context.indented < O.indented)) &&
                      (J = 'indent')))
          }
          return (
            (C || (W && W != 'comment')) && (O.lastTok = re),
            C == '|' && (O.varList = !O.varList),
            J == 'indent' || /[\(\[\{]/.test(C)
              ? (O.context = { prev: O.context, type: C || W, indented: O.indented })
              : (J == 'dedent' || /[\)\]\}]/.test(C)) && O.context.prev && (O.context = O.context.prev),
            M.eol() && (O.continuedLine = C == '\\' || W == 'operator'),
            W
          )
        },
        indent: function (M, O) {
          ...
          var W = O && O.charAt(0),
            J = M.context,
            re = J.type == h[W] || (J.type == 'keyword' && /^(?:end|until|else|elsif|when|rescue)\b/.test(O))
          return J.indented + (re ? 0 : g.indentUnit) + (M.continuedLine ? g.indentUnit : 0)
        },
  ...
  ;(function (o) {
    ...
    ;(o.defineMode(
      ...
      function (p) {
        ...
        function z(F, q) {
          ...
          return D === ')'
            ...
            : D === '('
              ...
              : D === "'" || D === '"'
                ? ((q.tokenizer = U(F.next())), 'string')
                : ((q.tokenizer = U(')', !1)), 'string')
        }
        function w(F, q) {
          return function (D, Q) {
            return D.sol() && D.indentation() <= F
              ? ((Q.tokenizer = J), J(D, Q))
              : (q && D.skipTo('*/') ? (D.next(), D.next(), (Q.tokenizer = J)) : D.skipToEnd(), 'comment')
          }
        }
        function U(F, q) {
          q == null && (q = !0)
          function D(Q, j) {
            var V = Q.next(),
              ...
              X = (V !== '\\' && y === F) || (V === F && G !== '\\')
            return X
              ? (V !== F && q && Q.next(), E(Q) && (j.cursorHalf = 0), (j.tokenizer = J), 'string')
              : V === '#' && y === '{'
        ...
        function M(F) {
          return function (q, D) {
            return q.peek() === '}' ? (q.next(), (D.tokenizer = F), 'operator') : J(q, D)
          }
        }
        function O(F) {
          if (F.indentCount == 0) {
        ...
        function J(F, q) {
          var D = F.peek()
          if (F.match('/*')) return ((q.tokenizer = w(F.indentation(), !0)), q.tokenizer(F, q))
          if (F.match('//')) return ((q.tokenizer = w(F.indentation(), !1)), q.tokenizer(F, q))
          if (F.match('#{')) return ((q.tokenizer = M(J)), 'operator')
          if (D === '"' || D === "'") return (F.next(), (q.tokenizer = U(D)), 'string')
          if (q.cursorHalf) {
            if ((D === '#' && (F.next(), F.match(/[0-9a-fA-F]{6}|[0-9a-fA-F]{3}/))) || F.match(/^-?[0-9\.]+/))
              return (E(F) && (q.cursorHalf = 0), 'number')
            if (F.match(/^(px|em|in)\b/)) return (E(F) && (q.cursorHalf = 0), 'unit')
            if (F.match(C)) return (E(F) && (q.cursorHalf = 0), 'keyword')
            if (F.match(/^url/) && F.peek() === '(') return ((q.tokenizer = z), E(F) && (q.cursorHalf = 0), 'atom')
            if (D === '$') return (F.next(), F.eatWhile(/[\w-]/), E(F) && (q.cursorHalf = 0), 'variable-2')
            if (D === '!') return (F.next(), (q.cursorHalf = 0), F.match(/^[\w]+/) ? 'keyword' : 'operator')
            if (F.match(c)) return (E(F) && (q.cursorHalf = 0), 'operator')
            if (F.eatWhile(/[\w-]/))
              return (
                E(F) && (q.cursorHalf = 0),
                (x = F.current().toLowerCase()),
                S.hasOwnProperty(x)
                  ? 'atom'
                  : b.hasOwnProperty(x)
                    ? 'keyword'
                    : L.hasOwnProperty(x)
                      ? ((q.prevProp = F.current().toLowerCase()), 'property')
                      : 'tag'
              )
            ...
            if (D === '.') {
              if ((F.next(), F.match(/^[\w-]+/))) return (O(q), 'qualifier')
              if (F.peek() === '#') return (O(q), 'tag')
            }
            if (D === '#') {
              if ((F.next(), F.match(/^[\w-]+/))) return (O(q), 'builtin')
              if (F.peek() === '#') return (O(q), 'tag')
            }
            if (D === '$') return (F.next(), F.eatWhile(/[\w-]/), 'variable-2')
            if (F.match(/^-?[0-9\.]+/)) return 'number'
            if (F.match(/^(px|em|in)\b/)) return 'unit'
            if (F.match(C)) return 'keyword'
            if (F.match(/^url/) && F.peek() === '(') return ((q.tokenizer = z), 'atom')
            if (D === '=' && F.match(/^=[\w-]+/)) return (O(q), 'meta')
            if (D === '+' && F.match(/^\+[\w-]+/)) return 'variable-3'
            if (
              (D === '@' && F.match('@extend') && (F.match(/\s*[\w]/) || W(q)),
              F.match(/^@(else if|if|media|else|for|each|while|mixin|function)/))
            )
              return (O(q), 'def')
            if (D === '@') return (F.next(), F.eatWhile(/[\w-]/), 'def')
            if (F.eatWhile(/[\w-]/))
              if (F.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                x = F.current().toLowerCase()
                var Q = q.prevProp + '-' + x
                return L.hasOwnProperty(Q)
                  ? 'property'
                  : L.hasOwnProperty(x)
                    ? ((q.prevProp = x), 'property')
                    : s.hasOwnProperty(x)
                      ? 'property'
                      : 'tag'
              } else
                return F.match(/ *:/, !1)
                  ? (O(q), (q.cursorHalf = 1), (q.prevProp = F.current().toLowerCase()), 'property')
                  : (F.match(/ *,/, !1) || O(q), 'tag')
            if (D === ':') return F.match(d) ? 'variable-3' : (F.next(), (q.cursorHalf = 1), 'operator')
          }
        ...
        function re(F, q) {
          ...
          var D = q.tokenizer(F, q),
            Q = F.current()
          if (((Q === '@return' || Q === '}') && W(q), D !== null)) {
            for (
              var j = F.pos - Q.length, V = j + p.indentUnit * q.indentCount, y = [], G = 0;
              G < q.scopes.length;
              G++
            ) {
              var X = q.scopes[G]
        ...
        return {
          ...
          token: function (F, q) {
            var D = re(F, q)
            return ((q.lastToken = { style: D, content: F.current() }), D)
          },
          indent: function (F) {
...
var Ru = Ke((Bu, ju) => {
  ;(function (o) {
    ...
    ;(o.defineMode('shell', function () {
      var p = {}
      function v(d, x) {
        for (var E = 0; E < x.length; E++) p[x[E]] = d
      }
      var L = ['true', 'false'],
        b = [
          'if',
      ...
      ;(o.registerHelper('hintWords', 'shell', L.concat(b, S)), v('atom', L), v('keyword', b), v('builtin', S))
      function s(d, x) {
        ...
        d.eatWhile(/[\w-]/)
        var U = d.current()
        return d.peek() === '=' && /\w+/.test(U) ? 'def' : p.hasOwnProperty(U) ? p[U] : null
      }
      function h(d, x) {
        var E = d == '(' ? ')' : d == '{' ? '}' : d
        return function (z, w) {
          for (var U, M = !1; (U = z.next()) != null;) {
            if (U === E && !M) {
              w.tokens.shift()
              break
            } else if (U === '$' && !M && d !== "'" && z.peek() != E) {
              ;((M = !0), z.backUp(1), w.tokens.unshift(C))
              break
            } else {
              if (!M && d !== E && U === d) return (w.tokens.unshift(h(d, x)), c(z, w))
              if (!M && /['"]/.test(U) && !/['"]/.test(d)) {
                ;(w.tokens.unshift(g(U, 'string')), z.backUp(1))
                break
              }
            }
            M = !M && U === '\\'
      ...
      function g(d, x) {
        return function (E, z) {
          return ((z.tokens[0] = h(d, x)), E.next(), c(E, z))
        }
      }
      var C = function (d, x) {
        ...
        var E = d.next()
        return /['"({]/.test(E)
          ? ((x.tokens[0] = h(E, E == '(' ? 'quote' : E == '{' ? 'def' : 'string')), c(d, x))
          : (/\d/.test(E) || d.eatWhile(/\w/), x.tokens.shift(), 'def')
      }
      function k(d) {
        return function (x, E) {
          return (x.sol() && x.string == d && E.tokens.shift(), x.skipToEnd(), 'string-2')
        }
      }
      function c(d, x) {
  ...
  ;(function (o) {
    ...
    o.defineMode('sql', function (g, C) {
      var k = C.client || {},
        ...
        z = C.support || {},
        w = C.hooks || {},
        U = C.dateSQL || { date: !0, time: !0, timestamp: !0 },
      ...
      function J(Q, j) {
        ...
        if (
          z.hexNumber &&
          ((V == '0' && Q.match(/^[xX][0-9a-fA-F]+/)) || ((V == 'x' || V == 'X') && Q.match(/^'[0-9a-fA-F]*'/)))
        )
          return 'number'
        if (z.binaryNumber && (((V == 'b' || V == 'B') && Q.match(/^'[01]*'/)) || (V == '0' && Q.match(/^b[01]+/))))
          return 'number'
        ...
        if (V == '/' && Q.eat('*')) return ((j.tokenize = F(1)), j.tokenize(Q, j))
        if (V == '.') {
          ...
          if (W.test(V)) return (Q.eatWhile(W), 'punctuation')
          if (
            V == '{' &&
            (Q.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/) || Q.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/))
          )
            return 'number'
          Q.eatWhile(/^[_\w\d]/)
          var G = Q.current().toLowerCase()
          return U.hasOwnProperty(G) && (Q.match(/^( )+'[^']*'/) || Q.match(/^( )+"[^"]*"/))
            ? 'number'
            : c.hasOwnProperty(G)
              ? 'atom'
              : d.hasOwnProperty(G)
      ...
      return {
        ...
        token: function (Q, j) {
          if (
            (Q.sol() && j.context && j.context.align == null && (j.context.align = !1), j.tokenize == J && Q.eatSpace())
          )
            return null
          ...
          var y = Q.current()
          return (y == '(' ? q(Q, j, ')') : y == '[' ? q(Q, j, ']') : j.context && j.context.type == y && D(j), V)
        },
        indent: function (Q, j) {
          var V = Q.context
          if (!V) return o.Pass
...
var ta = Ke(($u, Ku) => {
  ;(function (o) {
    ...
    o.defineMode('stylus', function (M) {
      ...
      function Oe(K, H) {
        if (
          ...
          (H.context.line.indent = K.indentation()),
          (ze = K.peek()),
          K.match('//'))
        )
          return (K.skipToEnd(), ['comment', 'comment'])
        if (K.match('/*')) return ((H.tokenize = qe), qe(K, H))
        if (ze == '"' || ze == "'") return (K.next(), (H.tokenize = Se(ze)), H.tokenize(K, H))
        if (ze == '@') return (K.next(), K.eatWhile(/[\w\\-]/), ['def', K.current()])
        if (ze == '#') {
          if ((K.next(), K.match(/^[0-9a-f]{3}([0-9a-f]([0-9a-f]{2}){0,2})?\b(?!-)/i))) return ['atom', 'atom']
        ...
        return K.match(_e)
          ...
          : K.match(/^-?[0-9]?\.?[0-9]/)
            ...
            : ze == '!'
              ? (K.next(), [K.match(/^(important|optional)/i) ? 'keyword' : 'operator', 'important'])
              : ze == '.' && K.match(/^\.[a-z][\w-]*/i)
                ? ['qualifier', 'qualifier']
                : K.match(V)
                  ? (K.peek() == '(' && (H.tokenize = Be), ['property', 'word'])
                  : K.match(/^[a-z][\w-]*\(/i)
                    ? (K.backUp(1), ['keyword', 'mixin'])
                    : K.match(/^(\+|-)[a-z][\w-]*\(/i)
                      ? (K.backUp(1), ['keyword', 'block-mixin'])
                      : K.string.match(/^\s*&/) && K.match(/^[-_]+[a-z][\w-]*/)
                        ? ['qualifier', 'qualifier']
                        : K.match(/^(\/|&)(-|_|:|\.|#|[a-z])/)
                          ...
                          : K.match(/^&{1}\s*$/)
                            ...
                            : K.match(R)
                              ...
                              : K.match(/^\$?[-_]*[a-z0-9]+[\w-]*/i)
                                ? K.match(/^(\.|\[)[\w-\'\"\]]+/i, !1) && !$(K.current())
                                  ? (K.match('.'), ['variable-2', 'variable-name'])
                                  : ['variable-2', 'word']
                                : K.match(N)
                                  ? ['operator', K.current()]
                                  : /[:;,{}\[\]\(\)]/.test(ze)
      ...
      function Se(K) {
        return function (H, le) {
          ...
          return ((nt == K || (!De && K != ')')) && (le.tokenize = null), ['string', 'string'])
        }
      }
      function Be(K, H) {
        return (K.next(), K.match(/\s*[\"\')]/, !1) ? (H.tokenize = null) : (H.tokenize = Se(')')), [null, '('])
      }
      function Ze(K, H, le, De) {
        ;((this.type = K), (this.indent = H), (this.prev = le), (this.line = De || { firstWord: '', indent: 0 }))
      }
      function ke(K, H, le, De) {
        return ((De = De >= 0 ? De : O), (K.context = new Ze(le, H.indentation() + De, K.context)), le)
      }
      function Je(K, H) {
        var le = K.context.indent - O
        return ((H = H || !1), (K.context = K.context.prev), H && (K.context.indent = le), K.context.type)
      }
      function Re(K, H, le) {
        return he[le.context.type](K, H, le)
      }
      function Ge(K, H, le, De) {
      ...
      function fe(K, H) {
        return (Me(H) && (K == '{' || K == ']' || K == 'hash' || K == 'qualifier')) || K == 'block-mixin'
      }
      function oe(K, H) {
        return K == '{' && H.match(/^\s*\$?[\w-]+/i, !1)
      }
      function Ue(K, H) {
        return K == ':' && H.match(/^[a-z-]+/, !1)
      }
      function we(K) {
        return K.sol() || K.string.match(new RegExp('^\\s*' + U(K.current())))
      }
      function Me(K) {
      ...
      function Le(K) {
        var H = /^\s*[-_]*[a-z0-9]+[\w-]*/i,
          le = typeof K == 'string' ? K.match(H) : K.string.match(H)
        return le ? le[0].replace(/^\s*/, '') : ''
      }
      return (
        (he.block = function (K, H, le) {
          if ((K == 'comment' && we(H)) || (K == ',' && Me(H)) || K == 'mixin') return ke(le, H, 'block', 0)
          if (oe(K, H)) return ke(le, H, 'interpolation')
          if (Me(H) && K == ']' && !/^\s*(\.|#|:|\[|\*|&)/.test(H.string) && !$(Le(H))) return ke(le, H, 'block', 0)
          if (fe(K, H)) return ke(le, H, 'block')
          if (K == '}' && Me(H)) return ke(le, H, 'block', 0)
          if (K == 'variable-name')
            return H.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/) || ce(Le(H))
              ? ke(le, H, 'variableName')
              : ke(le, H, 'variableName', 0)
          if (K == '=') return !Me(H) && !ce(Le(H)) ? ke(le, H, 'block', 0) : ke(le, H, 'block')
          if (K == '*' && (Me(H) || H.match(/\s*(,|\.|#|\[|:|{)/, !1))) return ((ge = 'tag'), ke(le, H, 'block'))
          if (Ue(K, H)) return ke(le, H, 'pseudo')
          if (/@(font-face|media|supports|(-moz-)?document)/.test(K)) return ke(le, H, Me(H) ? 'block' : 'atBlock')
          if (/@(-(moz|ms|o|webkit)-)?keyframes$/.test(K)) return ke(le, H, 'keyframes')
          if (/@extends?/.test(K)) return ke(le, H, 'extend', 0)
          if (K && K.charAt(0) == '@')
            return H.indentation() > 0 && Z(H.current().slice(1))
              ...
              : /(@import|@require|@charset)/.test(K)
                ? ke(le, H, 'block', 0)
                : ke(le, H, 'block')
          if (K == 'reference' && Me(H)) return ke(le, H, 'block')
          if (K == '(') return ke(le, H, 'parens')
          if (K == 'vendor-prefixes') return ke(le, H, 'vendorPrefixes')
          if (K == 'word') {
            var De = H.current()
            if (((ge = te(De)), ge == 'property')) return we(H) ? ke(le, H, 'block', 0) : ((ge = 'atom'), 'block')
            if (ge == 'tag') {
              if (
              ...
              if (
                re.test(De) &&
                ((we(H) && H.string.match(/=/)) || (!we(H) && !H.string.match(/^(\s*\.|#|\&|\[|\/|>|\*)/) && !$(Le(H))))
              )
                return ((ge = 'variable-2'), ce(Le(H)) ? 'block' : ke(le, H, 'block', 0))
              if (Me(H)) return ke(le, H, 'block')
            }
            if (ge == 'block-keyword')
              return ((ge = 'keyword'), H.current(/(if|unless)/) && !we(H) ? 'block' : ke(le, H, 'block'))
            if (De == 'return') return ke(le, H, 'block', 0)
            if (ge == 'variable-2' && H.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/)) return ke(le, H, 'block')
          }
          return le.context.type
        }),
        (he.parens = function (K, H, le) {
          if (K == '(') return ke(le, H, 'parens')
          if (K == ')')
              ...
              : (H.string.match(/^[a-z][\w-]*\(/i) && Me(H)) ||
                ...
                : H.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) ||
                  ...
                  : Me(H)
                    ? ke(le, H, 'block')
                    : ke(le, H, 'block', 0)
          if ((K && K.charAt(0) == '@' && Z(H.current().slice(1)) && (ge = 'variable-2'), K == 'word')) {
            var De = H.current()
            ;((ge = te(De)),
              ge == 'tag' && re.test(De) && (ge = 'variable-2'),
              (ge == 'property' || De == 'to') && (ge = 'atom'))
          }
          return K == 'variable-name' ? ke(le, H, 'variableName') : Ue(K, H) ? ke(le, H, 'pseudo') : le.context.type
        }),
        (he.vendorPrefixes = function (K, H, le) {
          return K == 'word' ? ((ge = 'property'), ke(le, H, 'block', 0)) : Je(le)
        }),
        (he.pseudo = function (K, H, le) {
          return Z(Le(H.string))
            ? Ge(K, H, le)
            : (H.match(/^[a-z-]+/), (ge = 'variable-3'), Me(H) ? ke(le, H, 'block') : Je(le))
        }),
        (he.atBlock = function (K, H, le) {
          if (K == '(') return ke(le, H, 'atBlock_parens')
          if (fe(K, H)) return ke(le, H, 'block')
          if (oe(K, H)) return ke(le, H, 'interpolation')
          if (K == 'word') {
          ...
          return (K == 'operator' && /^(not|and|or)$/.test(H.current()) && (ge = 'keyword'), le.context.type)
        }),
        (he.atBlock_parens = function (K, H, le) {
          if (K == '{' || K == '}') return le.context.type
          if (K == ')') return Me(H) ? ke(le, H, 'block') : ke(le, H, 'atBlock')
          if (K == 'word') {
            var De = H.current().toLowerCase()
            return (
              (ge = te(De)),
          ...
          return he.atBlock(K, H, le)
        }),
        (he.keyframes = function (K, H, le) {
          return H.indentation() == '0' &&
            ((K == '}' && we(H)) || K == ']' || K == 'hash' || K == 'qualifier' || $(H.current()))
            ? Ge(K, H, le)
            : K == '{'
              ? ke(le, H, 'keyframes')
              : K == '}'
                ? we(H)
                  ? Je(le, !0)
                  : ke(le, H, 'keyframes')
                : K == 'unit' && /^[0-9]+\%$/.test(H.current())
                  ? ke(le, H, 'keyframes')
                  : K == 'word' && ((ge = te(H.current())), ge == 'block-keyword')
                    ? ((ge = 'keyword'), ke(le, H, 'keyframes'))
                    : /@(font-face|media|supports|(-moz-)?document)/.test(K)
                      ? ke(le, H, Me(H) ? 'block' : 'atBlock')
                      : K == 'mixin'
                        ? ke(le, H, 'block', 0)
                        : le.context.type
        }),
        (he.interpolation = function (K, H, le) {
          return (
            K == '{' && Je(le) && ke(le, H, 'block'),
            K == '}'
              ? H.string.match(/^\s*(\.|#|:|\[|\*|&|>|~|\+|\/)/i) || (H.string.match(/^\s*[a-z]/i) && $(Le(H)))
                ? ke(le, H, 'block')
              ...
              : K == 'variable-name'
                ? ke(le, H, 'variableName', 0)
                : (K == 'word' && ((ge = te(H.current())), ge == 'tag' && (ge = 'atom')), le.context.type)
          )
        }),
        (he.extend = function (K, H, le) {
          return K == '[' || K == '='
            ? 'extend'
            : K == ']'
              ? Je(le)
        ...
        (he.variableName = function (K, H, le) {
          return K == 'string' || K == '[' || K == ']' || H.current().match(/^(\.|\$)/)
            ? (H.current().match(/^\.[\w-]+/i) && (ge = 'variable-2'), 'variableName')
            : Ge(K, H, le)
        }),
        {
          startState: function (K) {
            return { tokenize: null, state: 'block', context: new Ze('block', K || 0, null) }
          },
          token: function (K, H) {
            return !H.tokenize && K.eatSpace()
              ? null
              : ((de = (H.tokenize || Oe)(K, H)),
                de && typeof de == 'object' && ((Ee = de[1]), (de = de[0])),
                (ge = de),
                (H.state = he[H.state](Ee, K, H)),
                ge)
          },
          indent: function (K, H, le) {
            var De = K.context,
              nt = H && H.charAt(0),
              dt = De.indent,
              Pt = Le(H),
              Ft = le.match(/^\s*/)[0].replace(/\t/g, W).length,
              Pe = K.context.prev ? K.context.prev.line.firstWord : '',
              xt = K.context.prev ? K.context.prev.line.indent : Ft
            return (
              De.prev &&
    ...
    var p = [
      ...
      L = ['all', 'aural', 'braille', 'handheld', 'print', 'projection', 'screen', 'tty', 'tv', 'embossed'],
      b = [
        'width',
        'min-width',
        'max-width',
      ...
      x = ['@font-face', '@keyframes', '@media', '@viewport', '@page', '@host', '@supports', '@block', '@css'],
      E = p.concat(v, L, b, S, s, g, C, h, k, c, d, x)
    function z(M) {
      return (
        (M = M.sort(function (O, W) {
          return W > O
        })),
        new RegExp('^((' + M.join(')|(') + '))\\b')
      )
    ...
    function w(M) {
      for (var O = {}, W = 0; W < M.length; ++W) O[M[W]] = !0
      return O
    }
    function U(M) {
...
var Xu = Ke((Gu, Zu) => {
  ;(function (o) {
    ...
    function w(F, q, D) {
      if ((F.sol() && (q.indented = F.indentation()), F.eatSpace())) return null
      var Q = F.peek()
      if (Q == '/') {
        if (F.match('//')) return (F.skipToEnd(), 'comment')
        if (F.match('/*')) return (q.tokenize.push(O), O(F, q))
      }
      if (F.match(E)) return 'builtin'
      if (F.match(z)) return 'attribute'
      if (F.match(g) || F.match(C) || F.match(k) || F.match(c)) return 'number'
      if (F.match(x)) return 'property'
      if (s.indexOf(Q) > -1) return (F.next(), 'operator')
      if (h.indexOf(Q) > -1) return (F.next(), F.match('..'), 'punctuation')
      var j
      if ((j = F.match(/("""|"|')/))) {
      ...
      if (F.match(d)) {
        ...
        return S.hasOwnProperty(y)
          ...
          : b.hasOwnProperty(y)
            ? 'atom'
            : v.hasOwnProperty(y)
              ? (L.hasOwnProperty(y) && (q.prev = 'define'), 'keyword')
              : D == 'define'
                ? 'def'
                : 'variable'
      }
      ...
      return function (q, D, Q) {
        ...
        if (j == 'punctuation') {
          if (q.current() == '(') ++F
            ...
            if (F == 0) return (q.backUp(1), D.tokenize.pop(), D.tokenize[D.tokenize.length - 1](q, D))
            --F
          }
        }
        return j
    ...
    function M(F, q, D) {
      for (var Q = F.length == 1, j, V = !1; (j = q.peek());)
        if (V) {
          if ((q.next(), j == '(')) return (D.tokenize.push(U()), 'string')
          V = !1
        } else {
    ...
    function J(F, q) {
      ...
      F.context = new W(F.context, D, F.indented)
    }
    function re(F) {
      F.context && ((F.indented = F.context.indented), (F.context = F.context.prev))
    }
    ;(o.defineMode('swift', function (F) {
      return {
        ...
        indent: function (q, D) {
          ...
          if (!Q) return 0
          var j = /^[\]\}\)]/.test(D)
          return Q.align != null ? Q.align - (j ? 1 : 0) : Q.indented + (j ? 0 : F.indentUnit)
        },
        electricInput: /^\s*[\)\}\]]$/,
        lineComment: '//',
        blockCommentStart: '/*',
  ...
  ;(function (o) {
    ...
    ;(o.defineMode('coffeescript', function (p, v) {
      ...
      function U(q, D) {
        ...
        if (q.match('###')) return ((D.tokenize = O), D.tokenize(q, D))
        ...
        if (q.match(x)) return ((D.tokenize = M(q.current(), !1, 'string')), D.tokenize(q, D))
        if (q.match(E)) {
          if (q.current() != '/' || q.match(/^.*\//, !1))
            return ((D.tokenize = M(q.current(), !0, 'string-2')), D.tokenize(q, D))
          q.backUp(1)
        }
        ...
        return function (j, V) {
          for (; !j.eol();)
            if ((j.eatWhile(/[^'"\/\\]/), j.eat('\\'))) {
              ...
              if (j.match(q)) return ((V.tokenize = U), Q)
              j.eat(/['"\/]/)
            }
          return (D && (v.singleLineStringErrors ? (Q = L) : (V.tokenize = U)), Q)
        }
      }
      function O(q, D) {
        for (; !q.eol();) {
      ...
      function W(q, D, Q) {
        ...
        ;(Q !== 'coffee' ? ((V = null), (y = q.column() + q.current().length)) : D.scope.align && (D.scope.align = !1),
          (D.scope = { offset: j, type: Q, prev: D.scope, align: V, alignOffset: y }))
      }
      function J(q, D) {
        if (D.scope.prev)
          if (D.scope.type === 'coffee') {
            for (var Q = q.indentation(), j = !1, V = D.scope; V; V = V.prev)
              if (Q === V.offset) {
                j = !0
                break
              }
      ...
      function re(q, D) {
        var Q = D.tokenize(q, D),
          j = q.current()
        ;(j === 'return' && (D.dedent = !0), (((j === '->' || j === '=>') && q.eol()) || Q === 'indent') && W(q, D))
        var V = '[({'.indexOf(j)
        if (
          (V !== -1 && W(q, D, '])}'.slice(V, V + 1)),
          k.exec(j) && W(q, D),
          j == 'then' && J(q, D),
          Q === 'dedent' && J(q, D))
        )
      ...
      var F = {
        startState: function (q) {
          return { tokenize: U, scope: { offset: q || 0, type: 'coffee', prev: null, align: !1 }, prop: !1, dedent: 0 }
        },
        token: function (q, D) {
          var Q = D.scope.align === null && D.scope
          Q && q.sol() && (Q.align = !1)
          var j = re(q, D)
          return (j && j != 'comment' && (Q && (Q.align = !0), (D.prop = j == 'punctuation' && q.current() == '.')), j)
        },
        indent: function (q, D) {
          if (q.tokenize != U) return 0
          var Q = q.scope,
      ...
      function (p) {
        ...
        g.prototype.copy = function () {
          ...
          return (
            ...
            ($.javaScriptLineExcludesColon = this.javaScriptLineExcludesColon),
            ($.javaScriptArguments = this.javaScriptArguments),
            ($.javaScriptArgumentsDepth = this.javaScriptArgumentsDepth),
            ...
            this.innerMode && this.innerState && ($.innerState = o.copyState(this.innerMode, this.innerState)),
        ...
        function C($, Z) {
          if (($.sol() && ((Z.javaScriptLine = !1), (Z.javaScriptLineExcludesColon = !1)), Z.javaScriptLine)) {
        ...
        function k($, Z) {
          if (Z.javaScriptArguments) {
            if (Z.javaScriptArgumentsDepth === 0 && $.peek() !== '(') {
              Z.javaScriptArguments = !1
              return
            }
            if (
              ($.peek() === '(' ? Z.javaScriptArgumentsDepth++ : $.peek() === ')' && Z.javaScriptArgumentsDepth--,
        ...
        function x($, Z) {
          if ($.match('#{')) return ((Z.isInterpolating = !0), (Z.interpolationNesting = 0), 'punctuation')
        }
        function E($, Z) {
          if (Z.isInterpolating) {
            if ($.peek() === '}') {
              if ((Z.interpolationNesting--, Z.interpolationNesting < 0))
                return ($.next(), (Z.isInterpolating = !1), 'punctuation')
        ...
        function w($, Z) {
          if ($.match(/^when\b/)) return ((Z.javaScriptLine = !0), (Z.javaScriptLineExcludesColon = !0), v)
        }
        function U($) {
          if ($.match(/^default\b/)) return v
        }
        function M($, Z) {
          if ($.match(/^extends?\b/)) return ((Z.restOfLine = 'string'), v)
        }
        function O($, Z) {
          if ($.match(/^append\b/)) return ((Z.restOfLine = 'variable'), v)
        }
        function W($, Z) {
          if ($.match(/^prepend\b/)) return ((Z.restOfLine = 'variable'), v)
        }
        function J($, Z) {
          if ($.match(/^block\b *(?:(prepend|append)\b)?/)) return ((Z.restOfLine = 'variable'), v)
        }
        function re($, Z) {
          if ($.match(/^include\b/)) return ((Z.restOfLine = 'string'), v)
        }
        function F($, Z) {
          if ($.match(/^include:([a-zA-Z0-9\-]+)/, !1) && $.match('include')) return ((Z.isIncludeFiltered = !0), v)
        }
        function q($, Z) {
        ...
        function D($, Z) {
          if ($.match(/^mixin\b/)) return ((Z.javaScriptLine = !0), v)
        }
        function Q($, Z) {
          if ($.match(/^\+([-\w]+)/))
            return (
              $.match(/^\( *[-\w]+ *=/, !1) || ((Z.javaScriptArguments = !0), (Z.javaScriptArgumentsDepth = 0)),
              'variable'
            )
          if ($.match('+#{', !1)) return ($.next(), (Z.mixinCallAfter = !0), x($, Z))
        }
        function j($, Z) {
          if (Z.mixinCallAfter)
            return (
        ...
        function V($, Z) {
          if ($.match(/^(if|unless|else if|else)\b/)) return ((Z.javaScriptLine = !0), v)
        }
        function y($, Z) {
          if ($.match(/^(- *)?(each|for)\b/)) return ((Z.isEach = !0), v)
        }
        function G($, Z) {
          if (Z.isEach) {
            if ($.match(/^ in\b/)) return ((Z.javaScriptLine = !0), (Z.isEach = !1), v)
        ...
        function X($, Z) {
          if ($.match(/^while\b/)) return ((Z.javaScriptLine = !0), v)
        }
        function N($, Z) {
          var ce
          if ((ce = $.match(/^(\w(?:[-:\w]*\w)?)\/?/)))
        ...
        function R($, Z) {
          if ($.match(/^:([\w\-]+)/)) {
            var ce
            return (
              p && p.innerModes && (ce = p.innerModes($.current().substring(1))),
        ...
        function se($, Z) {
          if ($.match(/^(!?=|-)/)) return ((Z.javaScriptLine = !0), 'punctuation')
        }
        function _e($) {
          if ($.match(/^#([\w-]+)/)) return b
        }
        ...
        function he($, Z) {
          if (Z.isAttrs) {
            if ((s[$.peek()] && Z.attrsNest.push(s[$.peek()]), Z.attrsNest[Z.attrsNest.length - 1] === $.peek()))
              Z.attrsNest.pop()
            else if ($.eat(')')) return ((Z.isAttrs = !1), 'punctuation')
            if (Z.inAttributeName && $.match(/^[^=,\)!]+/))
              return (
                ($.peek() === '=' || $.peek() === '!') &&
                  ((Z.inAttributeName = !1),
                  (Z.jsState = o.startState(h)),
                  Z.lastTag === 'script' && $.current().trim().toLowerCase() === 'type'
                    ? (Z.attributeIsType = !0)
                    : (Z.attributeIsType = !1)),
                'attribute'
              )
            var ce = h.token($, Z.jsState)
            if (
              (Z.attributeIsType && ce === 'string' && (Z.scriptType = $.current().toString()),
        ...
        function Ee($, Z) {
          if ($.match(/^ *\/\/(-)?([^\n]*)/))
            return ((Z.indentOf = $.indentation()), (Z.indentToken = 'comment'), 'comment')
        }
        function ge($) {
        ...
        function Oe($, Z) {
          if ($.match(/^(?:\| ?| )([^\n]+)/)) return 'string'
          if ($.match(/^(<[^\n]*)/, !1)) return (Be($, Z, 'htmlmixed'), (Z.innerModeForLine = !0), Ze($, Z, !0))
        }
        function qe($, Z) {
          if ($.eat('.')) {
            var ce = null
        ...
        function Ze($, Z, ce) {
          if ($.indentation() > Z.indentOf || (Z.innerModeForLine && !$.sol()) || ce)
            return Z.innerMode
              ? (Z.innerState ||
                  (Z.innerState = Z.innerMode.startState ? o.startState(Z.innerMode, $.indentation()) : {}),
                $.hideFirstChars(Z.indentOf + 2, function () {
                  return Z.innerMode.token($, Z.innerState) || !0
                }))
              : ($.skipToEnd(), Z.indentToken)
          $.sol() && ((Z.indentOf = 1 / 0), (Z.indentToken = null), (Z.innerMode = null), (Z.innerState = null))
        }
        function ke($, Z) {
      ...
      return {
        ...
        token: function (b, S) {
          if (S.innerActive) {
            ...
            var k = E.close && !S.startingInner ? L(h, E.close, b.pos, E.parseDelimiters) : -1
            ...
            return (
              ...
              k == b.pos && E.parseDelimiters && (S.innerActive = S.inner = null),
            ...
            for (var s = 1 / 0, h = b.string, g = 0; g < v.length; ++g) {
              var C = v[g],
                k = L(h, C.open, b.pos)
              if (k == b.pos) {
                ;(C.parseDelimiters || b.match(C.open), (S.startingInner = !!C.parseDelimiters), (S.innerActive = C))
                var c = 0
                if (p.indent) {
                ...
                return (
                  (S.inner = o.startState(C.mode, c)), C.delimStyle && C.delimStyle + ' ' + C.delimStyle + '-open'
                )
              } else k != -1 && k < s && (s = k)
            }
  ...
  ;(function (o) {
    ...
    ;(o.defineSimpleMode('handlebars-tags', {
      ...
      o.defineMode('handlebars', function (p, v) {
        ...
        return !v || !v.base
          ? L
          : o.multiplexingMode(o.getMode(p, v.base), { open: '{{', close: /\}\}\}?/, mode: L, parseDelimiters: !0 })
      }),
      ...
      return {
        token: function (L, b) {
          ...
          if ((b.literal && (b.literal = !1), L.sol())) {
            if (((b.keyCol = 0), (b.pair = !1), (b.pairStart = !1), L.match('---') || L.match('...'))) return 'def'
            if (L.match(/\s*-\s+/)) return 'meta'
          }
          if (L.match(/^(\{|\}|\[|\])/))
            return (
              S == '{' ? b.inlinePairs++ : S == '}' ? b.inlinePairs-- : S == '[' ? b.inlineList++ : b.inlineList--,
              'meta'
            )
...
function Fd(o) {
  for (
    var p = new DOMParser(), v = p.parseFromString(o, 'text/html'), L = v.getElementsByTagName('li'), b = 0;
    b < L.length;
    b++
  )
...
function Id(o, p, v, L) {
  ...
  for (var s = 0; s < o.children.length; s++) {
    var h = o.children[s],
      g
    ;(typeof h == 'string' && h in Pr ? (g = qi(Pr[h], !0, p, v, 'button', L)) : (g = qi(h, !0, p, v, 'button', L)),
      g.addEventListener(
        'click',
        function (C) {
          C.stopPropagation()
...
function Br(o) {
  ...
  if (
    ...
    p.getOption('fullScreen')
      ? (p.getScrollerElement().style.removeProperty(S), L.style.removeProperty(S))
      : (p.getScrollerElement().style.setProperty(S, o.options.maxHeight), o.setPreviewMaxHeight())
  }
  if ((o.toolbar_div.classList.toggle('fullscreen'), o.toolbarElements && o.toolbarElements.fullscreen)) {
...
`),
  ...
  if (c === 'single') {
    ...
    if (h.line !== g.line || h.ch !== g.ch) {
      ...
      var U = s.getTokenAt({ line: d, ch: 1 }),
        M = L(U).fencedChars,
        O,
        W,
        J,
...
`),
        ...
        s.operation(function () {
          ;(s.replaceRange(J, { line: re, ch: 0 }, { line: re + (J ? 0 : 1), ch: 0 }),
            s.replaceRange(O, { line: W, ch: 0 }, { line: W + (O ? 0 : 1), ch: 0 }))
        }),
        s.setSelection({ line: W + (O ? 1 : 0), ch: 0 }, { line: re + (O ? 1 : -1), ch: 0 }),
        s.focus())
    } else {
      var F = h.line
      if (
        (v(s.getLineHandle(h.line)) &&
          (b(s, h.line + 1) === 'fenced' ? ((d = h.line), (F = h.line + 1)) : ((x = h.line), (F = h.line - 1))),
        d === void 0)
      )
        for (d = F; d >= 0 && ((k = s.getLineHandle(d)), !v(k)); d--);
      if (x === void 0) for (E = s.lineCount(), x = F; x < E && ((k = s.getLineHandle(x)), !v(k)); x++);
      ;(s.operation(function () {
    ...
    if (h.line !== g.line || h.ch !== g.ch) ((d = h.line), (x = g.line), g.ch === 0 && x--)
      ...
      for (E = s.lineCount(), x = h.line; x < E; x++)
        if (((k = s.getLineHandle(x)), !k.text.match(/^\s*$/) && b(s, x, k) !== 'indented')) {
          x -= 1
          break
        }
    }
    var q = s.getLineHandle(x + 1),
      D = q && s.getTokenAt({ line: x + 1, ch: q.text.length - 1 }),
...
function Ji(o) {
  ...
  if (
    (s.classList.contains('editor-preview-active-side') && bn(o), !S || !S.classList.contains('editor-preview-full'))
  ) {
    ...
    for (
      var L = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
        ...
        c = function (E, z, w) {
          ...
          return (
            U !== null
              ? (k(E, U[2]) && (M = ''), (z = U[1] + M + U[3] + z.replace(b, '').replace(g[E], '$1')))
              : w == !1 && (z = M + ' ' + z),
            z
          )
        },
  ...
  if (o.toolbar === void 0) {
    ...
    for (var S in Pr)
      Object.prototype.hasOwnProperty.call(Pr, S) &&
        ...
        (Pr[S].default === !0 || (o.showIcons && o.showIcons.constructor === Array && o.showIcons.indexOf(S) != -1)) &&
          o.toolbar.push(S))
  }
  if (
...
Maximum file size is #image_max_size#.`,
    ...
    Te.prototype.uploadImages = function (o, p, v) {
      if (o.length !== 0) {
        for (var L = [], b = 0; b < o.length; b++) (L.push(o[b].name), this.uploadImage(o[b], p, v))
        this.updateStatusBar('upload-image', this.options.imageTexts.sbOnDrop.replace('#images_names#', L.join(', ')))
      }
    }
    Te.prototype.uploadImagesUsingCustomFunction = function (o, p) {
      if (p.length !== 0) {
        for (var v = [], L = 0; L < p.length; L++) (v.push(p[L].name), this.uploadImageUsingCustomFunction(o, p[L]))
    ...
    Te.prototype.render = function (o) {
      ...
      function b(O) {
        ...
        if (J) {
          let re = Array.from(J.elements).filter(
            ...
            F = re.indexOf(W)
          F !== -1 && F + 1 < re.length && re[F + 1] && re[F + 1].focus()
        }
      }
      function S(O) {
        let W = O.getInputField(),
      ...
      for (var s in p.shortcuts)
        p.shortcuts[s] !== null &&
          Vn[s] !== null &&
          (function (O) {
            L[vc(p.shortcuts[O])] = function () {
              var W = Vn[O]
              typeof W == 'function' ? W(v) : typeof W == 'string' && window.open(W, '_blank')
            }
          })(s)
      ;((L.Enter = 'newlineAndIndentContinueMarkdownList'),
        (L.Tab = (O) => {
          let W = O.getSelection()
          W && W.length > 0 ? O.execCommand('indentMore') : b(O)
        }),
        (L['Shift-Tab'] = (O) => {
          let W = O.getSelection()
          W && W.length > 0 ? O.execCommand('indentLess') : S(O)
        }),
        (L.Esc = function (O) {
          O.getOption('fullScreen') && Br(v)
        }),
        (this.documentOnKeyDown = function (O) {
          ;((O = O || window.event), O.keyCode == 27 && v.codemirror.getOption('fullScreen') && Br(v))
        }),
        document.addEventListener('keydown', this.documentOnKeyDown, !1))
      var h, g
      ;(p.overlayMode
        ? (CodeMirror.defineMode('overlay-mode', function (O) {
            return CodeMirror.overlayMode(
              CodeMirror.getMode(O, p.spellChecker !== !1 ? 'spell-checker' : 'gfm'),
              p.overlayMode.mode,
      ...
      var k = this.codemirror.getScrollerElement()
      if (
        ((k.style.minHeight = p.minHeight),
        typeof p.maxHeight < 'u' &&
          (k.setAttribute('tabindex', '0'),
          k.style.setProperty(this.hasExplicitMinHeight ? 'max-height' : 'height', p.maxHeight)),
        p.forceSync === !0)
      ) {
      ...
      ;(d.classList.add('EasyMDEContainer'), d.setAttribute('role', 'application'))
      ...
      function E(O, W) {
        var J,
          re = window.getComputedStyle(document.querySelector('.CodeMirror-sizer')).width.replace('px', '')
        return (O < re ? (J = W + 'px') : (J = (W / O) * 100 + '%'), J)
      }
      var z = this
      function w(O, W) {
        ;(O.setAttribute('data-img-src', W.url),
          O.setAttribute(
            'style',
            '--bg-image:url(' +
              W.url +
              ...
              W.naturalWidth +
              'px;--height:' +
              E(W.naturalWidth, W.naturalHeight),
          ),
          z.codemirror.setSize())
      }
      function U() {
        p.previewImagesInEditor &&
          d.querySelectorAll('.cm-image-marker').forEach(function (O) {
            var W = O.parentElement
            if (W.innerText.match(/^!\[.*?\]\(.*\)/g) && !W.hasAttribute('data-img-src')) {
              var J = W.innerText.match('\\((.*)\\)')
              if ((window.EMDEimagesCache || (window.EMDEimagesCache = {}), J && J.length >= 2)) {
                var re = J[1]
                if (p.imagesPreviewHandler) {
                  var F = p.imagesPreviewHandler(J[1])
                  typeof F == 'string' && (re = F)
                }
                if (window.EMDEimagesCache[re]) w(W, window.EMDEimagesCache[re])
                else {
      ...
      if (!v || !v.classList.contains('editor-preview-side')) {
        if (((v = document.createElement('div')), (v.className = 'editor-preview-side'), this.options.previewClass))
          if (Array.isArray(this.options.previewClass))
            for (var L = 0; L < this.options.previewClass.length; L++) v.classList.add(this.options.previewClass[L])
          ...
          if (
            ...
            if (o[p] === '|') {
              for (var S = !1, s = p + 1; s < o.length; s++)
                o[s] !== '|' && (!L.options.hideIcons || L.options.hideIcons.indexOf(o[s].name) == -1) && (S = !0)
              if (!S) continue
            }
            ;(function (C) {
              var k
            ...
            ;(g === 'words'
              ...
              : g === 'lines'
                ...
                : g === 'cursor'
                  ...
                  : g === 'autosave'
                    ? (h = function (x) {
                        p.autosave != null && p.autosave.enabled === !0 && x.setAttribute('id', 'autosaved')
                      })
                    : g === 'upload-image' &&
                      (h = function (x) {
...
function Kd({
  ...
  return {
    ...
    async init() {
      if (
        (this.$root.closest('.fi-modal') && (await new Promise((E) => setTimeout(E, 300))),
        ...
        let E = this.editor.codemirror.getInputField()
        E && E.setAttribute('aria-label', L)
      }
      ;(this.editor.codemirror.setOption('direction', document.documentElement?.dir ?? 'ltr'),
        this.editor.codemirror.on('changes', (E, z) => {
          try {
            let w = z[z.length - 1]
            if (w.origin === '+input') {
              let U = '(https://)',
                M = w.text[w.text.length - 1]
              if (M.endsWith(U) && M !== '[]' + U) {
                let O = w.from,
                  W = w.to,
                  re = w.text.length > 1 ? 0 : O.ch
                setTimeout(() => {
                  E.setSelection(
                    { line: W.line, ch: re + M.lastIndexOf('(') + 1 },
                    { line: W.line, ch: re + M.lastIndexOf(')') },
                  )
                }, 25)
              }
            }
      ...
      ;(this.editor.codemirror.on('change', (E, z) => {
        this.editor && z.origin !== 'setValue' && ((this.state = this.editor.value()), p && x())
      }),
        v && this.editor.codemirror.on('blur', () => this.$wire.commit()),
        this.$watch('state', () => {
          this.editor && (this.state ?? '') !== this.editor.value() && Alpine.raw(this.editor).value(this.state ?? '')
        }),
        g && g(this),
        (this.wasEditorVisible = this.isEditorVisible()),
        (this.resizeObserver = new ResizeObserver(() => this.handleEditorVisibilityChange())),
        this.resizeObserver.observe(this.$el),
        (this.intersectionObserver = new IntersectionObserver(() => this.handleEditorVisibilityChange())),
        this.intersectionObserver.observe(this.$el))
    },
    isEditorVisible() {
      return this.$el.offsetParent !== null && getComputedStyle(this.$el).visibility !== 'hidden'
    },
    handleEditorVisibilityChange() {
      let x = this.isEditorVisible()
      ;(x && !this.wasEditorVisible && Alpine.raw(this.editor)?.codemirror?.refresh(), (this.wasEditorVisible = x))
    },
    destroy() {
    ...
    getToolbar() {
      ...
      return (
        c.forEach((E) => {
          ;(E.forEach((z) => x.push(this.getToolbarButton(z))), E.length > 0 && x.push('|'))
        }),
        x[x.length - 1] === '|' && x.pop(),
        x
      )
    ...
    getBulletListToolbarButton() {
      return { name: 'unordered-list', action: EasyMDE.toggleUnorderedList, title: k.tools?.bullet_list }
    },
    getOrderedListToolbarButton() {
      return { name: 'ordered-list', action: EasyMDE.toggleOrderedList, title: k.tools?.ordered_list }
    },
    getTableToolbarButton() {
      return { name: 'table', action: EasyMDE.drawTable, title: k.tools?.table }
    },
    getAttachFilesToolbarButton() {
      return { name: 'upload-image', action: EasyMDE.drawUploadedImage, title: k.tools?.attach_files }
    },
